 ...
 */
@JsonPropertyOrder({
  ApiV1TemplatesIdPatchRequest.JSON_PROPERTY_NAME,
  ApiV1TemplatesIdPatchRequest.JSON_PROPERTY_DESCRIPTION,
  ApiV1TemplatesIdPatchRequest.JSON_PROPERTY_CATEGORY
})
...
public class ApiV1TemplatesIdPatchRequest {
  ...
  public ApiV1TemplatesIdPatchRequest() { 
  }

  public ApiV1TemplatesIdPatchRequest name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ApiV1TemplatesIdPatchRequest description(@javax.annotation.Nullable String description) {
  ...
  public ApiV1TemplatesIdPatchRequest category(@javax.annotation.Nullable String category) {
  ...
  /**
   * Return true if this _api_v1_templates__id__patch_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiV1TemplatesIdPatchRequest apiV1TemplatesIdPatchRequest = (ApiV1TemplatesIdPatchRequest) o;
    return Objects.equals(this.name, apiV1TemplatesIdPatchRequest.name) &&
        Objects.equals(this.description, apiV1TemplatesIdPatchRequest.description) &&
        Objects.equals(this.category, apiV1TemplatesIdPatchRequest.category);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiV1TemplatesIdPatchRequest {\n");
