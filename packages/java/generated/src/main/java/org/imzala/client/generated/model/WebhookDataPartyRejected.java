...
import org.imzala.client.generated.model.WebhookDataPartyRejectedParty;
 ...
 */
@JsonPropertyOrder({
  WebhookDataPartyRejected.JSON_PROPERTY_DEMAND_ID,
...
public class WebhookDataPartyRejected {
  ...
  @javax.annotation.Nonnull
  private WebhookDataPartyRejectedParty party;

  public static final String JSON_PROPERTY_REJECTED_AT = "rejected_at";
  @javax.annotation.Nonnull
  private OffsetDateTime rejectedAt;

  public WebhookDataPartyRejected() { 
  }

  public WebhookDataPartyRejected demandId(@javax.annotation.Nonnull UUID demandId) {
  ...
  public WebhookDataPartyRejected party(@javax.annotation.Nonnull WebhookDataPartyRejectedParty party) {
    this.party = party;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_PARTY, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public WebhookDataPartyRejectedParty getParty() {
    return party;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PARTY, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setParty(@javax.annotation.Nonnull WebhookDataPartyRejectedParty party) {
    this.party = party;
  }


  public WebhookDataPartyRejected rejectedAt(@javax.annotation.Nonnull OffsetDateTime rejectedAt) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_REJECTED_AT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  /**
   * Return true if this WebhookDataPartyRejected object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookDataPartyRejected webhookDataPartyRejected = (WebhookDataPartyRejected) o;
    return Objects.equals(this.demandId, webhookDataPartyRejected.demandId) &&
        Objects.equals(this.party, webhookDataPartyRejected.party) &&
        Objects.equals(this.rejectedAt, webhookDataPartyRejected.rejectedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(demandId, party, rejectedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhookDataPartyRejected {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `party` to the URL query string
    if (getParty() != null) {
      joiner.add(getParty().toUrlQueryString(prefix + "party" + suffix));
    }
