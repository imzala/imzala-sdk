...
import org.imzala.client.generated.model.PageItem;
 ...
 */
@JsonPropertyOrder({
  UpsertItemsRequest.JSON_PROPERTY_ITEMS,
  UpsertItemsRequest.JSON_PROPERTY_PAGE_IDS
})
...
public class UpsertItemsRequest {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @javax.annotation.Nonnull
  private List<PageItem> items = new ArrayList<>();

  public static final String JSON_PROPERTY_PAGE_IDS = "page_ids";
  ...
  public UpsertItemsRequest items(@javax.annotation.Nonnull List<PageItem> items) {
    this.items = items;
    return this;
  }

  public UpsertItemsRequest addItemsItem(PageItem itemsItem) {
    if (this.items == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ITEMS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<PageItem> items) {
    this.items = items;
  }


  public UpsertItemsRequest pageIds(@javax.annotation.Nullable List<Integer> pageIds) {
    this.pageIds = pageIds;
    return this;
  }

  public UpsertItemsRequest addPageIdsItem(Integer pageIdsItem) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PAGE_IDS, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_PAGE_IDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPageIds(@javax.annotation.Nullable List<Integer> pageIds) {
    this.pageIds = pageIds;
  }


  /**
   * Return true if this UpsertItemsRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpsertItemsRequest upsertItemsRequest = (UpsertItemsRequest) o;
    return Objects.equals(this.items, upsertItemsRequest.items) &&
        Objects.equals(this.pageIds, upsertItemsRequest.pageIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(items, pageIds);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpsertItemsRequest {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `page_ids` to the URL query string
    if (getPageIds() != null) {
      for (int i = 0; i < getPageIds().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%spage_ids%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getPageIds().get(i)))));
      }
    }
