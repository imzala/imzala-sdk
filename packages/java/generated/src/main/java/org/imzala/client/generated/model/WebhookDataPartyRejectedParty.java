 ...
 */
@JsonPropertyOrder({
  WebhookDataPartyRejectedParty.JSON_PROPERTY_ID,
  WebhookDataPartyRejectedParty.JSON_PROPERTY_FIRST_NAME,
  WebhookDataPartyRejectedParty.JSON_PROPERTY_LAST_NAME,
  WebhookDataPartyRejectedParty.JSON_PROPERTY_EMAIL,
  WebhookDataPartyRejectedParty.JSON_PROPERTY_REJECTION_REASON
})
...
public class WebhookDataPartyRejectedParty {
  ...
  private JsonNullable<String> rejectionReason = JsonNullable.<String>undefined();

  public WebhookDataPartyRejectedParty() { 
  }

  public WebhookDataPartyRejectedParty id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookDataPartyRejectedParty firstName(@javax.annotation.Nonnull String firstName) {
  ...
  public WebhookDataPartyRejectedParty lastName(@javax.annotation.Nonnull String lastName) {
  ...
  public WebhookDataPartyRejectedParty email(@javax.annotation.Nullable String email) {
  ...
  public WebhookDataPartyRejectedParty rejectionReason(@javax.annotation.Nullable String rejectionReason) {
    this.rejectionReason = JsonNullable.<String>of(rejectionReason);
    return this;
  }
  ...
  public String getRejectionReason() {
        return rejectionReason.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_REJECTION_REASON, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getRejectionReason_JsonNullable() {
    return rejectionReason;
  }
  
  @JsonProperty(JSON_PROPERTY_REJECTION_REASON)
  public void setRejectionReason_JsonNullable(JsonNullable<String> rejectionReason) {
  ...
  /**
   * Return true if this WebhookDataPartyRejected_party object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookDataPartyRejectedParty webhookDataPartyRejectedParty = (WebhookDataPartyRejectedParty) o;
    return Objects.equals(this.id, webhookDataPartyRejectedParty.id) &&
        Objects.equals(this.firstName, webhookDataPartyRejectedParty.firstName) &&
        Objects.equals(this.lastName, webhookDataPartyRejectedParty.lastName) &&
        equalsNullable(this.email, webhookDataPartyRejectedParty.email) &&
        equalsNullable(this.rejectionReason, webhookDataPartyRejectedParty.rejectionReason);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, firstName, lastName, hashCodeNullable(email), hashCodeNullable(rejectionReason));
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookDataPartyRejectedParty {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `rejection_reason` to the URL query string
    if (getRejectionReason() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%srejection_reason%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRejectionReason()))));
    }
