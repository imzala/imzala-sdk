 ...
 */
@JsonPropertyOrder({
  ApiV1DemandsIdEmbedSessionPost200ResponseData.JSON_PROPERTY_EMBED_TOKEN,
  ApiV1DemandsIdEmbedSessionPost200ResponseData.JSON_PROPERTY_EXPIRES_AT,
  ApiV1DemandsIdEmbedSessionPost200ResponseData.JSON_PROPERTY_EMBED_URL
})
...
public class ApiV1DemandsIdEmbedSessionPost200ResponseData {
  ...
  public static final String JSON_PROPERTY_EMBED_URL = "embed_url";
  @javax.annotation.Nullable
  private URI embedUrl;

  public ApiV1DemandsIdEmbedSessionPost200ResponseData() { 
  }

  public ApiV1DemandsIdEmbedSessionPost200ResponseData embedToken(@javax.annotation.Nullable String embedToken) {
  ...
  @JsonProperty(value = JSON_PROPERTY_EMBED_TOKEN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEmbedToken(@javax.annotation.Nullable String embedToken) {
    this.embedToken = embedToken;
  }


  public ApiV1DemandsIdEmbedSessionPost200ResponseData expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public ApiV1DemandsIdEmbedSessionPost200ResponseData embedUrl(@javax.annotation.Nullable URI embedUrl) {
  ...
  @JsonProperty(value = JSON_PROPERTY_EMBED_URL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEmbedUrl(@javax.annotation.Nullable URI embedUrl) {
    this.embedUrl = embedUrl;
  }


  /**
   * Return true if this _api_v1_demands__id__embed_session_post_200_response_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiV1DemandsIdEmbedSessionPost200ResponseData apiV1DemandsIdEmbedSessionPost200ResponseData = (ApiV1DemandsIdEmbedSessionPost200ResponseData) o;
    return Objects.equals(this.embedToken, apiV1DemandsIdEmbedSessionPost200ResponseData.embedToken) &&
        Objects.equals(this.expiresAt, apiV1DemandsIdEmbedSessionPost200ResponseData.expiresAt) &&
        Objects.equals(this.embedUrl, apiV1DemandsIdEmbedSessionPost200ResponseData.embedUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(embedToken, expiresAt, embedUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiV1DemandsIdEmbedSessionPost200ResponseData {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEmbedToken() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sembed_token%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEmbedToken()))));
    }
    ...
    // add `embed_url` to the URL query string
    if (getEmbedUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sembed_url%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEmbedUrl()))));
    }
