 ...
 */
@JsonPropertyOrder({
  WebhookDataPartyViewed.JSON_PROPERTY_DEMAND_ID,
  WebhookDataPartyViewed.JSON_PROPERTY_PARTY_ID
})
...
public class WebhookDataPartyViewed {
  ...
  public WebhookDataPartyViewed() { 
  }

  public WebhookDataPartyViewed demandId(@javax.annotation.Nonnull UUID demandId) {
  ...
  public WebhookDataPartyViewed partyId(@javax.annotation.Nonnull UUID partyId) {
  ...
  /**
   * Return true if this WebhookDataPartyViewed object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookDataPartyViewed webhookDataPartyViewed = (WebhookDataPartyViewed) o;
    return Objects.equals(this.demandId, webhookDataPartyViewed.demandId) &&
        Objects.equals(this.partyId, webhookDataPartyViewed.partyId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(demandId, partyId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhookDataPartyViewed {\n");
