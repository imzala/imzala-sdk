 ...
 */
@JsonPropertyOrder({
  TemplateUsageExampleRequest.JSON_PROPERTY_CURL,
  TemplateUsageExampleRequest.JSON_PROPERTY_JSON
})
...
public class TemplateUsageExampleRequest {
  public static final String JSON_PROPERTY_CURL = "curl";
  ...
  public TemplateUsageExampleRequest() { 
  }

  public TemplateUsageExampleRequest curl(@javax.annotation.Nullable String curl) {
    this.curl = curl;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CURL, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_CURL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCurl(@javax.annotation.Nullable String curl) {
    this.curl = curl;
  }


  public TemplateUsageExampleRequest json(@javax.annotation.Nullable Object json) {
    this.json = json;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_JSON, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setJson(@javax.annotation.Nullable Object json) {
    this.json = json;
  }


  /**
   * Return true if this TemplateUsage_example_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TemplateUsageExampleRequest templateUsageExampleRequest = (TemplateUsageExampleRequest) o;
    return Objects.equals(this.curl, templateUsageExampleRequest.curl) &&
        Objects.equals(this.json, templateUsageExampleRequest.json);
  }

  @Override
  public int hashCode() {
    return Objects.hash(curl, json);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TemplateUsageExampleRequest {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `curl` to the URL query string
    if (getCurl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%scurl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCurl()))));
    }

    // add `json` to the URL query string
    if (getJson() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sjson%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getJson()))));
    }
