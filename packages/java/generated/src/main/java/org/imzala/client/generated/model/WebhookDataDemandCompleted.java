...
import org.imzala.client.generated.model.WebhookDataDemandCompletedPartiesInner;
 ...
 */
@JsonPropertyOrder({
  WebhookDataDemandCompleted.JSON_PROPERTY_DEMAND_ID,
  WebhookDataDemandCompleted.JSON_PROPERTY_TITLE,
  WebhookDataDemandCompleted.JSON_PROPERTY_STATUS,
  WebhookDataDemandCompleted.JSON_PROPERTY_COMPLETED_AT,
  WebhookDataDemandCompleted.JSON_PROPERTY_PARTIES,
  WebhookDataDemandCompleted.JSON_PROPERTY_BACKFILL
})
...
public class WebhookDataDemandCompleted {
  ...
  @javax.annotation.Nonnull
  private List<WebhookDataDemandCompletedPartiesInner> parties = new ArrayList<>();

  public static final String JSON_PROPERTY_BACKFILL = "_backfill";
  @javax.annotation.Nullable
  private Boolean backfill;

  public WebhookDataDemandCompleted() { 
  }

  public WebhookDataDemandCompleted demandId(@javax.annotation.Nonnull UUID demandId) {
  ...
  public WebhookDataDemandCompleted title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public WebhookDataDemandCompleted status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public WebhookDataDemandCompleted completedAt(@javax.annotation.Nonnull OffsetDateTime completedAt) {
  ...
  public WebhookDataDemandCompleted parties(@javax.annotation.Nonnull List<WebhookDataDemandCompletedPartiesInner> parties) {
    this.parties = parties;
    return this;
  }

  public WebhookDataDemandCompleted addPartiesItem(WebhookDataDemandCompletedPartiesInner partiesItem) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_PARTIES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public List<WebhookDataDemandCompletedPartiesInner> getParties() {
    return parties;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PARTIES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setParties(@javax.annotation.Nonnull List<WebhookDataDemandCompletedPartiesInner> parties) {
    this.parties = parties;
  }


  public WebhookDataDemandCompleted backfill(@javax.annotation.Nullable Boolean backfill) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BACKFILL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBackfill(@javax.annotation.Nullable Boolean backfill) {
    this.backfill = backfill;
  }


  /**
   * Return true if this WebhookDataDemandCompleted object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookDataDemandCompleted webhookDataDemandCompleted = (WebhookDataDemandCompleted) o;
    return Objects.equals(this.demandId, webhookDataDemandCompleted.demandId) &&
        Objects.equals(this.title, webhookDataDemandCompleted.title) &&
        Objects.equals(this.status, webhookDataDemandCompleted.status) &&
        Objects.equals(this.completedAt, webhookDataDemandCompleted.completedAt) &&
        Objects.equals(this.parties, webhookDataDemandCompleted.parties) &&
        Objects.equals(this.backfill, webhookDataDemandCompleted.backfill);
  }

  @Override
  public int hashCode() {
    return Objects.hash(demandId, title, status, completedAt, parties, backfill);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhookDataDemandCompleted {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `_backfill` to the URL query string
    if (getBackfill() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%s_backfill%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBackfill()))));
    }
