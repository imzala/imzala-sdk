...
import org.imzala.client.generated.model.StandardErrorError;
 ...
 */
@JsonPropertyOrder({
  StandardError.JSON_PROPERTY_SUCCESS,
  StandardError.JSON_PROPERTY_ERROR
})
...
public class StandardError {
  ...
  @javax.annotation.Nullable
  private StandardErrorError error;

  public StandardError() { 
  }

  public StandardError success(@javax.annotation.Nullable Boolean success) {
  ...
  public StandardError error(@javax.annotation.Nullable StandardErrorError error) {
    this.error = error;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public StandardErrorError getError() {
    return error;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ERROR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setError(@javax.annotation.Nullable StandardErrorError error) {
    this.error = error;
  }


  /**
   * Return true if this StandardError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, standardError.success) &&
        Objects.equals(this.error, standardError.error);
  }
