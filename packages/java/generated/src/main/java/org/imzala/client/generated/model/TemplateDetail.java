...
import org.imzala.client.generated.model.TemplatePartySummary;
import org.imzala.client.generated.model.TemplateVariable;
 ...
 */
@JsonPropertyOrder({
  TemplateDetail.JSON_PROPERTY_ID,
  TemplateDetail.JSON_PROPERTY_NAME,
  TemplateDetail.JSON_PROPERTY_DESCRIPTION,
  TemplateDetail.JSON_PROPERTY_CATEGORY,
  TemplateDetail.JSON_PROPERTY_USAGE_COUNT,
  TemplateDetail.JSON_PROPERTY_PARTIES,
  TemplateDetail.JSON_PROPERTY_PAGES_COUNT,
  TemplateDetail.JSON_PROPERTY_VARIABLES
})
...
public class TemplateDetail {
  ...
  @javax.annotation.Nullable
  private List<TemplatePartySummary> parties = new ArrayList<>();

  public static final String JSON_PROPERTY_PAGES_COUNT = "pages_count";
  @javax.annotation.Nullable
  ...
  public TemplateDetail id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public TemplateDetail name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TemplateDetail description(@javax.annotation.Nullable String description) {
  ...
  public TemplateDetail category(@javax.annotation.Nullable String category) {
  ...
  public TemplateDetail usageCount(@javax.annotation.Nullable Integer usageCount) {
  ...
  public TemplateDetail parties(@javax.annotation.Nullable List<TemplatePartySummary> parties) {
    this.parties = parties;
    return this;
  }

  public TemplateDetail addPartiesItem(TemplatePartySummary partiesItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<TemplatePartySummary> getParties() {
    return parties;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PARTIES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setParties(@javax.annotation.Nullable List<TemplatePartySummary> parties) {
    this.parties = parties;
  }


  public TemplateDetail pagesCount(@javax.annotation.Nullable Integer pagesCount) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_PAGES_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PAGES_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPagesCount(@javax.annotation.Nullable Integer pagesCount) {
    this.pagesCount = pagesCount;
  }


  public TemplateDetail variables(@javax.annotation.Nullable List<TemplateVariable> variables) {
    this.variables = variables;
    return this;
  }

  public TemplateDetail addVariablesItem(TemplateVariable variablesItem) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VARIABLES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVariables(@javax.annotation.Nullable List<TemplateVariable> variables) {
    this.variables = variables;
  }


  /**
   * Return true if this TemplateDetail object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, templateDetail.id) &&
        Objects.equals(this.name, templateDetail.name) &&
        equalsNullable(this.description, templateDetail.description) &&
        equalsNullable(this.category, templateDetail.category) &&
        Objects.equals(this.usageCount, templateDetail.usageCount) &&
        Objects.equals(this.parties, templateDetail.parties) &&
        Objects.equals(this.pagesCount, templateDetail.pagesCount) &&
        Objects.equals(this.variables, templateDetail.variables);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, hashCodeNullable(description), hashCodeNullable(category), usageCount, parties, pagesCount, variables);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `usage_count` to the URL query string
    if (getUsageCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%susage_count%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUsageCount()))));
    }
    ...
    // add `pages_count` to the URL query string
    if (getPagesCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%spages_count%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPagesCount()))));
    }
