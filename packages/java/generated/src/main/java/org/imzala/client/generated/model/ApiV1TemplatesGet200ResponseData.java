 ...
 */
@JsonPropertyOrder({
  ApiV1TemplatesGet200ResponseData.JSON_PROPERTY_TEMPLATES,
  ApiV1TemplatesGet200ResponseData.JSON_PROPERTY_TOTAL,
  ApiV1TemplatesGet200ResponseData.JSON_PROPERTY_PAGE,
  ApiV1TemplatesGet200ResponseData.JSON_PROPERTY_LIMIT
})
...
public class ApiV1TemplatesGet200ResponseData {
  ...
  public ApiV1TemplatesGet200ResponseData() { 
  }

  public ApiV1TemplatesGet200ResponseData templates(@javax.annotation.Nullable List<TemplateSummary> templates) {
    this.templates = templates;
    return this;
  }

  public ApiV1TemplatesGet200ResponseData addTemplatesItem(TemplateSummary templatesItem) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TEMPLATES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTemplates(@javax.annotation.Nullable List<TemplateSummary> templates) {
    this.templates = templates;
  }


  public ApiV1TemplatesGet200ResponseData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ApiV1TemplatesGet200ResponseData page(@javax.annotation.Nullable Integer page) {
    this.page = page;
    return this;
  }
  ...
  public ApiV1TemplatesGet200ResponseData limit(@javax.annotation.Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  /**
   * Return true if this _api_v1_templates_get_200_response_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiV1TemplatesGet200ResponseData apiV1TemplatesGet200ResponseData = (ApiV1TemplatesGet200ResponseData) o;
    return Objects.equals(this.templates, apiV1TemplatesGet200ResponseData.templates) &&
        Objects.equals(this.total, apiV1TemplatesGet200ResponseData.total) &&
        Objects.equals(this.page, apiV1TemplatesGet200ResponseData.page) &&
        Objects.equals(this.limit, apiV1TemplatesGet200ResponseData.limit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(templates, total, page, limit);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiV1TemplatesGet200ResponseData {\n");
