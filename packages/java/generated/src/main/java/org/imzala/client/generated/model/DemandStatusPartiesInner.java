...
@JsonPropertyOrder({
  ...
  DemandStatusPartiesInner.JSON_PROPERTY_NAME,
  DemandStatusPartiesInner.JSON_PROPERTY_EMAIL_MASKED,
  DemandStatusPartiesInner.JSON_PROPERTY_SIGNED,
  DemandStatusPartiesInner.JSON_PROPERTY_SIGNED_AT,
  DemandStatusPartiesInner.JSON_PROPERTY_REJECTED,
  DemandStatusPartiesInner.JSON_PROPERTY_REJECTED_AT,
...
public class DemandStatusPartiesInner {
  ...
  public static final String JSON_PROPERTY_EMAIL_MASKED = "email_masked";
  @javax.annotation.Nullable
  ...
  public static final String JSON_PROPERTY_REJECTED_AT = "rejected_at";
  private JsonNullable<OffsetDateTime> rejectedAt = JsonNullable.<OffsetDateTime>undefined();
  ...
  public DemandStatusPartiesInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public DemandStatusPartiesInner emailMasked(@javax.annotation.Nullable String emailMasked) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_EMAIL_MASKED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_EMAIL_MASKED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEmailMasked(@javax.annotation.Nullable String emailMasked) {
    this.emailMasked = emailMasked;
  }
  ...
  public DemandStatusPartiesInner rejected(@javax.annotation.Nullable Boolean rejected) {
  ...
  @JsonProperty(value = JSON_PROPERTY_REJECTED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRejected(@javax.annotation.Nullable Boolean rejected) {
    this.rejected = rejected;
  }


  public DemandStatusPartiesInner rejectedAt(@javax.annotation.Nullable OffsetDateTime rejectedAt) {
    this.rejectedAt = JsonNullable.<OffsetDateTime>of(rejectedAt);
    return this;
  }
  ...
  public OffsetDateTime getRejectedAt() {
        return rejectedAt.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_REJECTED_AT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<OffsetDateTime> getRejectedAt_JsonNullable() {
    return rejectedAt;
  }
  
  @JsonProperty(JSON_PROPERTY_REJECTED_AT)
  public void setRejectedAt_JsonNullable(JsonNullable<OffsetDateTime> rejectedAt) {
    this.rejectedAt = rejectedAt;
  }

  public void setRejectedAt(@javax.annotation.Nullable OffsetDateTime rejectedAt) {
    this.rejectedAt = JsonNullable.<OffsetDateTime>of(rejectedAt);
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.partyId, demandStatusPartiesInner.partyId) &&
        Objects.equals(this.name, demandStatusPartiesInner.name) &&
        Objects.equals(this.emailMasked, demandStatusPartiesInner.emailMasked) &&
        Objects.equals(this.signed, demandStatusPartiesInner.signed) &&
        equalsNullable(this.signedAt, demandStatusPartiesInner.signedAt) &&
        Objects.equals(this.rejected, demandStatusPartiesInner.rejected) &&
        equalsNullable(this.rejectedAt, demandStatusPartiesInner.rejectedAt) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(partyId, name, emailMasked, signed, hashCodeNullable(signedAt), rejected, hashCodeNullable(rejectedAt), signingUrl);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `email_masked` to the URL query string
    if (getEmailMasked() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%semail_masked%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEmailMasked()))));
    }
    ...
    // add `rejected_at` to the URL query string
    if (getRejectedAt() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%srejected_at%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRejectedAt()))));
    }
