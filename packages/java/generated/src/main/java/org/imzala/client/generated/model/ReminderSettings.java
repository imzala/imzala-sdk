 ...
 */
@JsonPropertyOrder({
  ReminderSettings.JSON_PROPERTY_ENABLED,
  ReminderSettings.JSON_PROPERTY_INTERVALS_HOURS,
  ReminderSettings.JSON_PROPERTY_MAX_REMINDERS,
  ReminderSettings.JSON_PROPERTY_CHANNELS
})
...
public class ReminderSettings {
  ...
  public static final String JSON_PROPERTY_INTERVALS_HOURS = "intervals_hours";
  @javax.annotation.Nullable
  private List<Integer> intervalsHours = new ArrayList<>(Arrays.asList(48));

  public static final String JSON_PROPERTY_MAX_REMINDERS = "max_reminders";
  @javax.annotation.Nullable
  private Integer maxReminders = 1;
  ...
  @javax.annotation.Nullable
  private List<ChannelsEnum> channels = new ArrayList<>(Arrays.asList(ChannelsEnum.EMAIL));

  public ReminderSettings() { 
  }

  public ReminderSettings enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public ReminderSettings intervalsHours(@javax.annotation.Nullable List<Integer> intervalsHours) {
    this.intervalsHours = intervalsHours;
    return this;
  }

  public ReminderSettings addIntervalsHoursItem(Integer intervalsHoursItem) {
    if (this.intervalsHours == null) {
      this.intervalsHours = new ArrayList<>(Arrays.asList(48));
    }
    this.intervalsHours.add(intervalsHoursItem);
    return this;
  }
   ...
   * @return intervalsHours
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INTERVALS_HOURS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<Integer> getIntervalsHours() {
    return intervalsHours;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INTERVALS_HOURS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIntervalsHours(@javax.annotation.Nullable List<Integer> intervalsHours) {
    this.intervalsHours = intervalsHours;
  }


  public ReminderSettings maxReminders(@javax.annotation.Nullable Integer maxReminders) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_MAX_REMINDERS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_MAX_REMINDERS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaxReminders(@javax.annotation.Nullable Integer maxReminders) {
    this.maxReminders = maxReminders;
  }


  public ReminderSettings channels(@javax.annotation.Nullable List<ChannelsEnum> channels) {
    this.channels = channels;
    return this;
  }

  public ReminderSettings addChannelsItem(ChannelsEnum channelsItem) {
    if (this.channels == null) {
      this.channels = new ArrayList<>(Arrays.asList(ChannelsEnum.EMAIL));
    }
  ...
  /**
   * Return true if this ReminderSettings object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, reminderSettings.enabled) &&
        Objects.equals(this.intervalsHours, reminderSettings.intervalsHours) &&
        Objects.equals(this.maxReminders, reminderSettings.maxReminders) &&
        Objects.equals(this.channels, reminderSettings.channels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, intervalsHours, maxReminders, channels);
  }
  ...
  public String toString() {
    ...
    sb.append("    intervalsHours: ").append(toIndentedString(intervalsHours)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `intervals_hours` to the URL query string
    if (getIntervalsHours() != null) {
      for (int i = 0; i < getIntervalsHours().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%sintervals_hours%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getIntervalsHours().get(i)))));
      }
    }

    // add `max_reminders` to the URL query string
    if (getMaxReminders() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%smax_reminders%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxReminders()))));
    }
