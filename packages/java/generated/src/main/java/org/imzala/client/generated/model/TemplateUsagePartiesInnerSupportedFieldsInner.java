 ...
 */
@JsonPropertyOrder({
  TemplateUsagePartiesInnerSupportedFieldsInner.JSON_PROPERTY_KEY,
  TemplateUsagePartiesInnerSupportedFieldsInner.JSON_PROPERTY_TYPE,
  TemplateUsagePartiesInnerSupportedFieldsInner.JSON_PROPERTY_REQUIRED,
...
public class TemplateUsagePartiesInnerSupportedFieldsInner {
  ...
  public static final String JSON_PROPERTY_REQUIRED_IF = "required_if";
  @javax.annotation.Nullable
  ...
  public TemplateUsagePartiesInnerSupportedFieldsInner() { 
  }

  public TemplateUsagePartiesInnerSupportedFieldsInner key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TemplateUsagePartiesInnerSupportedFieldsInner type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public TemplateUsagePartiesInnerSupportedFieldsInner required(@javax.annotation.Nullable Boolean required) {
  ...
  public TemplateUsagePartiesInnerSupportedFieldsInner requiredIf(@javax.annotation.Nullable String requiredIf) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_REQUIRED_IF, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_REQUIRED_IF, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRequiredIf(@javax.annotation.Nullable String requiredIf) {
    this.requiredIf = requiredIf;
  }


  public TemplateUsagePartiesInnerSupportedFieldsInner _default(@javax.annotation.Nullable Object _default) {
  ...
  /**
   * Return true if this TemplateUsage_parties_inner_supported_fields_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TemplateUsagePartiesInnerSupportedFieldsInner templateUsagePartiesInnerSupportedFieldsInner = (TemplateUsagePartiesInnerSupportedFieldsInner) o;
    return Objects.equals(this.key, templateUsagePartiesInnerSupportedFieldsInner.key) &&
        Objects.equals(this.type, templateUsagePartiesInnerSupportedFieldsInner.type) &&
        Objects.equals(this.required, templateUsagePartiesInnerSupportedFieldsInner.required) &&
        Objects.equals(this.requiredIf, templateUsagePartiesInnerSupportedFieldsInner.requiredIf) &&
        equalsNullable(this._default, templateUsagePartiesInnerSupportedFieldsInner._default);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, type, required, requiredIf, hashCodeNullable(_default));
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateUsagePartiesInnerSupportedFieldsInner {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `required_if` to the URL query string
    if (getRequiredIf() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%srequired_if%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRequiredIf()))));
    }
