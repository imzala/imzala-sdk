 ...
 */
@JsonPropertyOrder({
  ApiV1TemplatesIdPatch200ResponseData.JSON_PROPERTY_ID,
  ApiV1TemplatesIdPatch200ResponseData.JSON_PROPERTY_NAME,
  ApiV1TemplatesIdPatch200ResponseData.JSON_PROPERTY_DESCRIPTION,
  ApiV1TemplatesIdPatch200ResponseData.JSON_PROPERTY_CATEGORY
})
...
public class ApiV1TemplatesIdPatch200ResponseData {
  ...
  public ApiV1TemplatesIdPatch200ResponseData() { 
  }

  public ApiV1TemplatesIdPatch200ResponseData id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ApiV1TemplatesIdPatch200ResponseData name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ApiV1TemplatesIdPatch200ResponseData description(@javax.annotation.Nullable String description) {
  ...
  public ApiV1TemplatesIdPatch200ResponseData category(@javax.annotation.Nullable String category) {
  ...
  /**
   * Return true if this _api_v1_templates__id__patch_200_response_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiV1TemplatesIdPatch200ResponseData apiV1TemplatesIdPatch200ResponseData = (ApiV1TemplatesIdPatch200ResponseData) o;
    return Objects.equals(this.id, apiV1TemplatesIdPatch200ResponseData.id) &&
        Objects.equals(this.name, apiV1TemplatesIdPatch200ResponseData.name) &&
        equalsNullable(this.description, apiV1TemplatesIdPatch200ResponseData.description) &&
        equalsNullable(this.category, apiV1TemplatesIdPatch200ResponseData.category);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, hashCodeNullable(description), hashCodeNullable(category));
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiV1TemplatesIdPatch200ResponseData {\n");
