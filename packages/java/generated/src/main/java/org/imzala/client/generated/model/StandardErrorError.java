 ...
 */
@JsonPropertyOrder({
  StandardErrorError.JSON_PROPERTY_CODE,
  StandardErrorError.JSON_PROPERTY_MESSAGE,
  StandardErrorError.JSON_PROPERTY_RETRY_AFTER_SECONDS
})
...
public class StandardErrorError {
  /**
   * Gets or Sets code
   */
  public enum CodeEnum {
    INVALID_CHANNELS(String.valueOf("INVALID_CHANNELS")),
    
    DEMAND_NOT_FOUND(String.valueOf("DEMAND_NOT_FOUND")),
    
    ALREADY_COMPLETED(String.valueOf("ALREADY_COMPLETED")),
  ...
  public StandardErrorError() { 
  }

  public StandardErrorError code(@javax.annotation.Nonnull CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  public StandardErrorError message(@javax.annotation.Nonnull String message) {
  ...
  public StandardErrorError retryAfterSeconds(@javax.annotation.Nullable Integer retryAfterSeconds) {
  ...
  /**
   * Return true if this StandardError_error object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StandardErrorError standardErrorError = (StandardErrorError) o;
    return Objects.equals(this.code, standardErrorError.code) &&
        Objects.equals(this.message, standardErrorError.message) &&
        Objects.equals(this.retryAfterSeconds, standardErrorError.retryAfterSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class StandardErrorError {\n");
