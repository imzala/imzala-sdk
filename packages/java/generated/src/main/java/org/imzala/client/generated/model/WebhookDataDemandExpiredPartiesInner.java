 ...
 */
@JsonPropertyOrder({
  WebhookDataDemandExpiredPartiesInner.JSON_PROPERTY_ID,
  WebhookDataDemandExpiredPartiesInner.JSON_PROPERTY_NAME,
  WebhookDataDemandExpiredPartiesInner.JSON_PROPERTY_EMAIL,
  WebhookDataDemandExpiredPartiesInner.JSON_PROPERTY_SIGNED
})
...
public class WebhookDataDemandExpiredPartiesInner {
  ...
  public WebhookDataDemandExpiredPartiesInner() { 
  }

  public WebhookDataDemandExpiredPartiesInner id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookDataDemandExpiredPartiesInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public WebhookDataDemandExpiredPartiesInner email(@javax.annotation.Nullable String email) {
  ...
  public WebhookDataDemandExpiredPartiesInner signed(@javax.annotation.Nullable Boolean signed) {
    this.signed = signed;
    return this;
  }
  ...
  /**
   * Return true if this WebhookDataDemandExpired_parties_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookDataDemandExpiredPartiesInner webhookDataDemandExpiredPartiesInner = (WebhookDataDemandExpiredPartiesInner) o;
    return Objects.equals(this.id, webhookDataDemandExpiredPartiesInner.id) &&
        Objects.equals(this.name, webhookDataDemandExpiredPartiesInner.name) &&
        equalsNullable(this.email, webhookDataDemandExpiredPartiesInner.email) &&
        Objects.equals(this.signed, webhookDataDemandExpiredPartiesInner.signed);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, hashCodeNullable(email), signed);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookDataDemandExpiredPartiesInner {\n");
