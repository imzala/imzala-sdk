 ...
 */
@JsonPropertyOrder({
  WebhookDataDemandCompletedPartiesInner.JSON_PROPERTY_ID,
  WebhookDataDemandCompletedPartiesInner.JSON_PROPERTY_NAME,
  WebhookDataDemandCompletedPartiesInner.JSON_PROPERTY_EMAIL,
  WebhookDataDemandCompletedPartiesInner.JSON_PROPERTY_SIGNED_AT
})
...
public class WebhookDataDemandCompletedPartiesInner {
  ...
  public WebhookDataDemandCompletedPartiesInner() { 
  }

  public WebhookDataDemandCompletedPartiesInner id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookDataDemandCompletedPartiesInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public WebhookDataDemandCompletedPartiesInner email(@javax.annotation.Nullable String email) {
  ...
  public WebhookDataDemandCompletedPartiesInner signedAt(@javax.annotation.Nullable OffsetDateTime signedAt) {
  ...
  /**
   * Return true if this WebhookDataDemandCompleted_parties_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookDataDemandCompletedPartiesInner webhookDataDemandCompletedPartiesInner = (WebhookDataDemandCompletedPartiesInner) o;
    return Objects.equals(this.id, webhookDataDemandCompletedPartiesInner.id) &&
        Objects.equals(this.name, webhookDataDemandCompletedPartiesInner.name) &&
        equalsNullable(this.email, webhookDataDemandCompletedPartiesInner.email) &&
        equalsNullable(this.signedAt, webhookDataDemandCompletedPartiesInner.signedAt);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, hashCodeNullable(email), hashCodeNullable(signedAt));
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookDataDemandCompletedPartiesInner {\n");
