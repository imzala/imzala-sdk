...
import org.imzala.client.generated.model.WebhookDataDemandExpiredPartiesInner;
 ...
 */
@JsonPropertyOrder({
  WebhookDataDemandExpired.JSON_PROPERTY_DEMAND_ID,
  WebhookDataDemandExpired.JSON_PROPERTY_TITLE,
  WebhookDataDemandExpired.JSON_PROPERTY_EXPIRY_DATE,
  WebhookDataDemandExpired.JSON_PROPERTY_PARTIES
})
...
public class WebhookDataDemandExpired {
  ...
  @javax.annotation.Nonnull
  private List<WebhookDataDemandExpiredPartiesInner> parties = new ArrayList<>();

  public WebhookDataDemandExpired() { 
  }

  public WebhookDataDemandExpired demandId(@javax.annotation.Nonnull UUID demandId) {
  ...
  public WebhookDataDemandExpired title(@javax.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public WebhookDataDemandExpired expiryDate(@javax.annotation.Nonnull OffsetDateTime expiryDate) {
  ...
  public WebhookDataDemandExpired parties(@javax.annotation.Nonnull List<WebhookDataDemandExpiredPartiesInner> parties) {
    this.parties = parties;
    return this;
  }

  public WebhookDataDemandExpired addPartiesItem(WebhookDataDemandExpiredPartiesInner partiesItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public List<WebhookDataDemandExpiredPartiesInner> getParties() {
    return parties;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PARTIES, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setParties(@javax.annotation.Nonnull List<WebhookDataDemandExpiredPartiesInner> parties) {
    this.parties = parties;
  }


  /**
   * Return true if this WebhookDataDemandExpired object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookDataDemandExpired webhookDataDemandExpired = (WebhookDataDemandExpired) o;
    return Objects.equals(this.demandId, webhookDataDemandExpired.demandId) &&
        Objects.equals(this.title, webhookDataDemandExpired.title) &&
        Objects.equals(this.expiryDate, webhookDataDemandExpired.expiryDate) &&
        Objects.equals(this.parties, webhookDataDemandExpired.parties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(demandId, title, expiryDate, parties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhookDataDemandExpired {\n");
