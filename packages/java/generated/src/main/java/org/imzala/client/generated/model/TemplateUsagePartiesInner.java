...
import org.imzala.client.generated.model.TemplateUsagePartiesInnerSupportedFieldsInner;
 ...
 */
@JsonPropertyOrder({
  TemplateUsagePartiesInner.JSON_PROPERTY_TEMPLATE_PARTY_ID,
  TemplateUsagePartiesInner.JSON_PROPERTY_ORDER,
  TemplateUsagePartiesInner.JSON_PROPERTY_LABEL,
  TemplateUsagePartiesInner.JSON_PROPERTY_IS_REQUIRED,
  TemplateUsagePartiesInner.JSON_PROPERTY_SUPPORTED_FIELDS
})
...
public class TemplateUsagePartiesInner {
  ...
  public static final String JSON_PROPERTY_SUPPORTED_FIELDS = "supported_fields";
  @javax.annotation.Nullable
  private List<TemplateUsagePartiesInnerSupportedFieldsInner> supportedFields = new ArrayList<>();

  public TemplateUsagePartiesInner() { 
  }

  public TemplateUsagePartiesInner templatePartyId(@javax.annotation.Nullable UUID templatePartyId) {
  ...
  public TemplateUsagePartiesInner order(@javax.annotation.Nullable Integer order) {
    this.order = order;
    return this;
  }
  ...
  public TemplateUsagePartiesInner label(@javax.annotation.Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  public TemplateUsagePartiesInner isRequired(@javax.annotation.Nullable Boolean isRequired) {
  ...
  public TemplateUsagePartiesInner supportedFields(@javax.annotation.Nullable List<TemplateUsagePartiesInnerSupportedFieldsInner> supportedFields) {
    this.supportedFields = supportedFields;
    return this;
  }

  public TemplateUsagePartiesInner addSupportedFieldsItem(TemplateUsagePartiesInnerSupportedFieldsInner supportedFieldsItem) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_SUPPORTED_FIELDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<TemplateUsagePartiesInnerSupportedFieldsInner> getSupportedFields() {
    return supportedFields;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_SUPPORTED_FIELDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSupportedFields(@javax.annotation.Nullable List<TemplateUsagePartiesInnerSupportedFieldsInner> supportedFields) {
    this.supportedFields = supportedFields;
  }


  /**
   * Return true if this TemplateUsage_parties_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TemplateUsagePartiesInner templateUsagePartiesInner = (TemplateUsagePartiesInner) o;
    return Objects.equals(this.templatePartyId, templateUsagePartiesInner.templatePartyId) &&
        Objects.equals(this.order, templateUsagePartiesInner.order) &&
        Objects.equals(this.label, templateUsagePartiesInner.label) &&
        Objects.equals(this.isRequired, templateUsagePartiesInner.isRequired) &&
        Objects.equals(this.supportedFields, templateUsagePartiesInner.supportedFields);
  }

  @Override
  public int hashCode() {
    return Objects.hash(templatePartyId, order, label, isRequired, supportedFields);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TemplateUsagePartiesInner {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `supported_fields` to the URL query string
    if (getSupportedFields() != null) {
      for (int i = 0; i < getSupportedFields().size(); i++) {
        if (getSupportedFields().get(i) != null) {
          joiner.add(getSupportedFields().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%ssupported_fields%s%s", prefix, suffix,
