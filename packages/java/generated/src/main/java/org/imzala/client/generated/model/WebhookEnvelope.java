...
@JsonPropertyOrder({
  ...
  WebhookEnvelope.JSON_PROPERTY_CREATED_AT,
...
public class WebhookEnvelope {
  ...
  public enum TypeEnum {
    DEMAND_CREATED(String.valueOf("demand.created")),
    
    DEMAND_COMPLETED(String.valueOf("demand.completed")),
    
    DEMAND_EXPIRED(String.valueOf("demand.expired")),
    
    PARTY_SIGNED(String.valueOf("party.signed")),
    
    PARTY_VIEWED(String.valueOf("party.viewed")),
    
    PARTY_REJECTED(String.valueOf("party.rejected"));
  ...
  public WebhookEnvelope id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookEnvelope type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public WebhookEnvelope createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public WebhookEnvelope data(@javax.annotation.Nonnull Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webhookEnvelope.id) &&
        ...
        Objects.equals(this.createdAt, webhookEnvelope.createdAt) &&
