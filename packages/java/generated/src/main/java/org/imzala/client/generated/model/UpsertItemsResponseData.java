...
import org.imzala.client.generated.model.UpsertItemsResponseDataItemsInner;
 ...
 */
@JsonPropertyOrder({
  UpsertItemsResponseData.JSON_PROPERTY_ITEMS,
  UpsertItemsResponseData.JSON_PROPERTY_ITEMS_COUNT
})
...
public class UpsertItemsResponseData {
  public static final String JSON_PROPERTY_ITEMS = "items";
  @javax.annotation.Nullable
  private List<UpsertItemsResponseDataItemsInner> items = new ArrayList<>();

  public static final String JSON_PROPERTY_ITEMS_COUNT = "items_count";
  @javax.annotation.Nullable
  private Integer itemsCount;

  public UpsertItemsResponseData() { 
  }

  public UpsertItemsResponseData items(@javax.annotation.Nullable List<UpsertItemsResponseDataItemsInner> items) {
    this.items = items;
    return this;
  }

  public UpsertItemsResponseData addItemsItem(UpsertItemsResponseDataItemsInner itemsItem) {
    if (this.items == null) {
  ...
  public List<UpsertItemsResponseDataItemsInner> getItems() {
    return items;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ITEMS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@javax.annotation.Nullable List<UpsertItemsResponseDataItemsInner> items) {
    this.items = items;
  }


  public UpsertItemsResponseData itemsCount(@javax.annotation.Nullable Integer itemsCount) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ITEMS_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_ITEMS_COUNT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItemsCount(@javax.annotation.Nullable Integer itemsCount) {
    this.itemsCount = itemsCount;
  }


  /**
   * Return true if this UpsertItemsResponse_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpsertItemsResponseData upsertItemsResponseData = (UpsertItemsResponseData) o;
    return Objects.equals(this.items, upsertItemsResponseData.items) &&
        Objects.equals(this.itemsCount, upsertItemsResponseData.itemsCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(items, itemsCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpsertItemsResponseData {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `items_count` to the URL query string
    if (getItemsCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sitems_count%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getItemsCount()))));
    }
