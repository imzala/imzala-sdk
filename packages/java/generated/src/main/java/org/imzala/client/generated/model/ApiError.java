 ...
 */
@JsonPropertyOrder({
  ApiError.JSON_PROPERTY_SUCCESS,
...
public class ApiError {
  ...
  public ApiError success(@javax.annotation.Nullable Boolean success) {
  ...
  public ApiError error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, apiError.success) &&
