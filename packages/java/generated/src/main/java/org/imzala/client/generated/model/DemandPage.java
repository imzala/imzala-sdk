 ...
 */
@JsonPropertyOrder({
  DemandPage.JSON_PROPERTY_ID,
  DemandPage.JSON_PROPERTY_ORDER
})
...
public class DemandPage {
  ...
  public DemandPage id(@javax.annotation.Nonnull Integer id) {
    this.id = id;
    return this;
  }
  ...
  public DemandPage order(@javax.annotation.Nonnull Integer order) {
    this.order = order;
    return this;
  }
  ...
  /**
   * Return true if this DemandPage object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DemandPage demandPage = (DemandPage) o;
    return Objects.equals(this.id, demandPage.id) &&
        Objects.equals(this.order, demandPage.order);
  }
