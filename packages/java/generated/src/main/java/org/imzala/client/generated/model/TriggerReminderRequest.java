 ...
 */
@JsonPropertyOrder({
  TriggerReminderRequest.JSON_PROPERTY_CHANNELS,
  TriggerReminderRequest.JSON_PROPERTY_FORCE
})
...
public class TriggerReminderRequest {
  ...
  private List<ChannelsEnum> channels = new ArrayList<>(Arrays.asList(ChannelsEnum.SMS, ChannelsEnum.EMAIL));

  public static final String JSON_PROPERTY_FORCE = "force";
  @javax.annotation.Nullable
  private Boolean force = false;

  public TriggerReminderRequest() { 
  }

  public TriggerReminderRequest channels(@javax.annotation.Nullable List<ChannelsEnum> channels) {
    this.channels = channels;
    return this;
  }

  public TriggerReminderRequest addChannelsItem(ChannelsEnum channelsItem) {
    if (this.channels == null) {
      this.channels = new ArrayList<>(Arrays.asList(ChannelsEnum.SMS, ChannelsEnum.EMAIL));
    }
  ...
  public TriggerReminderRequest force(@javax.annotation.Nullable Boolean force) {
    this.force = force;
    return this;
  }
  ...
  /**
   * Return true if this TriggerReminderRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TriggerReminderRequest triggerReminderRequest = (TriggerReminderRequest) o;
    return Objects.equals(this.channels, triggerReminderRequest.channels) &&
        Objects.equals(this.force, triggerReminderRequest.force);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channels, force);
  }
