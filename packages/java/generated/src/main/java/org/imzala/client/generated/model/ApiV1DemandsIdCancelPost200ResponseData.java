 ...
 */
@JsonPropertyOrder({
  ApiV1DemandsIdCancelPost200ResponseData.JSON_PROPERTY_ID,
  ApiV1DemandsIdCancelPost200ResponseData.JSON_PROPERTY_TITLE,
  ApiV1DemandsIdCancelPost200ResponseData.JSON_PROPERTY_STATUS,
  ApiV1DemandsIdCancelPost200ResponseData.JSON_PROPERTY_CANCELLED_AT,
  ApiV1DemandsIdCancelPost200ResponseData.JSON_PROPERTY_CANCELLATION_REASON
})
...
public class ApiV1DemandsIdCancelPost200ResponseData {
  ...
  public ApiV1DemandsIdCancelPost200ResponseData() { 
  }

  public ApiV1DemandsIdCancelPost200ResponseData id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ApiV1DemandsIdCancelPost200ResponseData title(@javax.annotation.Nullable String title) {
  ...
  public ApiV1DemandsIdCancelPost200ResponseData status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public ApiV1DemandsIdCancelPost200ResponseData cancelledAt(@javax.annotation.Nullable OffsetDateTime cancelledAt) {
  ...
  public ApiV1DemandsIdCancelPost200ResponseData cancellationReason(@javax.annotation.Nullable String cancellationReason) {
  ...
  /**
   * Return true if this _api_v1_demands__id__cancel_post_200_response_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiV1DemandsIdCancelPost200ResponseData apiV1DemandsIdCancelPost200ResponseData = (ApiV1DemandsIdCancelPost200ResponseData) o;
    return Objects.equals(this.id, apiV1DemandsIdCancelPost200ResponseData.id) &&
        equalsNullable(this.title, apiV1DemandsIdCancelPost200ResponseData.title) &&
        Objects.equals(this.status, apiV1DemandsIdCancelPost200ResponseData.status) &&
        Objects.equals(this.cancelledAt, apiV1DemandsIdCancelPost200ResponseData.cancelledAt) &&
        equalsNullable(this.cancellationReason, apiV1DemandsIdCancelPost200ResponseData.cancellationReason);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, hashCodeNullable(title), status, cancelledAt, hashCodeNullable(cancellationReason));
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiV1DemandsIdCancelPost200ResponseData {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCancelledAt() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%scancelled_at%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCancelledAt()))));
    }

    // add `cancellation_reason` to the URL query string
    if (getCancellationReason() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%scancellation_reason%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCancellationReason()))));
    }
