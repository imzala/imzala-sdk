 ...
 */
@JsonPropertyOrder({
  ApiV1TimestampsPostRequest1.JSON_PROPERTY_FILE_BASE64,
  ApiV1TimestampsPostRequest1.JSON_PROPERTY_FILE_NAME,
  ApiV1TimestampsPostRequest1.JSON_PROPERTY_DESCRIPTION,
...
public class ApiV1TimestampsPostRequest1 {
  ...
  public static final String JSON_PROPERTY_OWNER_FIRST_NAME = "owner_first_name";
  @javax.annotation.Nullable
  private String ownerFirstName;

  public static final String JSON_PROPERTY_OWNER_LAST_NAME = "owner_last_name";
  @javax.annotation.Nullable
  private String ownerLastName;

  public ApiV1TimestampsPostRequest1() { 
  }

  public ApiV1TimestampsPostRequest1 fileBase64(@javax.annotation.Nonnull String fileBase64) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_FILE_BASE64, required = true)
  ...
  @JsonProperty(value = JSON_PROPERTY_FILE_BASE64, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFileBase64(@javax.annotation.Nonnull String fileBase64) {
    this.fileBase64 = fileBase64;
  }


  public ApiV1TimestampsPostRequest1 fileName(@javax.annotation.Nonnull String fileName) {
  ...
  public ApiV1TimestampsPostRequest1 description(@javax.annotation.Nullable String description) {
  ...
  public ApiV1TimestampsPostRequest1 ownerFirstName(@javax.annotation.Nullable String ownerFirstName) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_OWNER_FIRST_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_OWNER_FIRST_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOwnerFirstName(@javax.annotation.Nullable String ownerFirstName) {
    this.ownerFirstName = ownerFirstName;
  }


  public ApiV1TimestampsPostRequest1 ownerLastName(@javax.annotation.Nullable String ownerLastName) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_OWNER_LAST_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_OWNER_LAST_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOwnerLastName(@javax.annotation.Nullable String ownerLastName) {
    this.ownerLastName = ownerLastName;
  }


  /**
   * Return true if this _api_v1_timestamps_post_request_1 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiV1TimestampsPostRequest1 apiV1TimestampsPostRequest1 = (ApiV1TimestampsPostRequest1) o;
    return Objects.equals(this.fileBase64, apiV1TimestampsPostRequest1.fileBase64) &&
        Objects.equals(this.fileName, apiV1TimestampsPostRequest1.fileName) &&
        Objects.equals(this.description, apiV1TimestampsPostRequest1.description) &&
        Objects.equals(this.ownerFirstName, apiV1TimestampsPostRequest1.ownerFirstName) &&
        Objects.equals(this.ownerLastName, apiV1TimestampsPostRequest1.ownerLastName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileBase64, fileName, description, ownerFirstName, ownerLastName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApiV1TimestampsPostRequest1 {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `file_base64` to the URL query string
    if (getFileBase64() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sfile_base64%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getFileBase64()))));
    }
    ...
    // add `owner_first_name` to the URL query string
    if (getOwnerFirstName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sowner_first_name%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getOwnerFirstName()))));
    }

    // add `owner_last_name` to the URL query string
    if (getOwnerLastName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sowner_last_name%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getOwnerLastName()))));
    }
