 ...
 */
@JsonPropertyOrder({
  ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData.JSON_PROPERTY_SENT
})
...
public class ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData {
  public static final String JSON_PROPERTY_SENT = "sent";
  @javax.annotation.Nullable
  private List<String> sent = new ArrayList<>();

  public ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData() { 
  }

  public ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData sent(@javax.annotation.Nullable List<String> sent) {
    this.sent = sent;
    return this;
  }

  public ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData addSentItem(String sentItem) {
    if (this.sent == null) {
  ...
  /**
   * Return true if this _api_v1_demands__id__parties__partyId__resend_post_200_response_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData apiV1DemandsIdPartiesPartyIdResendPost200ResponseData = (ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData) o;
    return Objects.equals(this.sent, apiV1DemandsIdPartiesPartyIdResendPost200ResponseData.sent);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData {\n");
    ...
    if (getSent() != null) {
      for (int i = 0; i < getSent().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%ssent%s%s=%s", prefix, suffix,
            ...
            ApiClient.urlEncode(ApiClient.valueToString(getSent().get(i)))));
      }
    }
