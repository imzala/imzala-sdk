 ...
 */
@JsonPropertyOrder({
  ApiV1DemandsIdRemindersPost429ResponseError.JSON_PROPERTY_CODE,
...
public class ApiV1DemandsIdRemindersPost429ResponseError {
  ...
  public enum CodeEnum {
    ...
    MAX_SMS_REMINDERS_REACHED(String.valueOf("MAX_SMS_REMINDERS_REACHED"));
  ...
  public static final String JSON_PROPERTY_RETRY_AFTER_SECONDS = "retry_after_seconds";
  @javax.annotation.Nullable
  private Integer retryAfterSeconds;

  public ApiV1DemandsIdRemindersPost429ResponseError() { 
  }

  public ApiV1DemandsIdRemindersPost429ResponseError code(@javax.annotation.Nullable CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  public ApiV1DemandsIdRemindersPost429ResponseError message(@javax.annotation.Nullable String message) {
  ...
  public ApiV1DemandsIdRemindersPost429ResponseError retryAfterSeconds(@javax.annotation.Nullable Integer retryAfterSeconds) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_RETRY_AFTER_SECONDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_RETRY_AFTER_SECONDS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRetryAfterSeconds(@javax.annotation.Nullable Integer retryAfterSeconds) {
    this.retryAfterSeconds = retryAfterSeconds;
  }


  /**
   * Return true if this _api_v1_demands__id__reminders_post_429_response_error object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiV1DemandsIdRemindersPost429ResponseError apiV1DemandsIdRemindersPost429ResponseError = (ApiV1DemandsIdRemindersPost429ResponseError) o;
    return Objects.equals(this.code, apiV1DemandsIdRemindersPost429ResponseError.code) &&
        Objects.equals(this.message, apiV1DemandsIdRemindersPost429ResponseError.message) &&
        Objects.equals(this.retryAfterSeconds, apiV1DemandsIdRemindersPost429ResponseError.retryAfterSeconds);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiV1DemandsIdRemindersPost429ResponseError {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `retry_after_seconds` to the URL query string
    if (getRetryAfterSeconds() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sretry_after_seconds%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRetryAfterSeconds()))));
    }
