...
public class DemandsApiTest {
     ...
     */
    @Test
    public void apiV1DemandsGetTest() throws ApiException {
        String status = null;
        String q = null;
        LocalDate from = null;
        LocalDate to = null;
     ...
     */
    @Test
    public void apiV1DemandsIdCancelPostTest() throws ApiException {
        UUID id = null;
        ApiV1DemandsIdCancelPostRequest apiV1DemandsIdCancelPostRequest = null;
        ApiV1DemandsIdCancelPost200Response response = 
        api.apiV1DemandsIdCancelPost(id, apiV1DemandsIdCancelPostRequest);
     ...
     */
    @Test
    public void apiV1DemandsIdCertificateGetTest() throws ApiException {
        UUID id = null;
        String lang = null;
        File response = 
        api.apiV1DemandsIdCertificateGet(id, lang);
     ...
     */
    @Test
    public void apiV1DemandsIdDeleteTest() throws ApiException {
        UUID id = null;
     ...
     */
    @Test
    public void apiV1DemandsIdPartiesPartyIdResendPostTest() throws ApiException {
        UUID id = null;
        UUID partyId = null;
        ApiV1DemandsIdPartiesPartyIdResendPost200Response response = 
     ...
     */
    @Test
    public void apiV1DemandsIdPdfGetTest() throws ApiException {
        UUID id = null;
        File response = 
        api.apiV1DemandsIdPdfGet(id);
     ...
     */
    @Test
    public void apiV1DemandsIdTimelineGetTest() throws ApiException {
        UUID id = null;
        ApiV1DemandsIdTimelineGet200Response response = 
