...
/**
 * API tests for TimestampsApi
 */
@Disabled
public class TimestampsApiTest {

    private final TimestampsApi api = new TimestampsApi();
     ...
     */
    @Test
    public void apiV1TimestampsPostTest() throws ApiException {
        File _file = null;
        String idempotencyKey = null;
        String description = null;
        String ownerFirstName = null;
        String ownerLastName = null;
        ApiV1TimestampsPost201Response response = 
        api.apiV1TimestampsPost(_file, idempotencyKey, description, ownerFirstName, ownerLastName);
