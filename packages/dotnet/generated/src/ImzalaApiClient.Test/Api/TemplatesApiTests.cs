...
namespace ImzalaApiClient.Test.Api
{
    ...
    public class TemplatesApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiV1TemplatesGet
        /// </summary>
        [Fact]
        public void ApiV1TemplatesGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? page = null;
            //int? limit = null;
            //var response = instance.ApiV1TemplatesGet(page, limit);
            //Assert.IsType<ApiV1TemplatesGet200Response>(response);
        }

        /// <summary>
        /// Test ApiV1TemplatesIdDelete
        /// </summary>
        [Fact]
        public void ApiV1TemplatesIdDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid id = null;
            //var response = instance.ApiV1TemplatesIdDelete(id);
            //Assert.IsType<ApiV1TemplatesIdDelete200Response>(response);
        }

        /// <summary>
        /// Test ApiV1TemplatesIdGet
        /// </summary>
        [Fact]
        public void ApiV1TemplatesIdGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid id = null;
            //var response = instance.ApiV1TemplatesIdGet(id);
            //Assert.IsType<ApiV1TemplatesIdGet200Response>(response);
        }

        /// <summary>
        /// Test ApiV1TemplatesIdPatch
        /// </summary>
        [Fact]
        public void ApiV1TemplatesIdPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid id = null;
            //ApiV1TemplatesIdPatchRequest apiV1TemplatesIdPatchRequest = null;
            //var response = instance.ApiV1TemplatesIdPatch(id, apiV1TemplatesIdPatchRequest);
            //Assert.IsType<ApiV1TemplatesIdPatch200Response>(response);
        }

        /// <summary>
        /// Test ApiV1TemplatesIdUsageGet
        /// </summary>
        [Fact]
        public void ApiV1TemplatesIdUsageGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid id = null;
            //var response = instance.ApiV1TemplatesIdUsageGet(id);
            //Assert.IsType<ApiV1TemplatesIdUsageGet200Response>(response);
        }
    }
}
