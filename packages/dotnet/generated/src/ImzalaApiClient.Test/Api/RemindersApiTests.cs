...
namespace ImzalaApiClient.Test.Api
{
    ...
    /// </remarks>
    public class RemindersApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test 'IsType' RemindersApi
            //Assert.IsType<RemindersApi>(instance);
        }

        /// <summary>
        /// Test ApiV1DemandsIdRemindersPost
        /// </summary>
        [Fact]
        public void ApiV1DemandsIdRemindersPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid id = null;
            //TriggerReminderRequest? triggerReminderRequest = null;
            //var response = instance.ApiV1DemandsIdRemindersPost(id, triggerReminderRequest);
            //Assert.IsType<ApiV1DemandsIdRemindersPost200Response>(response);
        }
    }
}
