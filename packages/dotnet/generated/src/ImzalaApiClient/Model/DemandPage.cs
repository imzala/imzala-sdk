...
namespace ImzalaApiClient.Model
{
    ...
    /// DemandPage
    /// </summary>
    [DataContract(Name = "DemandPage")]
    public partial class DemandPage : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DemandPage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DemandPage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DemandPage" /> class.
        /// </summary>
        /// <param name="id">id (required).</param>
        /// <param name="order">1-based sayfa sırası (required).</param>
        public DemandPage(int id = default, int order = default)
        {
            this.Id = id;
            this.Order = order;
        }
        ...
        */
        ...
        /// </summary>
        /// <value>1-based sayfa sırası</value>
        /*
        <example>1</example>
        */
