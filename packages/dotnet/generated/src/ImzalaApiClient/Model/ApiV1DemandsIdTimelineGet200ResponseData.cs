...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_demands__id__timeline_get_200_response_data")]
    public partial class ApiV1DemandsIdTimelineGet200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1DemandsIdTimelineGet200ResponseData" /> class.
        /// </summary>
        /// <param name="events">events.</param>
        public ApiV1DemandsIdTimelineGet200ResponseData(List<ApiV1DemandsIdTimelineGet200ResponseDataEventsInner> events = default)
        {
            this.Events = events;
        }
        ...
        public List<ApiV1DemandsIdTimelineGet200ResponseDataEventsInner> Events { get; set; }
