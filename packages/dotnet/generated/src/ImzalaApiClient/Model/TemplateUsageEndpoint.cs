...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateUsage_endpoint")]
    public partial class TemplateUsageEndpoint : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateUsageEndpoint" /> class.
        /// </summary>
        /// <param name="method">method.</param>
        /// <param name="url">url.</param>
        public TemplateUsageEndpoint(string method = default, string url = default)
        {
            this.Method = method;
            this.Url = url;
        }
        ...
        */
        ...
        /// </summary>
        /*
        <example>https://api-prd.imzala.org/api/v1/demands</example>
        */
