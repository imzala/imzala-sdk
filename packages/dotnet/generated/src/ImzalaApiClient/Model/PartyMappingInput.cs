...
namespace ImzalaApiClient.Model
{
    ...
    /// PartyMappingInput
    /// </summary>
    [DataContract(Name = "PartyMappingInput")]
    public partial class PartyMappingInput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartyMappingInput" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PartyMappingInput() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PartyMappingInput" /> class.
        /// </summary>
        /// <param name="templatePartyId">GET /api/v1/templates/{id} cevabındaki parties[].id (required).</param>
        /// <param name="firstName">firstName (required).</param>
        /// <param name="lastName">lastName (required).</param>
        /// <param name="email">email VEYA phone&#39;dan en az biri zorunlu.</param>
        /// <param name="phone">E.164 format (örn. \&quot;+905551234567\&quot;).</param>
        /// <param name="governmentId">TC kimlik no (11 hane).</param>
        /// <param name="birthDate">ISO 8601 (örn. \&quot;1990-05-15\&quot;).</param>
        /// <param name="sendSms">sendSms (default to true).</param>
        /// <param name="sendEmail">sendEmail (default to true).</param>
        /// <param name="variables">Bu PARTİYE AİT dynamic field&#39;lara gönderilen değerler. Slug bazında eşleşir. Item&#39;ın template_party_id&#39;si bu partiyle aynı olmalı; değilse değişken atlanır ve variables_ignored&#39;a düşürülür. .</param>
        public PartyMappingInput(Guid templatePartyId = default, string firstName = default, string lastName = default, string email = default, string phone = default, string governmentId = default, DateOnly birthDate = default, bool sendSms = true, bool sendEmail = true, Dictionary<string, PartyMappingInputVariablesValue> variables = default)
        {
            this.TemplatePartyId = templatePartyId;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for PartyMappingInput and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for PartyMappingInput and cannot be null");
            }
        ...
        /// </summary>
        /// <value>GET /api/v1/templates/{id} cevabındaki parties[].id</value>
        [DataMember(Name = "template_party_id", IsRequired = true, EmitDefaultValue = true)]
        public Guid TemplatePartyId { get; set; }
        ...
        /// </summary>
        /// <value>email VEYA phone&#39;dan en az biri zorunlu</value>
        ...
        /// </summary>
        /// <value>E.164 format (örn. \&quot;+905551234567\&quot;)</value>
        ...
        /// </summary>
        /// <value>TC kimlik no (11 hane)</value>
        [DataMember(Name = "government_id", EmitDefaultValue = false)]
        public string GovernmentId { get; set; }

        /// <summary>
        /// ISO 8601 (örn. \&quot;1990-05-15\&quot;)
        /// </summary>
        /// <value>ISO 8601 (örn. \&quot;1990-05-15\&quot;)</value>
        ...
        /// </summary>
        /// <value>Bu PARTİYE AİT dynamic field&#39;lara gönderilen değerler. Slug bazında eşleşir. Item&#39;ın template_party_id&#39;si bu partiyle aynı olmalı; değilse değişken atlanır ve variables_ignored&#39;a düşürülür. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TemplatePartyId: ").Append(TemplatePartyId).Append("\n");
