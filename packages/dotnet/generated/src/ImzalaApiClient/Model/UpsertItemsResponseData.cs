...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpsertItemsResponse_data")]
    public partial class UpsertItemsResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertItemsResponseData" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="itemsCount">itemsCount.</param>
        public UpsertItemsResponseData(List<UpsertItemsResponseDataItemsInner> items = default, int itemsCount = default)
        {
            this.Items = items;
        ...
        public List<UpsertItemsResponseDataItemsInner> Items { get; set; }
