...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateSummary_parties_inner")]
    public partial class TemplateSummaryPartiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateSummaryPartiesInner" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="order">order.</param>
        /// <param name="label">label.</param>
        /// <param name="isRequired">isRequired.</param>
        public TemplateSummaryPartiesInner(Guid id = default, int order = default, string label = default, bool isRequired = default)
        {
            this.Id = id;
            this.Order = order;
            this.Label = label;
