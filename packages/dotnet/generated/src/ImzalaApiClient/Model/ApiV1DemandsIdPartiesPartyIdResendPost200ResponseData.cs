...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_demands__id__parties__partyId__resend_post_200_response_data")]
    public partial class ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData" /> class.
        /// </summary>
        /// <param name="sent">Gönderilen kanallar (sms/email/whatsapp).</param>
        public ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData(List<string> sent = default)
        {
            this.Sent = sent;
        }
        ...
        /// </summary>
        /// <value>Gönderilen kanallar (sms/email/whatsapp)</value>
