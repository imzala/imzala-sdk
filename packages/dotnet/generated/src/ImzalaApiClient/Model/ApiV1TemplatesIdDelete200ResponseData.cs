...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_templates__id__delete_200_response_data")]
    public partial class ApiV1TemplatesIdDelete200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1TemplatesIdDelete200ResponseData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="deleted">deleted.</param>
        public ApiV1TemplatesIdDelete200ResponseData(Guid id = default, bool deleted = default)
        {
            this.Id = id;
