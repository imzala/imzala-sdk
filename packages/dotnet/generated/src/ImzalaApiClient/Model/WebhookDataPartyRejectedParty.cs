...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookDataPartyRejected_party")]
    public partial class WebhookDataPartyRejectedParty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataPartyRejectedParty" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookDataPartyRejectedParty() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataPartyRejectedParty" /> class.
        /// </summary>
        ...
        /// <param name="rejectionReason">Tarafın belirttiği sebep (opsiyonel, modal textarea).</param>
        public WebhookDataPartyRejectedParty(Guid id = default, string firstName = default, string lastName = default, string email = default, string rejectionReason = default)
        {
            this.Id = id;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for WebhookDataPartyRejectedParty and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for WebhookDataPartyRejectedParty and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Tarafın belirttiği sebep (opsiyonel, modal textarea)</value>
        [DataMember(Name = "rejection_reason", EmitDefaultValue = true)]
