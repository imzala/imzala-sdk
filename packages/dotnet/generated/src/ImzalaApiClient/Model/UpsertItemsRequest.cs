...
namespace ImzalaApiClient.Model
{
    ...
    /// UpsertItemsRequest
    /// </summary>
    [DataContract(Name = "UpsertItemsRequest")]
    public partial class UpsertItemsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertItemsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpsertItemsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertItemsRequest" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="pageIds">**Opsiyonel.** Verilirse sadece bu sayfaların item&#39;ları replace edilir; diğer sayfalardaki item&#39;lar korunur. Body&#39;deki &#x60;items[].page_id&#x60; değerleri bu listede olmalıdır. Omitted ise tüm sayfaların item&#39;ları replace edilir. .</param>
        public UpsertItemsRequest(List<PageItem> items = default, List<int> pageIds = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for UpsertItemsRequest and cannot be null");
            }
            this.Items = items;
        ...
        /// </summary>
        /// <value>**Opsiyonel.** Verilirse sadece bu sayfaların item&#39;ları replace edilir; diğer sayfalardaki item&#39;lar korunur. Body&#39;deki &#x60;items[].page_id&#x60; değerleri bu listede olmalıdır. Omitted ise tüm sayfaların item&#39;ları replace edilir. </value>
