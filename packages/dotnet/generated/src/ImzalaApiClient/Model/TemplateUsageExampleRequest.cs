...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateUsage_example_request")]
    public partial class TemplateUsageExampleRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateUsageExampleRequest" /> class.
        /// </summary>
        /// <param name="curl">curl komutu, slug&#39;lar dolu.</param>
        /// <param name="json">JSON payload, multi-party-aware (party_mapping[].variables + root variables).</param>
        public TemplateUsageExampleRequest(string curl = default, Object json = default)
        {
            this.Curl = curl;
            this.Json = json;
        }
        ...
        /// </summary>
        /// <value>curl komutu, slug&#39;lar dolu</value>
        [DataMember(Name = "curl", EmitDefaultValue = false)]
        public string Curl { get; set; }

        /// <summary>
        /// JSON payload, multi-party-aware (party_mapping[].variables + root variables)
        /// </summary>
        /// <value>JSON payload, multi-party-aware (party_mapping[].variables + root variables)</value>
