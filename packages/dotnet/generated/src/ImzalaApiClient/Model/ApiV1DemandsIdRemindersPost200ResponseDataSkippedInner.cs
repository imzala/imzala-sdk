...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_demands__id__reminders_post_200_response_data_skipped_inner")]
    public partial class ApiV1DemandsIdRemindersPost200ResponseDataSkippedInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1DemandsIdRemindersPost200ResponseDataSkippedInner" /> class.
        /// </summary>
        /// <param name="partyId">partyId.</param>
        /// <param name="reason">reason.</param>
        public ApiV1DemandsIdRemindersPost200ResponseDataSkippedInner(Guid partyId = default, string reason = default)
        {
        ...
        /// </summary>
        /*
        <example>no_phone_number</example>
        */
