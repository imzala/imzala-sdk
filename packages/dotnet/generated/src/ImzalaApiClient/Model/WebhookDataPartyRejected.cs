...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookDataPartyRejected")]
    public partial class WebhookDataPartyRejected : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataPartyRejected" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookDataPartyRejected() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataPartyRejected" /> class.
        /// </summary>
        /// <param name="demandId">demandId (required).</param>
        /// <param name="party">party (required).</param>
        /// <param name="rejectedAt">rejectedAt (required).</param>
        public WebhookDataPartyRejected(Guid demandId = default, WebhookDataPartyRejectedParty party = default, DateTime rejectedAt = default)
        {
            this.DemandId = demandId;
            // to ensure "party" is required (not null)
            if (party == null)
            {
                throw new ArgumentNullException("party is a required property for WebhookDataPartyRejected and cannot be null");
            }
            this.Party = party;
        ...
        public WebhookDataPartyRejectedParty Party { get; set; }

        /// <summary>
        /// Gets or Sets RejectedAt
        /// </summary>
        [DataMember(Name = "rejected_at", IsRequired = true, EmitDefaultValue = true)]
