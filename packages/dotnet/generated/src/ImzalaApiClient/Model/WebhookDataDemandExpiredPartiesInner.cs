...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookDataDemandExpired_parties_inner")]
    public partial class WebhookDataDemandExpiredPartiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataDemandExpiredPartiesInner" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        /// <param name="email">email.</param>
        /// <param name="signed">Süre dolduğunda imzalamış mıydı?.</param>
        public WebhookDataDemandExpiredPartiesInner(Guid id = default, string name = default, string email = default, bool signed = default)
        {
            this.Id = id;
            this.Name = name;
            this.Email = email;
        ...
        /// </summary>
        /// <value>Süre dolduğunda imzalamış mıydı?</value>
