...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_demands__id__cancel_post_request")]
    public partial class ApiV1DemandsIdCancelPostRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1DemandsIdCancelPostRequest" /> class.
        /// </summary>
        /// <param name="reason">İptal nedeni (opsiyonel).</param>
        public ApiV1DemandsIdCancelPostRequest(string reason = default)
        {
            this.Reason = reason;
        }
        ...
        /// </summary>
        /// <value>İptal nedeni (opsiyonel)</value>
