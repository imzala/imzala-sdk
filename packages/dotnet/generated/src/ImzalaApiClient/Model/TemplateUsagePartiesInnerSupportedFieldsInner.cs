...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateUsage_parties_inner_supported_fields_inner")]
    public partial class TemplateUsagePartiesInnerSupportedFieldsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateUsagePartiesInnerSupportedFieldsInner" /> class.
        /// </summary>
        /// <param name="key">key.</param>
        /// <param name="type">type.</param>
        /// <param name="required">required.</param>
        /// <param name="requiredIf">requiredIf.</param>
        /// <param name="varDefault">varDefault.</param>
        public TemplateUsagePartiesInnerSupportedFieldsInner(string key = default, string type = default, bool required = default, string requiredIf = default, Object varDefault = default)
        {
            this.Key = key;
            this.Type = type;
        ...
        /// <summary>
        /// Gets or Sets RequiredIf
        /// </summary>
        [DataMember(Name = "required_if", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RequiredIf: ").Append(RequiredIf).Append("\n");
