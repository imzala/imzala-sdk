...
namespace ImzalaApiClient.Model
{
    ...
    public partial class TemplateDetail : IValidatableObject
    {
        ...
        public TemplateDetail(Guid id = default, string name = default, string description = default, string category = default, int usageCount = default, List<TemplatePartySummary> parties = default, int pagesCount = default, List<TemplateVariable> variables = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        public List<TemplatePartySummary> Parties { get; set; }

        /// <summary>
        /// Gets or Sets PagesCount
        /// </summary>
        [DataMember(Name = "pages_count", EmitDefaultValue = false)]
