...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_demands__id__cancel_post_200_response_data")]
    public partial class ApiV1DemandsIdCancelPost200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1DemandsIdCancelPost200ResponseData" /> class.
        /// </summary>
        ...
        public ApiV1DemandsIdCancelPost200ResponseData(Guid id = default, string title = default, string status = default, DateTime cancelledAt = default, string cancellationReason = default)
        {
            this.Id = id;
            this.Title = title;
            this.Status = status;
        ...
        */
        ...
        /// </summary>
        [DataMember(Name = "cancellation_reason", EmitDefaultValue = true)]
