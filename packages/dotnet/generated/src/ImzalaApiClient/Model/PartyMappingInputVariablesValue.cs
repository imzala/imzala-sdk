...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(PartyMappingInputVariablesValueJsonConverter))]
    [DataContract(Name = "PartyMappingInput_variables_value")]
    public partial class PartyMappingInputVariablesValue : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartyMappingInputVariablesValue" /> class.
        /// </summary>
        ...
        public PartyMappingInputVariablesValue(string actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
        ...
        public PartyMappingInputVariablesValue(decimal actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance;
        ...
        public PartyMappingInputVariablesValue(bool actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PartyMappingInputVariablesValue {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, PartyMappingInputVariablesValue.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of PartyMappingInputVariablesValue
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of PartyMappingInputVariablesValue</returns>
        public static PartyMappingInputVariablesValue FromJson(string jsonString)
        {
            PartyMappingInputVariablesValue newPartyMappingInputVariablesValue = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newPartyMappingInputVariablesValue;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newPartyMappingInputVariablesValue = new PartyMappingInputVariablesValue(JsonConvert.DeserializeObject<bool>(jsonString, PartyMappingInputVariablesValue.SerializerSettings));
                }
                else
                {
                    newPartyMappingInputVariablesValue = new PartyMappingInputVariablesValue(JsonConvert.DeserializeObject<bool>(jsonString, PartyMappingInputVariablesValue.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newPartyMappingInputVariablesValue = new PartyMappingInputVariablesValue(JsonConvert.DeserializeObject<decimal>(jsonString, PartyMappingInputVariablesValue.SerializerSettings));
                }
                else
                {
                    newPartyMappingInputVariablesValue = new PartyMappingInputVariablesValue(JsonConvert.DeserializeObject<decimal>(jsonString, PartyMappingInputVariablesValue.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newPartyMappingInputVariablesValue = new PartyMappingInputVariablesValue(JsonConvert.DeserializeObject<string>(jsonString, PartyMappingInputVariablesValue.SerializerSettings));
                }
                else
                {
                    newPartyMappingInputVariablesValue = new PartyMappingInputVariablesValue(JsonConvert.DeserializeObject<string>(jsonString, PartyMappingInputVariablesValue.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for PartyMappingInputVariablesValue
    /// </summary>
    public class PartyMappingInputVariablesValueJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(PartyMappingInputVariablesValue).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.String: 
                    return new PartyMappingInputVariablesValue(Convert.ToString(reader.Value));
                case JsonToken.Float: 
                    return new PartyMappingInputVariablesValue(Convert.ToDecimal(reader.Value));
                case JsonToken.Boolean: 
                    return new PartyMappingInputVariablesValue(Convert.ToBoolean(reader.Value));
                case JsonToken.StartObject:
                    return PartyMappingInputVariablesValue.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return PartyMappingInputVariablesValue.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
