...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookDataPartySigned")]
    public partial class WebhookDataPartySigned : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataPartySigned" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookDataPartySigned() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataPartySigned" /> class.
        /// </summary>
        /// <param name="demandId">demandId (required).</param>
        /// <param name="partyId">partyId (required).</param>
        /// <param name="backfill">Replay bayrağı.</param>
        public WebhookDataPartySigned(Guid demandId = default, Guid partyId = default, bool backfill = default)
        {
