...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_demands__id__reminders_post_200_response_data")]
    public partial class ApiV1DemandsIdRemindersPost200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1DemandsIdRemindersPost200ResponseData" /> class.
        /// </summary>
        /// <param name="demandId">demandId.</param>
        /// <param name="dispatched">dispatched.</param>
        /// <param name="skipped">Hatırlatma gönderilmeyen partilerin nedenleriyle birlikte (telefon/email yok, opt-out vs.).</param>
        /// <param name="lastReminderSentAt">lastReminderSentAt.</param>
        public ApiV1DemandsIdRemindersPost200ResponseData(Guid demandId = default, List<ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner> dispatched = default, List<ApiV1DemandsIdRemindersPost200ResponseDataSkippedInner> skipped = default, DateTime lastReminderSentAt = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "demand_id", EmitDefaultValue = false)]
        ...
        public List<ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner> Dispatched { get; set; }

        /// <summary>
        /// Hatırlatma gönderilmeyen partilerin nedenleriyle birlikte (telefon/email yok, opt-out vs.)
        /// </summary>
        /// <value>Hatırlatma gönderilmeyen partilerin nedenleriyle birlikte (telefon/email yok, opt-out vs.)</value>
        [DataMember(Name = "skipped", EmitDefaultValue = false)]
        public List<ApiV1DemandsIdRemindersPost200ResponseDataSkippedInner> Skipped { get; set; }

        /// <summary>
        /// Gets or Sets LastReminderSentAt
        /// </summary>
        [DataMember(Name = "last_reminder_sent_at", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LastReminderSentAt: ").Append(LastReminderSentAt).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
