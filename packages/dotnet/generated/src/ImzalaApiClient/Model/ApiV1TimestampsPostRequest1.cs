...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_timestamps_post_request_1")]
    public partial class ApiV1TimestampsPostRequest1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1TimestampsPostRequest1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApiV1TimestampsPostRequest1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1TimestampsPostRequest1" /> class.
        /// </summary>
        /// <param name="fileBase64">Standart Base64 kodlanmış dosya içeriği (RFC 4648 §4 — A-Za-z0-9+/ alfabesi, &#39;&#x3D;&#39; padding). data URL öneki (&#x60;data:...;base64,&#x60;) ve URL-safe alfabe (&#x60;-_&#x60;) kabul edilmez.  (required).</param>
        /// <param name="fileName">Orijinal dosya adı (uzantısıyla, ör. \&quot;belge.pdf\&quot;) (required).</param>
        /// <param name="description">Kayıt açıklaması (opsiyonel, max 500 karakter).</param>
        /// <param name="ownerFirstName">Dosya sahibinin adı (opsiyonel, kullanıcı beyanı).</param>
        /// <param name="ownerLastName">Dosya sahibinin soyadı (opsiyonel, kullanıcı beyanı).</param>
        public ApiV1TimestampsPostRequest1(string fileBase64 = default, string fileName = default, string description = default, string ownerFirstName = default, string ownerLastName = default)
        {
            // to ensure "fileBase64" is required (not null)
            if (fileBase64 == null)
            {
                throw new ArgumentNullException("fileBase64 is a required property for ApiV1TimestampsPostRequest1 and cannot be null");
            }
            this.FileBase64 = fileBase64;
            // to ensure "fileName" is required (not null)
            if (fileName == null)
            {
                throw new ArgumentNullException("fileName is a required property for ApiV1TimestampsPostRequest1 and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Standart Base64 kodlanmış dosya içeriği (RFC 4648 §4 — A-Za-z0-9+/ alfabesi, &#39;&#x3D;&#39; padding). data URL öneki (&#x60;data:...;base64,&#x60;) ve URL-safe alfabe (&#x60;-_&#x60;) kabul edilmez. </value>
        [DataMember(Name = "file_base64", IsRequired = true, EmitDefaultValue = true)]
        public string FileBase64 { get; set; }

        /// <summary>
        /// Orijinal dosya adı (uzantısıyla, ör. \&quot;belge.pdf\&quot;)
        /// </summary>
        /// <value>Orijinal dosya adı (uzantısıyla, ör. \&quot;belge.pdf\&quot;)</value>
        ...
        /// </summary>
        /// <value>Kayıt açıklaması (opsiyonel, max 500 karakter)</value>
        ...
        /// </summary>
        /// <value>Dosya sahibinin adı (opsiyonel, kullanıcı beyanı)</value>
        [DataMember(Name = "owner_first_name", EmitDefaultValue = false)]
        public string OwnerFirstName { get; set; }

        /// <summary>
        /// Dosya sahibinin soyadı (opsiyonel, kullanıcı beyanı)
        /// </summary>
        /// <value>Dosya sahibinin soyadı (opsiyonel, kullanıcı beyanı)</value>
        [DataMember(Name = "owner_last_name", EmitDefaultValue = false)]
