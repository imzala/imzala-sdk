...
namespace ImzalaApiClient.Model
{
    ...
    /// TimestampRecord
    /// </summary>
    [DataContract(Name = "TimestampRecord")]
    public partial class TimestampRecord : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimestampRecord" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="timestampTime">TÜBİTAK KAMU SM&#39;nin onayladığı damga zamanı (UTC).</param>
        /// <param name="tsaAuthority">Zaman damgası sağlayıcısı.</param>
        /// <param name="fileSha256">Damgalanan dosyanın SHA-256 hash değeri (hex, 64 karakter).</param>
        /// <param name="verifyUrl">Damgayı doğrulamak için URL.</param>
        /// <param name="certificateUrl">Damga sertifikası URL&#39;i.</param>
        /// <param name="creditsUsed">Bu damga için harcanan kredi miktarı.</param>
        /// <param name="creditsRemaining">İşlem sonrası kalan kredi bakiyesi.</param>
        public TimestampRecord(Guid id = default, DateTime timestampTime = default, string tsaAuthority = default, string fileSha256 = default, string verifyUrl = default, string certificateUrl = default, int creditsUsed = default, int creditsRemaining = default)
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>TÜBİTAK KAMU SM&#39;nin onayladığı damga zamanı (UTC)</value>
        [DataMember(Name = "timestamp_time", EmitDefaultValue = false)]
        public DateTime TimestampTime { get; set; }

        /// <summary>
        /// Zaman damgası sağlayıcısı
        /// </summary>
        /// <value>Zaman damgası sağlayıcısı</value>
        /*
        <example>TÜBİTAK KAMU SM</example>
        */
        [DataMember(Name = "tsa_authority", EmitDefaultValue = false)]
        public string TsaAuthority { get; set; }

        /// <summary>
        /// Damgalanan dosyanın SHA-256 hash değeri (hex, 64 karakter)
        /// </summary>
        /// <value>Damgalanan dosyanın SHA-256 hash değeri (hex, 64 karakter)</value>
        /*
        <example>a3f8b1c2d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1</example>
        */
        [DataMember(Name = "file_sha256", EmitDefaultValue = false)]
        public string FileSha256 { get; set; }

        /// <summary>
        /// Damgayı doğrulamak için URL
        /// </summary>
        /// <value>Damgayı doğrulamak için URL</value>
        /*
        <example>https://imzala.org/dogrula?seri&#x3D;&lt;id&gt;</example>
        */
        [DataMember(Name = "verify_url", EmitDefaultValue = false)]
        public string VerifyUrl { get; set; }

        /// <summary>
        /// Damga sertifikası URL&#39;i
        /// </summary>
        /// <value>Damga sertifikası URL&#39;i</value>
        /*
        <example>https://imzala.org/dogrula?seri&#x3D;&lt;id&gt;</example>
        */
        [DataMember(Name = "certificate_url", EmitDefaultValue = false)]
        public string CertificateUrl { get; set; }

        /// <summary>
        /// Bu damga için harcanan kredi miktarı
        /// </summary>
        /// <value>Bu damga için harcanan kredi miktarı</value>
        /*
        <example>4</example>
        */
        [DataMember(Name = "credits_used", EmitDefaultValue = false)]
        public int CreditsUsed { get; set; }

        /// <summary>
        /// İşlem sonrası kalan kredi bakiyesi
        /// </summary>
        /// <value>İşlem sonrası kalan kredi bakiyesi</value>
        /*
        <example>0</example>
        */
        [DataMember(Name = "credits_remaining", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TsaAuthority: ").Append(TsaAuthority).Append("\n");
