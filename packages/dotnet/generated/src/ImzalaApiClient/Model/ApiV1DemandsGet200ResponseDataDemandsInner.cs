...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_demands_get_200_response_data_demands_inner")]
    public partial class ApiV1DemandsGet200ResponseDataDemandsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1DemandsGet200ResponseDataDemandsInner" /> class.
        /// </summary>
        ...
        /// <param name="partiesTotal">partiesTotal.</param>
        /// <param name="partiesSigned">partiesSigned.</param>
        /// <param name="pdfUrl">COMPLETED ise imzalı PDF public URL&#39;i.</param>
        public ApiV1DemandsGet200ResponseDataDemandsInner(Guid id = default, string title = default, string status = default, DateTime createdAt = default, DateTime? completedAt = default, int partiesTotal = default, int partiesSigned = default, string pdfUrl = default)
        {
            this.Id = id;
            this.Title = title;
            this.Status = status;
        ...
        /// <summary>
        /// Gets or Sets PartiesTotal
        /// </summary>
        [DataMember(Name = "parties_total", EmitDefaultValue = false)]
        public int PartiesTotal { get; set; }

        /// <summary>
        /// Gets or Sets PartiesSigned
        /// </summary>
        [DataMember(Name = "parties_signed", EmitDefaultValue = false)]
        public int PartiesSigned { get; set; }

        /// <summary>
        /// COMPLETED ise imzalı PDF public URL&#39;i
        /// </summary>
        /// <value>COMPLETED ise imzalı PDF public URL&#39;i</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PartiesTotal: ").Append(PartiesTotal).Append("\n");
            sb.Append("  PartiesSigned: ").Append(PartiesSigned).Append("\n");
