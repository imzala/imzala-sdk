...
namespace ImzalaApiClient.Model
{
    ...
    public partial class TemplateSummary : IValidatableObject
    {
        ...
        public TemplateSummary(Guid id = default, string name = default, string description = default, string category = default, int usageCount = default, List<TemplateSummaryPartiesInner> parties = default)
        {
            this.Id = id;
            this.Name = name;
        ...
        public List<TemplateSummaryPartiesInner> Parties { get; set; }
