...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_demands_get_200_response_data")]
    public partial class ApiV1DemandsGet200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1DemandsGet200ResponseData" /> class.
        /// </summary>
        /// <param name="demands">demands.</param>
        /// <param name="total">total.</param>
        /// <param name="page">page.</param>
        /// <param name="limit">limit.</param>
        public ApiV1DemandsGet200ResponseData(List<ApiV1DemandsGet200ResponseDataDemandsInner> demands = default, int total = default, int page = default, int limit = default)
        {
        ...
        public List<ApiV1DemandsGet200ResponseDataDemandsInner> Demands { get; set; }
