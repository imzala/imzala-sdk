...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_templates__id__patch_request")]
    public partial class ApiV1TemplatesIdPatchRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1TemplatesIdPatchRequest" /> class.
        /// </summary>
        /// <param name="name">name.</param>
        /// <param name="description">description.</param>
        /// <param name="category">category.</param>
        public ApiV1TemplatesIdPatchRequest(string name = default, string description = default, string category = default)
        {
            this.Name = name;
