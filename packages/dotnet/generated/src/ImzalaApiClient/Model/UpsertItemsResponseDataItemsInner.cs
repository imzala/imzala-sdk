...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpsertItemsResponse_data_items_inner")]
    public partial class UpsertItemsResponseDataItemsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertItemsResponseDataItemsInner" /> class.
        /// </summary>
        ...
        public UpsertItemsResponseDataItemsInner(Guid id = default, int pageId = default, Guid? partyId = default, string itemType = default, decimal positionX = default, decimal positionY = default, decimal width = default, decimal height = default, bool isRequired = default, string slug = default, string label = default, Object config = default)
        {
            this.Id = id;
            this.PageId = pageId;
        ...
        /// </summary>
        [DataMember(Name = "position_x", EmitDefaultValue = false)]
        public decimal PositionX { get; set; }

        /// <summary>
        /// Gets or Sets PositionY
        /// </summary>
        [DataMember(Name = "position_y", EmitDefaultValue = false)]
