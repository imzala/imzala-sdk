...
namespace ImzalaApiClient.Model
{
    ...
    public partial class DemandStatusPartiesInner : IValidatableObject
    {
        ...
        public DemandStatusPartiesInner(Guid partyId = default, string firstName = default, string lastName = default, string email = default, bool signed = default, DateTime? signedAt = default, string signingUrl = default)
        {
