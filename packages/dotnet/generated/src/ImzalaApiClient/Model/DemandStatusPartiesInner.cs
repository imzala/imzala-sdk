...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DemandStatus_parties_inner")]
    public partial class DemandStatusPartiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DemandStatusPartiesInner" /> class.
        /// </summary>
        /// <param name="partyId">partyId.</param>
        /// <param name="name">Kısaltılmış görünen ad (Ahmet Y.) — KVKK maskeleme.</param>
        /// <param name="emailMasked">Maskeli e-posta (ah***@x.com).</param>
        /// <param name="signed">signed.</param>
        /// <param name="signedAt">signedAt.</param>
        /// <param name="rejected">rejected.</param>
        /// <param name="rejectedAt">rejectedAt.</param>
        /// <param name="signingUrl">signingUrl.</param>
        public DemandStatusPartiesInner(Guid partyId = default, string name = default, string emailMasked = default, bool signed = default, DateTime? signedAt = default, bool rejected = default, DateTime? rejectedAt = default, string signingUrl = default)
        {
        ...
        /// </summary>
        /// <value>Kısaltılmış görünen ad (Ahmet Y.) — KVKK maskeleme</value>
        ...
        /// </summary>
        /// <value>Maskeli e-posta (ah***@x.com)</value>
        [DataMember(Name = "email_masked", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "signing_url", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EmailMasked: ").Append(EmailMasked).Append("\n");
