...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookDataDemandCompleted_parties_inner")]
    public partial class WebhookDataDemandCompletedPartiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataDemandCompletedPartiesInner" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">first_name + last_name.</param>
        /// <param name="email">email.</param>
        /// <param name="signedAt">signedAt.</param>
        public WebhookDataDemandCompletedPartiesInner(Guid id = default, string name = default, string email = default, DateTime? signedAt = default)
        {
            this.Id = id;
            this.Name = name;
            this.Email = email;
