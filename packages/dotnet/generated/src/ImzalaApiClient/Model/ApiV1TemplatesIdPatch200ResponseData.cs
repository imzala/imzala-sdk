...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_templates__id__patch_200_response_data")]
    public partial class ApiV1TemplatesIdPatch200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1TemplatesIdPatch200ResponseData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        /// <param name="description">description.</param>
        /// <param name="category">category.</param>
        public ApiV1TemplatesIdPatch200ResponseData(Guid id = default, string name = default, string description = default, string category = default)
        {
            this.Id = id;
            this.Name = name;
