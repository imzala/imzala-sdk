...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookDataDemandExpired")]
    public partial class WebhookDataDemandExpired : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataDemandExpired" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookDataDemandExpired() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataDemandExpired" /> class.
        /// </summary>
        ...
        public WebhookDataDemandExpired(Guid demandId = default, string title = default, DateTime expiryDate = default, List<WebhookDataDemandExpiredPartiesInner> parties = default)
        {
            this.DemandId = demandId;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for WebhookDataDemandExpired and cannot be null");
            }
            this.Title = title;
            ...
            if (parties == null)
            {
                throw new ArgumentNullException("parties is a required property for WebhookDataDemandExpired and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "expiry_date", IsRequired = true, EmitDefaultValue = true)]
        ...
        public List<WebhookDataDemandExpiredPartiesInner> Parties { get; set; }
