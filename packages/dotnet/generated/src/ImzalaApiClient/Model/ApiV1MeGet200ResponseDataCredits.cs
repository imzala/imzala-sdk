...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_me_get_200_response_data_credits")]
    public partial class ApiV1MeGet200ResponseDataCredits : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1MeGet200ResponseDataCredits" /> class.
        /// </summary>
        /// <param name="remaining">remaining.</param>
        public ApiV1MeGet200ResponseDataCredits(int remaining = default)
        {
