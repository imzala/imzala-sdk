...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_templates_get_401_response")]
    public partial class ApiV1TemplatesGet401Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1TemplatesGet401Response" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="error">error.</param>
        /// <param name="message">message.</param>
        public ApiV1TemplatesGet401Response(bool success = default, string error = default, string message = default)
        {
        ...
        */
        ...
        /// </summary>
        /*
        <example>Invalid or missing X-API-Key header</example>
        */
