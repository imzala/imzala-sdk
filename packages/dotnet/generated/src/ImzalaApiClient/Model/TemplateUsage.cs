...
namespace ImzalaApiClient.Model
{
    ...
    public partial class TemplateUsage : IValidatableObject
    {
        ...
        public TemplateUsage(TemplateUsageTemplate template = default, TemplateUsageEndpoint endpoint = default, Dictionary<string, string> requiredHeaders = default, List<TemplateUsagePartiesInner> parties = default, List<TemplateUsageVariablesInner> variables = default, TemplateUsageExampleRequest exampleRequest = default)
        {
        ...
        public TemplateUsageTemplate Template { get; set; }
