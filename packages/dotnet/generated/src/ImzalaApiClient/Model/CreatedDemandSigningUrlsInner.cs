...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreatedDemand_signing_urls_inner")]
    public partial class CreatedDemandSigningUrlsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatedDemandSigningUrlsInner" /> class.
        /// </summary>
        ...
        public CreatedDemandSigningUrlsInner(Guid partyId = default, string firstName = default, string lastName = default, string email = default, string phone = default, string signingUrl = default)
        {
        ...
        /// </summary>
        /*
        <example>https://e.imzala.org/imza/&lt;party_id&gt;</example>
        */
