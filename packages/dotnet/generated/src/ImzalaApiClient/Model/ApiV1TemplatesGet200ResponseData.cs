...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_templates_get_200_response_data")]
    public partial class ApiV1TemplatesGet200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1TemplatesGet200ResponseData" /> class.
        /// </summary>
        /// <param name="templates">templates.</param>
        /// <param name="total">total.</param>
        /// <param name="page">page.</param>
        /// <param name="limit">limit.</param>
        public ApiV1TemplatesGet200ResponseData(List<TemplateSummary> templates = default, int total = default, int page = default, int limit = default)
        {
