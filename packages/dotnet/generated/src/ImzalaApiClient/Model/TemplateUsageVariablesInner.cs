...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateUsage_variables_inner")]
    public partial class TemplateUsageVariablesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateUsageVariablesInner" /> class.
        /// </summary>
        /// <param name="slug">slug.</param>
        /// <param name="label">label.</param>
        /// <param name="itemType">itemType.</param>
        /// <param name="isRequired">isRequired.</param>
        /// <param name="defaultSource">defaultSource.</param>
        /// <param name="autoFilled">autoFilled.</param>
        /// <param name="templatePartyId">templatePartyId.</param>
        /// <param name="note">note.</param>
        public TemplateUsageVariablesInner(string slug = default, string label = default, string itemType = default, bool isRequired = default, string defaultSource = default, bool autoFilled = default, string templatePartyId = default, string note = default)
        {
            this.Slug = slug;
            this.Label = label;
        ...
        /// <summary>
        /// Gets or Sets AutoFilled
        /// </summary>
        [DataMember(Name = "auto_filled", EmitDefaultValue = true)]
        public bool AutoFilled { get; set; }

        /// <summary>
        /// Gets or Sets TemplatePartyId
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AutoFilled: ").Append(AutoFilled).Append("\n");
