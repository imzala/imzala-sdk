...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_api_v1_demands__id__timeline_get_200_response_data_events_inner")]
    public partial class ApiV1DemandsIdTimelineGet200ResponseDataEventsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiV1DemandsIdTimelineGet200ResponseDataEventsInner" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="eventType">eventType.</param>
        /// <param name="actorLabel">actorLabel.</param>
        /// <param name="ipMasked">ipMasked.</param>
        /// <param name="deviceLabel">deviceLabel.</param>
        /// <param name="commentText">commentText.</param>
        /// <param name="createdAt">createdAt.</param>
        public ApiV1DemandsIdTimelineGet200ResponseDataEventsInner(string id = default, string eventType = default, string actorLabel = default, string ipMasked = default, string deviceLabel = default, string commentText = default, DateTime createdAt = default)
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets ActorLabel
        /// </summary>
        [DataMember(Name = "actor_label", EmitDefaultValue = true)]
        public string ActorLabel { get; set; }

        /// <summary>
        /// Gets or Sets IpMasked
        /// </summary>
        [DataMember(Name = "ip_masked", EmitDefaultValue = true)]
        public string IpMasked { get; set; }

        /// <summary>
        /// Gets or Sets DeviceLabel
        /// </summary>
        [DataMember(Name = "device_label", EmitDefaultValue = true)]
        public string DeviceLabel { get; set; }

        /// <summary>
        /// Gets or Sets CommentText
        /// </summary>
        [DataMember(Name = "comment_text", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ActorLabel: ").Append(ActorLabel).Append("\n");
            sb.Append("  IpMasked: ").Append(IpMasked).Append("\n");
