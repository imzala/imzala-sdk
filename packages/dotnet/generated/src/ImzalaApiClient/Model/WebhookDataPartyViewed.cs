...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookDataPartyViewed")]
    public partial class WebhookDataPartyViewed : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataPartyViewed" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookDataPartyViewed() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataPartyViewed" /> class.
        /// </summary>
        /// <param name="demandId">demandId (required).</param>
        /// <param name="partyId">partyId (required).</param>
        public WebhookDataPartyViewed(Guid demandId = default, Guid partyId = default)
        {
