...
namespace ImzalaApiClient.Model
{
    ...
    /// UpsertItemsResponse
    /// </summary>
    [DataContract(Name = "UpsertItemsResponse")]
    public partial class UpsertItemsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertItemsResponse" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="data">data.</param>
        public UpsertItemsResponse(bool success = default, UpsertItemsResponseData data = default)
        {
        ...
        public UpsertItemsResponseData Data { get; set; }
