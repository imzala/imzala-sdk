...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateUsage_parties_inner")]
    public partial class TemplateUsagePartiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateUsagePartiesInner" /> class.
        /// </summary>
        /// <param name="templatePartyId">templatePartyId.</param>
        /// <param name="order">order.</param>
        /// <param name="label">label.</param>
        /// <param name="isRequired">isRequired.</param>
        /// <param name="supportedFields">supportedFields.</param>
        public TemplateUsagePartiesInner(Guid templatePartyId = default, int order = default, string label = default, bool isRequired = default, List<TemplateUsagePartiesInnerSupportedFieldsInner> supportedFields = default)
        {
        ...
        /// </summary>
        [DataMember(Name = "template_party_id", EmitDefaultValue = false)]
        ...
        public List<TemplateUsagePartiesInnerSupportedFieldsInner> SupportedFields { get; set; }
