...
namespace ImzalaApiClient.Model
{
    ...
    /// DemandStatus
    /// </summary>
    [DataContract(Name = "DemandStatus")]
    public partial class DemandStatus : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DemandStatus" /> class.
        /// </summary>
        ...
        /// <param name="pdfUrl">Sadece status&#x3D;COMPLETED iken dolu.</param>
        public DemandStatus(Guid id = default, string title = default, StatusEnum? status = default, DateTime createdAt = default, DateTime? completedAt = default, List<DemandStatusPartiesInner> parties = default, string resultUrl = default, string pdfUrl = default)
        {
            this.Id = id;
            this.Title = title;
            this.Status = status;
        ...
        public List<DemandStatusPartiesInner> Parties { get; set; }
        ...
        /// </summary>
        /// <value>Sadece status&#x3D;COMPLETED iken dolu</value>
