...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateUsage_template")]
    public partial class TemplateUsageTemplate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateUsageTemplate" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        /// <param name="description">description.</param>
        /// <param name="category">category.</param>
        public TemplateUsageTemplate(Guid id = default, string name = default, string description = default, string category = default)
        {
            this.Id = id;
            this.Name = name;
