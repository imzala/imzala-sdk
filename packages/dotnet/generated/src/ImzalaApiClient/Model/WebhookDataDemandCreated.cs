...
namespace ImzalaApiClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookDataDemandCreated")]
    public partial class WebhookDataDemandCreated : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataDemandCreated" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookDataDemandCreated() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookDataDemandCreated" /> class.
        /// </summary>
        /// <param name="demandId">demandId (required).</param>
        /// <param name="title">title (required).</param>
        /// <param name="backfill">Geçmiş event&#39;i replay etmek için bayrak. Receiver yan etkileri (e-posta gönderme, ödeme tetikleme vs.) atlamalı. .</param>
        public WebhookDataDemandCreated(Guid demandId = default, string title = default, bool backfill = default)
        {
            this.DemandId = demandId;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for WebhookDataDemandCreated and cannot be null");
            }
            this.Title = title;
        ...
        /// </summary>
        /// <value>Geçmiş event&#39;i replay etmek için bayrak. Receiver yan etkileri (e-posta gönderme, ödeme tetikleme vs.) atlamalı. </value>
