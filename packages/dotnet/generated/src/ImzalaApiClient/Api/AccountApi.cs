...
namespace ImzalaApiClient.Api
{
    ...
    public interface IAccountApiSync : IApiAccessor
    {
        ...
        /// <returns>ApiV1MeGet200Response</returns>
        ...
        /// </remarks>
        /// <exception cref="ImzalaApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of ApiV1MeGet200Response</returns>
    ...
    public interface IAccountApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of ApiV1MeGet200Response</returns>
        System.Threading.Tasks.Task<ApiV1MeGet200Response> ApiV1MeGetAsync(System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ImzalaApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiV1MeGet200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiV1MeGet200Response>> ApiV1MeGetWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class AccountApi : IDisposable, IAccountApi
    {
        ...
        /// <returns></returns>
        public AccountApi(ImzalaApiClient.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public AccountApi(HttpClient client, ImzalaApiClient.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public AccountApi(ImzalaApiClient.Client.ISynchronousClient client, ImzalaApiClient.Client.IAsynchronousClient asyncClient, ImzalaApiClient.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <summary>
        /// API key sahibi bilgisi Çağrıyı yapan API key&#39;in sahibi hakkında temel bilgileri döner: kullanıcı kimliği, e-posta, isim, aktif workspace ve kalan kredi. &#x60;timestamps&#x60; scope&#39;u gerektirir; scope yoksa 403 &#x60;INSUFFICIENT_SCOPE&#x60; döner. 
        /// </summary>
        /// <exception cref="ImzalaApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiV1MeGet200Response</returns>
        public ApiV1MeGet200Response ApiV1MeGet()
        {
            ImzalaApiClient.Client.ApiResponse<ApiV1MeGet200Response> localVarResponse = ApiV1MeGetWithHttpInfo();
        ...
        /// <exception cref="ImzalaApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of ApiV1MeGet200Response</returns>
        public ImzalaApiClient.Client.ApiResponse<ApiV1MeGet200Response> ApiV1MeGetWithHttpInfo()
        {
            ...
            var localVarResponse = this.Client.Get<ApiV1MeGet200Response>("/api/v1/me", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiV1MeGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiV1MeGet200Response</returns>
        public async System.Threading.Tasks.Task<ApiV1MeGet200Response> ApiV1MeGetAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            ImzalaApiClient.Client.ApiResponse<ApiV1MeGet200Response> localVarResponse = await ApiV1MeGetWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiV1MeGet200Response)</returns>
        public async System.Threading.Tasks.Task<ImzalaApiClient.Client.ApiResponse<ApiV1MeGet200Response>> ApiV1MeGetWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ApiV1MeGet200Response>("/api/v1/me", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
