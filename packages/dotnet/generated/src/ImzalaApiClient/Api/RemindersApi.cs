...
namespace ImzalaApiClient.Api
{
    ...
    /// </summary>
    public interface IRemindersApiSync : IApiAccessor
    {
        ...
        /// <param name="triggerReminderRequest"> (optional)</param>
        /// <returns>ApiV1DemandsIdRemindersPost200Response</returns>
        ApiV1DemandsIdRemindersPost200Response ApiV1DemandsIdRemindersPost(Guid id, TriggerReminderRequest? triggerReminderRequest = default);
        ...
        /// <param name="id">Sözleşme (demand) ID</param>
        /// <param name="triggerReminderRequest"> (optional)</param>
        /// <returns>ApiResponse of ApiV1DemandsIdRemindersPost200Response</returns>
        ApiResponse<ApiV1DemandsIdRemindersPost200Response> ApiV1DemandsIdRemindersPostWithHttpInfo(Guid id, TriggerReminderRequest? triggerReminderRequest = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRemindersApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of ApiV1DemandsIdRemindersPost200Response</returns>
        System.Threading.Tasks.Task<ApiV1DemandsIdRemindersPost200Response> ApiV1DemandsIdRemindersPostAsync(Guid id, TriggerReminderRequest? triggerReminderRequest = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="triggerReminderRequest"> (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiV1DemandsIdRemindersPost200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiV1DemandsIdRemindersPost200Response>> ApiV1DemandsIdRemindersPostWithHttpInfoAsync(Guid id, TriggerReminderRequest? triggerReminderRequest = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRemindersApi : IRemindersApiSync, IRemindersApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class RemindersApi : IDisposable, IRemindersApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public RemindersApi() : this((string)null)
        {
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemindersApi"/> class using Configuration object.
        /// **IMPORTANT** This will also create an instance of HttpClient, which is less than ideal.
        /// It's better to reuse the <see href="https://docs.microsoft.com/en-us/dotnet/architecture/microservices/implement-resilient-applications/use-httpclientfactory-to-implement-resilient-http-requests#issues-with-the-original-httpclient-class-available-in-net">HttpClient and HttpClientHandler</see>.
        /// </summary>
        ...
        /// <returns></returns>
        public RemindersApi(ImzalaApiClient.Client.Configuration configuration)
        {
        ...
        /// </remarks>
        public RemindersApi(HttpClient client, HttpClientHandler handler = null) : this(client, (string)null, handler)
        {
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public RemindersApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public RemindersApi(HttpClient client, ImzalaApiClient.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public RemindersApi(ImzalaApiClient.Client.ISynchronousClient client, ImzalaApiClient.Client.IAsynchronousClient asyncClient, ImzalaApiClient.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <summary>
        /// Anlık hatırlatma tetikle (imzalanmamış taraflara) Sözleşmenin **henüz imzalamamış** taraflarına SMS ve/veya e-posta hatırlatması anlık olarak gönderir. Şablon-/sözleşme-seviyesi &#x60;reminder_settings&#x60; ayarından **bağımsız** olarak çalışır — istediğiniz zaman elle tetiklenebilir.  **Anti-spam koruması:** Aynı sözleşme için son hatırlatmanın üzerinden 5 dakika geçmemişse 429 &#x60;RATE_LIMITED&#x60; döner ve &#x60;Retry-After&#x60; header&#39;ı ile &#x60;retry_after_seconds&#x60; alanı bilgilendirir. Override için body&#39;de &#x60;force: true&#x60; yollayın (yanlışlıkla spam atmamak için kasıtlı kullanın).  **Kişi başına sert sınırlar (override edilemez):** Spam ve gönderici reputasyon koruması için kişi-başına reminder sayısı sınırlıdır:  - **Bir kişiye en fazla 3 SMS reminder** gönderilebilir (otomatik   scheduled + manuel trigger toplam). Sayaç dolu kişi için SMS skip   edilir, &#x60;details[]&#x60; içinde &#x60;reason: \&quot;party_sms_cap_reached (3)\&quot;&#x60; görünür. - **Bir kişiye en fazla 3 e-posta reminder** gönderilebilir. Sayaç   dolu kişi için email skip edilir, &#x60;reason: \&quot;party_email_cap_reached (3)\&quot;&#x60;. - Diğer kişilere gönderim normal şekilde devam eder; tek bir kişinin   sayacı dolu diye tüm çağrı reddedilmez. - &#x60;force: true&#x60; 5dk anti-spam pencereyi override eder ama kişi-başı   cap&#39;i ASLA — sert kural. - Sözleşme başına global cap pratikte yok (&#x60;999&#x60; safety net) — kural   kişi başınadır.  Sayım kaynağı: &#x60;ReminderLog&#x60; tablosu (channel + party_id, &#x60;status&#x3D;&#39;SENT&#39;&#x60;). Hem otomatik scheduled (ReminderWorker) hem manuel trigger reminders tek toplamda sayılır.  **Workspace izolasyonu:** &#x60;X-Workspace-Id&#x60; header&#39;ıyla erişilen organizasyonun sözleşmesi olmalıdır; aksi halde 404 &#x60;DEMAND_NOT_FOUND&#x60; (IDOR shield).  **Kanal eligibility:** Bir parti için - &#x60;email&#x60; kanalı: &#x60;party.email&#x60; dolu **ve** &#x60;party.send_email&#x3D;true&#x60; **ve**   &#x60;demand.send_email_notifications&#x3D;true&#x60; ise gönderilir - &#x60;sms&#x60; kanalı: &#x60;party.phone&#x60; dolu **ve** &#x60;party.send_sms&#x3D;true&#x60; **ve**   &#x60;demand.send_sms_notifications&#x3D;true&#x60; ise gönderilir  **Mesaj içeriği:** Şablonun &#x60;sms_reminder_message&#x60; alanı (varsa) + &#x60;signer.first_name&#x60; / &#x60;{{name}}&#x60; / &#x60;{{link}}&#x60; gibi sistem değişkenleri substitute edilir. Şablonda yoksa sistem default reminder mesajı kullanılır. 
        /// </summary>
        /// <exception cref="ImzalaApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Sözleşme (demand) ID</param>
        /// <param name="triggerReminderRequest"> (optional)</param>
        /// <returns>ApiV1DemandsIdRemindersPost200Response</returns>
        public ApiV1DemandsIdRemindersPost200Response ApiV1DemandsIdRemindersPost(Guid id, TriggerReminderRequest? triggerReminderRequest = default)
        {
            ImzalaApiClient.Client.ApiResponse<ApiV1DemandsIdRemindersPost200Response> localVarResponse = ApiV1DemandsIdRemindersPostWithHttpInfo(id, triggerReminderRequest);
        ...
        /// <param name="triggerReminderRequest"> (optional)</param>
        /// <returns>ApiResponse of ApiV1DemandsIdRemindersPost200Response</returns>
        public ImzalaApiClient.Client.ApiResponse<ApiV1DemandsIdRemindersPost200Response> ApiV1DemandsIdRemindersPostWithHttpInfo(Guid id, TriggerReminderRequest? triggerReminderRequest = default)
        {
            ...
            localVarRequestOptions.Data = triggerReminderRequest;
            ...
            var localVarResponse = this.Client.Post<ApiV1DemandsIdRemindersPost200Response>("/api/v1/demands/{id}/reminders", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiV1DemandsIdRemindersPost", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiV1DemandsIdRemindersPost200Response</returns>
        public async System.Threading.Tasks.Task<ApiV1DemandsIdRemindersPost200Response> ApiV1DemandsIdRemindersPostAsync(Guid id, TriggerReminderRequest? triggerReminderRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ImzalaApiClient.Client.ApiResponse<ApiV1DemandsIdRemindersPost200Response> localVarResponse = await ApiV1DemandsIdRemindersPostWithHttpInfoAsync(id, triggerReminderRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiV1DemandsIdRemindersPost200Response)</returns>
        public async System.Threading.Tasks.Task<ImzalaApiClient.Client.ApiResponse<ApiV1DemandsIdRemindersPost200Response>> ApiV1DemandsIdRemindersPostWithHttpInfoAsync(Guid id, TriggerReminderRequest? triggerReminderRequest = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<ApiV1DemandsIdRemindersPost200Response>("/api/v1/demands/{id}/reminders", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
