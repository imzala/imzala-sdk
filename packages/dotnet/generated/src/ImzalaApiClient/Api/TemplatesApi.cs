...
namespace ImzalaApiClient.Api
{
    ...
    public interface ITemplatesApiSync : IApiAccessor
    {
        ...
        ApiResponse<ApiV1TemplatesIdDelete200Response> ApiV1TemplatesIdDeleteWithHttpInfo(Guid id);
        /// <summary>
        /// Şablon detay
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="ImzalaApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id"></param>
        /// <param name="apiV1TemplatesIdPatchRequest"></param>
        /// <returns>ApiV1TemplatesIdPatch200Response</returns>
        ...
        /// <param name="id"></param>
        /// <param name="apiV1TemplatesIdPatchRequest"></param>
        /// <returns>ApiResponse of ApiV1TemplatesIdPatch200Response</returns>
        ApiResponse<ApiV1TemplatesIdPatch200Response> ApiV1TemplatesIdPatchWithHttpInfo(Guid id, ApiV1TemplatesIdPatchRequest apiV1TemplatesIdPatchRequest);
        /// <summary>
    ...
    public interface ITemplatesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiV1TemplatesIdDelete200Response> ApiV1TemplatesIdDeleteAsync(Guid id, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<ApiV1TemplatesIdDelete200Response>> ApiV1TemplatesIdDeleteWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Şablon detay
        /// </summary>
        /// <remarks>
        ...
        /// <param name="apiV1TemplatesIdPatchRequest"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiV1TemplatesIdPatch200Response</returns>
        System.Threading.Tasks.Task<ApiV1TemplatesIdPatch200Response> ApiV1TemplatesIdPatchAsync(Guid id, ApiV1TemplatesIdPatchRequest apiV1TemplatesIdPatchRequest, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="apiV1TemplatesIdPatchRequest"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiV1TemplatesIdPatch200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiV1TemplatesIdPatch200Response>> ApiV1TemplatesIdPatchWithHttpInfoAsync(Guid id, ApiV1TemplatesIdPatchRequest apiV1TemplatesIdPatchRequest, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// Şablon kullanım kılavuzu (curl + JSON örnek)
        /// </summary>
        /// <remarks>
    ...
    public partial class TemplatesApi : IDisposable, ITemplatesApi
    {
        ...
        /// <summary>
        /// Şablon sil Şablonu siler (soft delete). Mevcut sözleşmeler etkilenmez.
        /// </summary>
        /// <exception cref="ImzalaApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id"></param>
        /// <returns>ApiV1TemplatesIdDelete200Response</returns>
        public ApiV1TemplatesIdDelete200Response ApiV1TemplatesIdDelete(Guid id)
        {
            ImzalaApiClient.Client.ApiResponse<ApiV1TemplatesIdDelete200Response> localVarResponse = ApiV1TemplatesIdDeleteWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id"></param>
        /// <returns>ApiResponse of ApiV1TemplatesIdDelete200Response</returns>
        public ImzalaApiClient.Client.ApiResponse<ApiV1TemplatesIdDelete200Response> ApiV1TemplatesIdDeleteWithHttpInfo(Guid id)
        {
            ImzalaApiClient.Client.RequestOptions localVarRequestOptions = new ImzalaApiClient.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<ApiV1TemplatesIdDelete200Response>("/api/v1/templates/{id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiV1TemplatesIdDelete", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiV1TemplatesIdDelete200Response</returns>
        public async System.Threading.Tasks.Task<ApiV1TemplatesIdDelete200Response> ApiV1TemplatesIdDeleteAsync(Guid id, System.Threading.CancellationToken cancellationToken = default)
        {
            ImzalaApiClient.Client.ApiResponse<ApiV1TemplatesIdDelete200Response> localVarResponse = await ApiV1TemplatesIdDeleteWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiV1TemplatesIdDelete200Response)</returns>
        public async System.Threading.Tasks.Task<ImzalaApiClient.Client.ApiResponse<ApiV1TemplatesIdDelete200Response>> ApiV1TemplatesIdDeleteWithHttpInfoAsync(Guid id, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<ApiV1TemplatesIdDelete200Response>("/api/v1/templates/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Şablon metadata güncelle Şablonun yalnızca metadata alanlarını (name / description / category) günceller. Sayfa/alan/taraf yapısı bu endpoint&#39;ten DEĞİŞTİRİLEMEZ (şablon içeriği panelden düzenlenir). 
        /// </summary>
        /// <exception cref="ImzalaApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id"></param>
        /// <param name="apiV1TemplatesIdPatchRequest"></param>
        /// <returns>ApiV1TemplatesIdPatch200Response</returns>
        public ApiV1TemplatesIdPatch200Response ApiV1TemplatesIdPatch(Guid id, ApiV1TemplatesIdPatchRequest apiV1TemplatesIdPatchRequest)
        {
            ImzalaApiClient.Client.ApiResponse<ApiV1TemplatesIdPatch200Response> localVarResponse = ApiV1TemplatesIdPatchWithHttpInfo(id, apiV1TemplatesIdPatchRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="apiV1TemplatesIdPatchRequest"></param>
        /// <returns>ApiResponse of ApiV1TemplatesIdPatch200Response</returns>
        public ImzalaApiClient.Client.ApiResponse<ApiV1TemplatesIdPatch200Response> ApiV1TemplatesIdPatchWithHttpInfo(Guid id, ApiV1TemplatesIdPatchRequest apiV1TemplatesIdPatchRequest)
        {
            // verify the required parameter 'apiV1TemplatesIdPatchRequest' is set
            if (apiV1TemplatesIdPatchRequest == null)
                throw new ImzalaApiClient.Client.ApiException(400, "Missing required parameter 'apiV1TemplatesIdPatchRequest' when calling TemplatesApi->ApiV1TemplatesIdPatch");
            ...
            localVarRequestOptions.PathParameters.Add("id", ImzalaApiClient.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.Data = apiV1TemplatesIdPatchRequest;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Patch<ApiV1TemplatesIdPatch200Response>("/api/v1/templates/{id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiV1TemplatesIdPatch", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiV1TemplatesIdPatch200Response</returns>
        public async System.Threading.Tasks.Task<ApiV1TemplatesIdPatch200Response> ApiV1TemplatesIdPatchAsync(Guid id, ApiV1TemplatesIdPatchRequest apiV1TemplatesIdPatchRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            ImzalaApiClient.Client.ApiResponse<ApiV1TemplatesIdPatch200Response> localVarResponse = await ApiV1TemplatesIdPatchWithHttpInfoAsync(id, apiV1TemplatesIdPatchRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiV1TemplatesIdPatch200Response)</returns>
        public async System.Threading.Tasks.Task<ImzalaApiClient.Client.ApiResponse<ApiV1TemplatesIdPatch200Response>> ApiV1TemplatesIdPatchWithHttpInfoAsync(Guid id, ApiV1TemplatesIdPatchRequest apiV1TemplatesIdPatchRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'apiV1TemplatesIdPatchRequest' is set
            if (apiV1TemplatesIdPatchRequest == null)
                throw new ImzalaApiClient.Client.ApiException(400, "Missing required parameter 'apiV1TemplatesIdPatchRequest' when calling TemplatesApi->ApiV1TemplatesIdPatch");
            ...
            var localVarResponse = await this.AsynchronousClient.PatchAsync<ApiV1TemplatesIdPatch200Response>("/api/v1/templates/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
