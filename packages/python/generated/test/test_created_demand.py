...
class TestCreatedDemand(unittest.TestCase):
    """CreatedDemand unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatedDemand:
        """Test CreatedDemand
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatedDemand`
        """
        model = CreatedDemand()
        if include_optional:
