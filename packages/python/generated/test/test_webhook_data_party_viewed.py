...
class TestWebhookDataPartyViewed(unittest.TestCase):
    """WebhookDataPartyViewed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDataPartyViewed:
        """Test WebhookDataPartyViewed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDataPartyViewed`
        """
        model = WebhookDataPartyViewed()
        if include_optional:
            return WebhookDataPartyViewed(
                demand_id = '',
                party_id = ''
            )
        else:
    ...
    def testWebhookDataPartyViewed(self):
        """Test WebhookDataPartyViewed"""
