...
class TestApiV1DemandsIdDelete409Response(unittest.TestCase):
    """ApiV1DemandsIdDelete409Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdDelete409Response:
        """Test ApiV1DemandsIdDelete409Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdDelete409Response`
        """
        model = ApiV1DemandsIdDelete409Response()
        if include_optional:
            return ApiV1DemandsIdDelete409Response(
                success = False,
                error = 'Tamamlanmış sözleşme API üzerinden silinemez',
                code = 'DEMAND_COMPLETED'
            )
        else:
            return ApiV1DemandsIdDelete409Response(
        )
    ...
    def testApiV1DemandsIdDelete409Response(self):
        """Test ApiV1DemandsIdDelete409Response"""
