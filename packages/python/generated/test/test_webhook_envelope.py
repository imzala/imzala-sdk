...
class TestWebhookEnvelope(unittest.TestCase):
    """WebhookEnvelope unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookEnvelope:
        """Test WebhookEnvelope
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookEnvelope`
        """
        model = WebhookEnvelope()
        if include_optional:
            return WebhookEnvelope(
                id = 'evt_3a8f9c2b1d4e5f6a7b8c9d0e1f2a3b4c',
                type = 'demand.created',
