...
class TestWebhookDataDemandCreated(unittest.TestCase):
    """WebhookDataDemandCreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDataDemandCreated:
        """Test WebhookDataDemandCreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDataDemandCreated`
        """
        model = WebhookDataDemandCreated()
        if include_optional:
            return WebhookDataDemandCreated(
                demand_id = '',
                title = '',
                backfill = True
            )
    ...
    def testWebhookDataDemandCreated(self):
        """Test WebhookDataDemandCreated"""
