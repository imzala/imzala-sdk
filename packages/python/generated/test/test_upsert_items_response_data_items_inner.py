...
class TestUpsertItemsResponseDataItemsInner(unittest.TestCase):
    """UpsertItemsResponseDataItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertItemsResponseDataItemsInner:
        """Test UpsertItemsResponseDataItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertItemsResponseDataItemsInner`
        """
        model = UpsertItemsResponseDataItemsInner()
        if include_optional:
            return UpsertItemsResponseDataItemsInner(
                id = '',
                page_id = 56,
                party_id = '',
                item_type = '',
    ...
    def testUpsertItemsResponseDataItemsInner(self):
        """Test UpsertItemsResponseDataItemsInner"""
