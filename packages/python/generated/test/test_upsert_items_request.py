...
class TestUpsertItemsRequest(unittest.TestCase):
    """UpsertItemsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertItemsRequest:
        """Test UpsertItemsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertItemsRequest`
        """
        model = UpsertItemsRequest()
        if include_optional:
            return UpsertItemsRequest(
                items = [
                    imzala_client.models.page_item.PageItem(
                        page_id = 12345, 
                        party_id = '', 
                        item_type = 'signature', 
                        position_x = 0, 
                        ...
                        height = 1.337, 
                        is_required = True, 
                        slug = 'ar2c3v8s7djuy2zmetozkhdomh', 
                        label = '', 
    ...
    def testUpsertItemsRequest(self):
        """Test UpsertItemsRequest"""
