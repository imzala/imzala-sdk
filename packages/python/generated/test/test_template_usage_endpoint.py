...
class TestTemplateUsageEndpoint(unittest.TestCase):
    """TemplateUsageEndpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateUsageEndpoint:
        """Test TemplateUsageEndpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateUsageEndpoint`
        """
        model = TemplateUsageEndpoint()
        if include_optional:
            return TemplateUsageEndpoint(
                method = 'POST',
    ...
    def testTemplateUsageEndpoint(self):
        """Test TemplateUsageEndpoint"""
