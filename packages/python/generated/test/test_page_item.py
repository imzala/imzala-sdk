...
class TestPageItem(unittest.TestCase):
    """PageItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageItem:
        """Test PageItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageItem`
        """
        model = PageItem()
        if include_optional:
            return PageItem(
