...
class TestApiV1DemandsGet200ResponseData(unittest.TestCase):
    """ApiV1DemandsGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsGet200ResponseData:
        """Test ApiV1DemandsGet200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsGet200ResponseData`
        """
        model = ApiV1DemandsGet200ResponseData()
        if include_optional:
            return ApiV1DemandsGet200ResponseData(
                demands = [
    ...
    def testApiV1DemandsGet200ResponseData(self):
        """Test ApiV1DemandsGet200ResponseData"""
