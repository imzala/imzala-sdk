...
class TestDemandStatus(unittest.TestCase):
    """DemandStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DemandStatus:
        """Test DemandStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DemandStatus`
        """
        model = DemandStatus()
        if include_optional:
            return DemandStatus(
