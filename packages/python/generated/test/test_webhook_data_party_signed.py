...
class TestWebhookDataPartySigned(unittest.TestCase):
    """WebhookDataPartySigned unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDataPartySigned:
        """Test WebhookDataPartySigned
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDataPartySigned`
        """
        model = WebhookDataPartySigned()
        if include_optional:
            return WebhookDataPartySigned(
                demand_id = '',
                party_id = '',
                backfill = True
            )
    ...
    def testWebhookDataPartySigned(self):
        """Test WebhookDataPartySigned"""
