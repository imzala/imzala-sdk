...
class TestApiV1TemplatesIdUsageGet200Response(unittest.TestCase):
    """ApiV1TemplatesIdUsageGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1TemplatesIdUsageGet200Response:
        """Test ApiV1TemplatesIdUsageGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1TemplatesIdUsageGet200Response`
        """
        model = ApiV1TemplatesIdUsageGet200Response()
        if include_optional:
            return ApiV1TemplatesIdUsageGet200Response(
                success = True,
                data = imzala_client.models.template_usage.TemplateUsage(
                    template = imzala_client.models._api_v1_templates__id__patch_200_response_data._api_v1_templates__id__patch_200_response_data(
                        id = '', 
                        name = '', 
                        description = '', 
                        category = '', ), 
                    endpoint = imzala_client.models.template_usage_endpoint.TemplateUsage_endpoint(
                        method = 'POST', 
                        url = 'https://api-prd.imzala.org/api/v1/demands', ), 
                    required_headers = {"X-API-Key":"<sizin API anahtariniz>","X-Workspace-Id":"ed422ff9-...","Content-Type":"application/json"}, 
                    parties = [
                        imzala_client.models.template_usage_parties_inner.TemplateUsage_parties_inner(
                            template_party_id = '', 
                            order = 56, 
                            label = '', 
                            is_required = True, 
                            supported_fields = [
                                imzala_client.models.template_usage_parties_inner_supported_fields_inner.TemplateUsage_parties_inner_supported_fields_inner(
                                    key = '', 
                                    type = '', 
                                    required = True, 
                                    required_if = '', 
                    ...
                    variables = [
                        imzala_client.models.template_usage_variables_inner.TemplateUsage_variables_inner(
                            slug = '', 
                            label = '', 
                            item_type = '', 
                            is_required = True, 
                    ...
                    example_request = imzala_client.models.template_usage_example_request.TemplateUsage_example_request(
                        curl = '', 
                        json = imzala_client.models.json.json(), ), )
            )
        else:
            return ApiV1TemplatesIdUsageGet200Response(
        )
    ...
    def testApiV1TemplatesIdUsageGet200Response(self):
        """Test ApiV1TemplatesIdUsageGet200Response"""
