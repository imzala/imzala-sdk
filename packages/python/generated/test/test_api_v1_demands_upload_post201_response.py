...
class TestApiV1DemandsUploadPost201Response(unittest.TestCase):
    """ApiV1DemandsUploadPost201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsUploadPost201Response:
        """Test ApiV1DemandsUploadPost201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsUploadPost201Response`
        """
        model = ApiV1DemandsUploadPost201Response()
        if include_optional:
            return ApiV1DemandsUploadPost201Response(
                success = True,
                data = imzala_client.models.created_demand_upload.CreatedDemandUpload(
                    id = '', 
                    title = '', 
                    status = 'PENDING', 
                    pages = [
                        imzala_client.models.demand_page.DemandPage(
                            id = 12345, 
                            order = 1, )
                        ], 
                    signing_urls = [
    ...
    def testApiV1DemandsUploadPost201Response(self):
        """Test ApiV1DemandsUploadPost201Response"""
