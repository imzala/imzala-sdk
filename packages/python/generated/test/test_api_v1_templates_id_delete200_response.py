...
class TestApiV1TemplatesIdDelete200Response(unittest.TestCase):
    """ApiV1TemplatesIdDelete200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1TemplatesIdDelete200Response:
        """Test ApiV1TemplatesIdDelete200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1TemplatesIdDelete200Response`
        """
        model = ApiV1TemplatesIdDelete200Response()
        if include_optional:
            return ApiV1TemplatesIdDelete200Response(
                success = True,
                data = imzala_client.models._api_v1_templates__id__delete_200_response_data._api_v1_templates__id__delete_200_response_data(
                    id = '', 
                    deleted = True, )
            )
        else:
    ...
    def testApiV1TemplatesIdDelete200Response(self):
        """Test ApiV1TemplatesIdDelete200Response"""
