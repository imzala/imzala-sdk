...
class TestWebhookDataDemandCompletedPartiesInner(unittest.TestCase):
    """WebhookDataDemandCompletedPartiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDataDemandCompletedPartiesInner:
        """Test WebhookDataDemandCompletedPartiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDataDemandCompletedPartiesInner`
        """
        model = WebhookDataDemandCompletedPartiesInner()
        if include_optional:
            return WebhookDataDemandCompletedPartiesInner(
                id = '',
                name = '',
                email = '',
    ...
    def testWebhookDataDemandCompletedPartiesInner(self):
        """Test WebhookDataDemandCompletedPartiesInner"""
