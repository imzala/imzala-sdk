...
class TestUpsertItemsResponse(unittest.TestCase):
    """UpsertItemsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertItemsResponse:
        """Test UpsertItemsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertItemsResponse`
        """
        model = UpsertItemsResponse()
        if include_optional:
            return UpsertItemsResponse(
                success = True,
                data = imzala_client.models.upsert_items_response_data.UpsertItemsResponse_data(
                    items = [
                        imzala_client.models.upsert_items_response_data_items_inner.UpsertItemsResponse_data_items_inner(
                            id = '', 
                            page_id = 56, 
                            party_id = '', 
                            item_type = '', 
                            ...
                            slug = '', 
                            label = '', 
                            config = imzala_client.models.config.config(), )
                        ], 
                    items_count = 56, )
            )
        else:
    ...
    def testUpsertItemsResponse(self):
        """Test UpsertItemsResponse"""
