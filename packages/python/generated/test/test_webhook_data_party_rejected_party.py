...
class TestWebhookDataPartyRejectedParty(unittest.TestCase):
    """WebhookDataPartyRejectedParty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDataPartyRejectedParty:
        """Test WebhookDataPartyRejectedParty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDataPartyRejectedParty`
        """
        model = WebhookDataPartyRejectedParty()
        if include_optional:
            return WebhookDataPartyRejectedParty(
                id = '',
                first_name = '',
                last_name = '',
                email = '',
    ...
    def testWebhookDataPartyRejectedParty(self):
        """Test WebhookDataPartyRejectedParty"""
