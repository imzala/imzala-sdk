...
class TestTemplateSummaryPartiesInner(unittest.TestCase):
    """TemplateSummaryPartiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateSummaryPartiesInner:
        """Test TemplateSummaryPartiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateSummaryPartiesInner`
        """
        model = TemplateSummaryPartiesInner()
        if include_optional:
            return TemplateSummaryPartiesInner(
                id = '',
                order = 56,
                label = '',
                is_required = True
    ...
    def testTemplateSummaryPartiesInner(self):
        """Test TemplateSummaryPartiesInner"""
