...
class TestApiV1DemandsIdTimelineGet200ResponseDataEventsInner(unittest.TestCase):
    """ApiV1DemandsIdTimelineGet200ResponseDataEventsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdTimelineGet200ResponseDataEventsInner:
        """Test ApiV1DemandsIdTimelineGet200ResponseDataEventsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdTimelineGet200ResponseDataEventsInner`
        """
        model = ApiV1DemandsIdTimelineGet200ResponseDataEventsInner()
        if include_optional:
            return ApiV1DemandsIdTimelineGet200ResponseDataEventsInner(
                id = '',
                event_type = '',
                actor_label = '',
                ip_masked = '',
    ...
    def testApiV1DemandsIdTimelineGet200ResponseDataEventsInner(self):
        """Test ApiV1DemandsIdTimelineGet200ResponseDataEventsInner"""
