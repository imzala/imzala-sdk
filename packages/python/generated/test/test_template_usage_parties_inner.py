...
class TestTemplateUsagePartiesInner(unittest.TestCase):
    """TemplateUsagePartiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateUsagePartiesInner:
        """Test TemplateUsagePartiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateUsagePartiesInner`
        """
        model = TemplateUsagePartiesInner()
        if include_optional:
            return TemplateUsagePartiesInner(
                template_party_id = '',
                order = 56,
                label = '',
                is_required = True,
    ...
    def testTemplateUsagePartiesInner(self):
        """Test TemplateUsagePartiesInner"""
