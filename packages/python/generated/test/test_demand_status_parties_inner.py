...
class TestDemandStatusPartiesInner(unittest.TestCase):
    """DemandStatusPartiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DemandStatusPartiesInner:
        """Test DemandStatusPartiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DemandStatusPartiesInner`
        """
        model = DemandStatusPartiesInner()
        if include_optional:
            return DemandStatusPartiesInner(
                party_id = '',
                name = '',
                email_masked = '',
                signed = True,
    ...
    def testDemandStatusPartiesInner(self):
        """Test DemandStatusPartiesInner"""
