...
class TestUpsertItemsResponseData(unittest.TestCase):
    """UpsertItemsResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertItemsResponseData:
        """Test UpsertItemsResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertItemsResponseData`
        """
        model = UpsertItemsResponseData()
        if include_optional:
            return UpsertItemsResponseData(
                items = [
    ...
    def testUpsertItemsResponseData(self):
        """Test UpsertItemsResponseData"""
