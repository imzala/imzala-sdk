...
class TestApiV1DemandsIdTimelineGet200Response(unittest.TestCase):
    """ApiV1DemandsIdTimelineGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdTimelineGet200Response:
        """Test ApiV1DemandsIdTimelineGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdTimelineGet200Response`
        """
        model = ApiV1DemandsIdTimelineGet200Response()
        if include_optional:
            return ApiV1DemandsIdTimelineGet200Response(
                success = True,
                data = imzala_client.models._api_v1_demands__id__timeline_get_200_response_data._api_v1_demands__id__timeline_get_200_response_data(
                    events = [
                        imzala_client.models._api_v1_demands__id__timeline_get_200_response_data_events_inner._api_v1_demands__id__timeline_get_200_response_data_events_inner(
                            id = '', 
                            event_type = '', 
                            actor_label = '', 
                            ip_masked = '', 
    ...
    def testApiV1DemandsIdTimelineGet200Response(self):
        """Test ApiV1DemandsIdTimelineGet200Response"""
