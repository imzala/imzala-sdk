...
class TestTemplateUsageVariablesInner(unittest.TestCase):
    """TemplateUsageVariablesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateUsageVariablesInner:
        """Test TemplateUsageVariablesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateUsageVariablesInner`
        """
        model = TemplateUsageVariablesInner()
        if include_optional:
            return TemplateUsageVariablesInner(
                slug = '',
                label = '',
                item_type = '',
                is_required = True,
    ...
    def testTemplateUsageVariablesInner(self):
        """Test TemplateUsageVariablesInner"""
