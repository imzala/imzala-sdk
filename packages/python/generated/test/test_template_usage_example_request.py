...
class TestTemplateUsageExampleRequest(unittest.TestCase):
    """TemplateUsageExampleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateUsageExampleRequest:
        """Test TemplateUsageExampleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateUsageExampleRequest`
        """
        model = TemplateUsageExampleRequest()
        if include_optional:
            return TemplateUsageExampleRequest(
                curl = '',
                var_json = imzala_client.models.json.json()
            )
        else:
            return TemplateUsageExampleRequest(
        )
    ...
    def testTemplateUsageExampleRequest(self):
        """Test TemplateUsageExampleRequest"""
