...
class TestApiV1TemplatesIdGet200Response(unittest.TestCase):
    """ApiV1TemplatesIdGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1TemplatesIdGet200Response:
        """Test ApiV1TemplatesIdGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1TemplatesIdGet200Response`
        """
        model = ApiV1TemplatesIdGet200Response()
        if include_optional:
            return ApiV1TemplatesIdGet200Response(
                success = True,
                data = imzala_client.models.template_detail.TemplateDetail(
                    id = '', 
                    name = '', 
                    description = '', 
                    category = '', 
                    usage_count = 56, 
                    parties = [
                        imzala_client.models.template_party_summary.TemplatePartySummary(
                            id = '', 
                            order = 56, 
                            label = 'Musteri', 
                            is_required = True, )
                    ...
                    pages_count = 56, 
                    variables = [
                        imzala_client.models.template_variable.TemplateVariable(
                            slug = 'adres', 
                            label = 'ADRES', 
                            item_type = 'dynamic_text', 
                            is_required = True, 
                            default_source = '{{signer.full_name}}', 
                            template_party_id = '', )
                        ], )
            )
        else:
    ...
    def testApiV1TemplatesIdGet200Response(self):
        """Test ApiV1TemplatesIdGet200Response"""
