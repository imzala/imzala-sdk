...
class TestWebhookDataDemandCompleted(unittest.TestCase):
    """WebhookDataDemandCompleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDataDemandCompleted:
        """Test WebhookDataDemandCompleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDataDemandCompleted`
        """
        model = WebhookDataDemandCompleted()
        if include_optional:
            return WebhookDataDemandCompleted(
                demand_id = '',
                title = '',
                status = 'COMPLETED',
                completed_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                parties = [
                    imzala_client.models.webhook_data_demand_completed_parties_inner.WebhookDataDemandCompleted_parties_inner(
                        id = '', 
                        name = '', 
                        email = '', 
    ...
    def testWebhookDataDemandCompleted(self):
        """Test WebhookDataDemandCompleted"""
