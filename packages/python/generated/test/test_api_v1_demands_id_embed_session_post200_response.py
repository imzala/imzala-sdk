...
class TestApiV1DemandsIdEmbedSessionPost200Response(unittest.TestCase):
    """ApiV1DemandsIdEmbedSessionPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdEmbedSessionPost200Response:
        """Test ApiV1DemandsIdEmbedSessionPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdEmbedSessionPost200Response`
        """
        model = ApiV1DemandsIdEmbedSessionPost200Response()
        if include_optional:
            return ApiV1DemandsIdEmbedSessionPost200Response(
                success = True,
                data = imzala_client.models._api_v1_demands__id__embed_session_post_200_response_data._api_v1_demands__id__embed_session_post_200_response_data(
                    embed_token = 'emb_a1b2c3d4e5f6...', 
                    expires_at = '2026-06-30T15:30Z', 
                    embed_url = 'https://e.imzala.org/embed/sign?token=emb_a1b2c3d4e5f6...', )
            )
        else:
            return ApiV1DemandsIdEmbedSessionPost200Response(
        )
    ...
    def testApiV1DemandsIdEmbedSessionPost200Response(self):
        """Test ApiV1DemandsIdEmbedSessionPost200Response"""
