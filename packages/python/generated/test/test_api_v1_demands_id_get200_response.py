...
class TestApiV1DemandsIdGet200Response(unittest.TestCase):
    """ApiV1DemandsIdGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdGet200Response:
        """Test ApiV1DemandsIdGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdGet200Response`
        """
        model = ApiV1DemandsIdGet200Response()
        if include_optional:
            return ApiV1DemandsIdGet200Response(
                success = True,
                data = imzala_client.models.demand_status.DemandStatus(
                    id = '', 
                    title = '', 
                    status = 'DRAFT', 
                    ...
                    parties = [
                        imzala_client.models.demand_status_parties_inner.DemandStatus_parties_inner(
                            party_id = '', 
                            first_name = '', 
                            last_name = '', 
                            email = '', 
    ...
    def testApiV1DemandsIdGet200Response(self):
        """Test ApiV1DemandsIdGet200Response"""
