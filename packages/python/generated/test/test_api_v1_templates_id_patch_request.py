...
class TestApiV1TemplatesIdPatchRequest(unittest.TestCase):
    """ApiV1TemplatesIdPatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1TemplatesIdPatchRequest:
        """Test ApiV1TemplatesIdPatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1TemplatesIdPatchRequest`
        """
        model = ApiV1TemplatesIdPatchRequest()
        if include_optional:
            return ApiV1TemplatesIdPatchRequest(
                name = '',
                description = '',
                category = ''
            )
    ...
    def testApiV1TemplatesIdPatchRequest(self):
        """Test ApiV1TemplatesIdPatchRequest"""
