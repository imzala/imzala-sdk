...
class TestApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner(unittest.TestCase):
    """ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner:
        """Test ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner`
        """
        model = ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner()
        if include_optional:
            return ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner(
                party_id = '',
                first_name = '',
                last_name = '',
                channels = [
    ...
    def testApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner(self):
        """Test ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner"""
