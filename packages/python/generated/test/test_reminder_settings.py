...
class TestReminderSettings(unittest.TestCase):
    """ReminderSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderSettings:
        """Test ReminderSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderSettings`
        """
