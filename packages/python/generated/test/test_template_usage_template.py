...
class TestTemplateUsageTemplate(unittest.TestCase):
    """TemplateUsageTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateUsageTemplate:
        """Test TemplateUsageTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateUsageTemplate`
        """
        model = TemplateUsageTemplate()
        if include_optional:
            return TemplateUsageTemplate(
                id = '',
                name = '',
                description = '',
                category = ''
    ...
    def testTemplateUsageTemplate(self):
        """Test TemplateUsageTemplate"""
