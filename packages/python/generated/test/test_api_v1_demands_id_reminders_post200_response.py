...
class TestApiV1DemandsIdRemindersPost200Response(unittest.TestCase):
    """ApiV1DemandsIdRemindersPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdRemindersPost200Response:
        """Test ApiV1DemandsIdRemindersPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdRemindersPost200Response`
        """
        model = ApiV1DemandsIdRemindersPost200Response()
        if include_optional:
            return ApiV1DemandsIdRemindersPost200Response(
                success = True,
                data = imzala_client.models._api_v1_demands__id__reminders_post_200_response_data._api_v1_demands__id__reminders_post_200_response_data(
                    demand_id = '', 
                    dispatched = [
                        imzala_client.models._api_v1_demands__id__reminders_post_200_response_data_dispatched_inner._api_v1_demands__id__reminders_post_200_response_data_dispatched_inner(
                            party_id = '', 
                            first_name = '', 
                            last_name = '', 
                            channels = [
                    ...
                    skipped = [
                        imzala_client.models._api_v1_demands__id__reminders_post_200_response_data_skipped_inner._api_v1_demands__id__reminders_post_200_response_data_skipped_inner(
                            party_id = '', 
                            reason = 'no_phone_number', )
                        ], 
                    last_reminder_sent_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
            )
        else:
            return ApiV1DemandsIdRemindersPost200Response(
        )
    ...
    def testApiV1DemandsIdRemindersPost200Response(self):
        """Test ApiV1DemandsIdRemindersPost200Response"""
