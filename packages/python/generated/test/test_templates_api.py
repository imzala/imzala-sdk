...
class TestTemplatesApi(unittest.TestCase):
    ...
    def test_api_v1_templates_get(self) -> None:
        """Test case for api_v1_templates_get

        Şablon listesi
        """
        pass

    def test_api_v1_templates_id_delete(self) -> None:
        """Test case for api_v1_templates_id_delete

        Şablon sil
        """
        pass

    def test_api_v1_templates_id_get(self) -> None:
        """Test case for api_v1_templates_id_get

        Şablon detay
        """
        pass

    def test_api_v1_templates_id_patch(self) -> None:
        """Test case for api_v1_templates_id_patch

        Şablon metadata güncelle
        """
        pass

    def test_api_v1_templates_id_usage_get(self) -> None:
        """Test case for api_v1_templates_id_usage_get
