...
class TestApiV1DemandsIdCancelPost200Response(unittest.TestCase):
    """ApiV1DemandsIdCancelPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdCancelPost200Response:
        """Test ApiV1DemandsIdCancelPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdCancelPost200Response`
        """
        model = ApiV1DemandsIdCancelPost200Response()
        if include_optional:
            return ApiV1DemandsIdCancelPost200Response(
                success = True,
                data = imzala_client.models._api_v1_demands__id__cancel_post_200_response_data._api_v1_demands__id__cancel_post_200_response_data(
                    id = '', 
                    title = '', 
                    status = 'CANCELLED', 
    ...
    def testApiV1DemandsIdCancelPost200Response(self):
        """Test ApiV1DemandsIdCancelPost200Response"""
