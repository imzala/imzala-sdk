...
class TestApiV1DemandsGet200Response(unittest.TestCase):
    """ApiV1DemandsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsGet200Response:
        """Test ApiV1DemandsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsGet200Response`
        """
        model = ApiV1DemandsGet200Response()
        if include_optional:
            return ApiV1DemandsGet200Response(
                success = True,
                data = imzala_client.models._api_v1_demands_get_200_response_data._api_v1_demands_get_200_response_data(
                    demands = [
                        imzala_client.models._api_v1_demands_get_200_response_data_demands_inner._api_v1_demands_get_200_response_data_demands_inner(
                            id = '', 
                            title = '', 
                            status = '', 
    ...
    def testApiV1DemandsGet200Response(self):
        """Test ApiV1DemandsGet200Response"""
