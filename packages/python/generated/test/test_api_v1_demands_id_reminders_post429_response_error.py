...
class TestApiV1DemandsIdRemindersPost429ResponseError(unittest.TestCase):
    """ApiV1DemandsIdRemindersPost429ResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdRemindersPost429ResponseError:
        """Test ApiV1DemandsIdRemindersPost429ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdRemindersPost429ResponseError`
        """
        model = ApiV1DemandsIdRemindersPost429ResponseError()
        if include_optional:
            return ApiV1DemandsIdRemindersPost429ResponseError(
                code = 'RATE_LIMITED',
                message = '',
    ...
    def testApiV1DemandsIdRemindersPost429ResponseError(self):
        """Test ApiV1DemandsIdRemindersPost429ResponseError"""
