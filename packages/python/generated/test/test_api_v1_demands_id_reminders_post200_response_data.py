...
class TestApiV1DemandsIdRemindersPost200ResponseData(unittest.TestCase):
    """ApiV1DemandsIdRemindersPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdRemindersPost200ResponseData:
        """Test ApiV1DemandsIdRemindersPost200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdRemindersPost200ResponseData`
        """
        model = ApiV1DemandsIdRemindersPost200ResponseData()
        if include_optional:
            return ApiV1DemandsIdRemindersPost200ResponseData(
                demand_id = '',
                dispatched = [
    ...
    def testApiV1DemandsIdRemindersPost200ResponseData(self):
        """Test ApiV1DemandsIdRemindersPost200ResponseData"""
