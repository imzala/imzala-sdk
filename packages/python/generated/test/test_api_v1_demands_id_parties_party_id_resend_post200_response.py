...
class TestApiV1DemandsIdPartiesPartyIdResendPost200Response(unittest.TestCase):
    """ApiV1DemandsIdPartiesPartyIdResendPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdPartiesPartyIdResendPost200Response:
        """Test ApiV1DemandsIdPartiesPartyIdResendPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdPartiesPartyIdResendPost200Response`
        """
        model = ApiV1DemandsIdPartiesPartyIdResendPost200Response()
        if include_optional:
            return ApiV1DemandsIdPartiesPartyIdResendPost200Response(
                success = True,
                data = imzala_client.models._api_v1_demands__id__parties__party_id__resend_post_200_response_data._api_v1_demands__id__parties__partyId__resend_post_200_response_data(
                    sent = [
                        ''
                        ], )
            )
    ...
    def testApiV1DemandsIdPartiesPartyIdResendPost200Response(self):
        """Test ApiV1DemandsIdPartiesPartyIdResendPost200Response"""
