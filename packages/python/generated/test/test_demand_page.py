...
class TestDemandPage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DemandPage:
        """Test DemandPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DemandPage`
        """
        model = DemandPage()
        if include_optional:
            return DemandPage(
