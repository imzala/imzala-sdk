...
class TestCreateDemandRequest(unittest.TestCase):
    """CreateDemandRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDemandRequest:
        """Test CreateDemandRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDemandRequest`
        """
        ...
        if include_optional:
            return CreateDemandRequest(
                ...
                description = '',
                party_mapping = [
                    imzala_client.models.party_mapping_input.PartyMappingInput(
                        template_party_id = '', 
                        first_name = '', 
                        last_name = '', 
                        email = '', 
                ...
                require_tc_verification = True,
                require_biometric_verification = True,
                reminder_settings = imzala_client.models.reminder_settings.ReminderSettings(
                    enabled = True, 
                    intervals_hours = [24,72], 
                    max_reminders = 2, 
                    channels = ["email","sms"], )
            )
        else:
    ...
    def testCreateDemandRequest(self):
        """Test CreateDemandRequest"""
