...
class TestCreatedDemandSigningUrlsInner(unittest.TestCase):
    """CreatedDemandSigningUrlsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatedDemandSigningUrlsInner:
        """Test CreatedDemandSigningUrlsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatedDemandSigningUrlsInner`
        """
        model = CreatedDemandSigningUrlsInner()
        if include_optional:
            return CreatedDemandSigningUrlsInner(
                party_id = '',
                first_name = '',
                last_name = '',
                email = '',
    ...
    def testCreatedDemandSigningUrlsInner(self):
        """Test CreatedDemandSigningUrlsInner"""
