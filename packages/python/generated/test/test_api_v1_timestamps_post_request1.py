...
class TestApiV1TimestampsPostRequest1(unittest.TestCase):
    """ApiV1TimestampsPostRequest1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1TimestampsPostRequest1:
        """Test ApiV1TimestampsPostRequest1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1TimestampsPostRequest1`
        """
        model = ApiV1TimestampsPostRequest1()
        if include_optional:
            return ApiV1TimestampsPostRequest1(
                file_base64 = '',
                file_name = '',
                description = '',
                owner_first_name = '',
    ...
    def testApiV1TimestampsPostRequest1(self):
        """Test ApiV1TimestampsPostRequest1"""
