...
class TestApiV1DemandsIdCancelPost200ResponseData(unittest.TestCase):
    """ApiV1DemandsIdCancelPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdCancelPost200ResponseData:
        """Test ApiV1DemandsIdCancelPost200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdCancelPost200ResponseData`
        """
        model = ApiV1DemandsIdCancelPost200ResponseData()
        if include_optional:
            return ApiV1DemandsIdCancelPost200ResponseData(
                id = '',
                title = '',
                status = 'CANCELLED',
    ...
    def testApiV1DemandsIdCancelPost200ResponseData(self):
        """Test ApiV1DemandsIdCancelPost200ResponseData"""
