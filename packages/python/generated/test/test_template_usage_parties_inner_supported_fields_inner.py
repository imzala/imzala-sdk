...
class TestTemplateUsagePartiesInnerSupportedFieldsInner(unittest.TestCase):
    """TemplateUsagePartiesInnerSupportedFieldsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateUsagePartiesInnerSupportedFieldsInner:
        """Test TemplateUsagePartiesInnerSupportedFieldsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateUsagePartiesInnerSupportedFieldsInner`
        """
        model = TemplateUsagePartiesInnerSupportedFieldsInner()
        if include_optional:
            return TemplateUsagePartiesInnerSupportedFieldsInner(
                key = '',
                type = '',
                required = True,
                required_if = '',
    ...
    def testTemplateUsagePartiesInnerSupportedFieldsInner(self):
        """Test TemplateUsagePartiesInnerSupportedFieldsInner"""
