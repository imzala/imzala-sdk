...
class TestApiV1TemplatesGet200ResponseData(unittest.TestCase):
    """ApiV1TemplatesGet200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1TemplatesGet200ResponseData:
        """Test ApiV1TemplatesGet200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1TemplatesGet200ResponseData`
        """
        model = ApiV1TemplatesGet200ResponseData()
        if include_optional:
            return ApiV1TemplatesGet200ResponseData(
                templates = [
                    imzala_client.models.template_summary.TemplateSummary(
                        id = '', 
                        name = '', 
                        description = '', 
                        category = '', 
                        usage_count = 56, 
                        parties = [
                            imzala_client.models.template_summary_parties_inner.TemplateSummary_parties_inner(
                                id = '', 
                                order = 56, 
                                label = '', 
                                is_required = True, )
    ...
    def testApiV1TemplatesGet200ResponseData(self):
        """Test ApiV1TemplatesGet200ResponseData"""
