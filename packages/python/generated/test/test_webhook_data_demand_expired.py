...
class TestWebhookDataDemandExpired(unittest.TestCase):
    """WebhookDataDemandExpired unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDataDemandExpired:
        """Test WebhookDataDemandExpired
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDataDemandExpired`
        """
        model = WebhookDataDemandExpired()
        if include_optional:
            return WebhookDataDemandExpired(
                demand_id = '',
                title = '',
                expiry_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                parties = [
                    imzala_client.models.webhook_data_demand_expired_parties_inner.WebhookDataDemandExpired_parties_inner(
                        id = '', 
                        name = '', 
                        email = '', 
                        signed = True, )
    ...
    def testWebhookDataDemandExpired(self):
        """Test WebhookDataDemandExpired"""
