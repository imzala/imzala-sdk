...
class TestApiV1DemandsGet200ResponseDataDemandsInner(unittest.TestCase):
    """ApiV1DemandsGet200ResponseDataDemandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsGet200ResponseDataDemandsInner:
        """Test ApiV1DemandsGet200ResponseDataDemandsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsGet200ResponseDataDemandsInner`
        """
        model = ApiV1DemandsGet200ResponseDataDemandsInner()
        if include_optional:
            return ApiV1DemandsGet200ResponseDataDemandsInner(
                id = '',
                title = '',
                status = '',
    ...
    def testApiV1DemandsGet200ResponseDataDemandsInner(self):
        """Test ApiV1DemandsGet200ResponseDataDemandsInner"""
