...
class TestTemplatePartySummary(unittest.TestCase):
    """TemplatePartySummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplatePartySummary:
        """Test TemplatePartySummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplatePartySummary`
        """
        model = TemplatePartySummary()
        if include_optional:
            return TemplatePartySummary(
                id = '',
                order = 56,
                label = 'Musteri',
                is_required = True
    ...
    def testTemplatePartySummary(self):
        """Test TemplatePartySummary"""
