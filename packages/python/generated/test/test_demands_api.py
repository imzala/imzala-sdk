...
class TestDemandsApi(unittest.TestCase):
    """DemandsApi unit test stubs"""
    ...
    def test_api_v1_demands_get(self) -> None:
        """Test case for api_v1_demands_get

        Sözleşme listesi (counts-only, PII'siz)
        """
        pass

    def test_api_v1_demands_id_cancel_post(self) -> None:
        """Test case for api_v1_demands_id_cancel_post

        Sözleşme iptal (void)
        """
        pass

    def test_api_v1_demands_id_certificate_get(self) -> None:
        """Test case for api_v1_demands_id_certificate_get

        Tamamlanma sertifikası (PAdES B-T)
        """
        pass

    def test_api_v1_demands_id_delete(self) -> None:
        """Test case for api_v1_demands_id_delete

        Sözleşme sil (yalnızca tamamlanmamış)
        """
        pass

    def test_api_v1_demands_id_embed_session_post(self) -> None:
        """Test case for api_v1_demands_id_embed_session_post

        Gömülü imza oturumu başlat (embed token mint)
        """
        pass

    def test_api_v1_demands_id_get(self) -> None:
        """Test case for api_v1_demands_id_get

        Sözleşme durumu + imza ilerlemesi
        """
        pass

    def test_api_v1_demands_id_items_post(self) -> None:
        """Test case for api_v1_demands_id_items_post

        Sözleşmeye alan yerleştir (replace)
        """
        pass

    def test_api_v1_demands_id_parties_party_id_resend_post(self) -> None:
        """Test case for api_v1_demands_id_parties_party_id_resend_post

        Tekil tarafa imza davetini tekrar gönder
        """
        pass

    def test_api_v1_demands_id_pdf_get(self) -> None:
        """Test case for api_v1_demands_id_pdf_get

        İmzalı sözleşme PDF'i (auth'lu indirme)
        """
        pass

    def test_api_v1_demands_id_timeline_get(self) -> None:
        """Test case for api_v1_demands_id_timeline_get

        İmza denetim izi (maskeli)
        """
        pass

    def test_api_v1_demands_post(self) -> None:
        """Test case for api_v1_demands_post

        Sözleşme oluştur (şablondan)
        """
        pass

    def test_api_v1_demands_upload_post(self) -> None:
        """Test case for api_v1_demands_upload_post
