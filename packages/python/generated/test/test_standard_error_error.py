...
class TestStandardErrorError(unittest.TestCase):
    """StandardErrorError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandardErrorError:
        """Test StandardErrorError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandardErrorError`
        """
        model = StandardErrorError()
        if include_optional:
            return StandardErrorError(
                code = 'DEMAND_NOT_FOUND',
                message = 'Demand not found',
                retry_after_seconds = 247
            )
        else:
            return StandardErrorError(
                code = 'DEMAND_NOT_FOUND',
    ...
    def testStandardErrorError(self):
        """Test StandardErrorError"""
