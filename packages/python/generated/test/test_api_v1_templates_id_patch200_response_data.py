...
class TestApiV1TemplatesIdPatch200ResponseData(unittest.TestCase):
    """ApiV1TemplatesIdPatch200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1TemplatesIdPatch200ResponseData:
        """Test ApiV1TemplatesIdPatch200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1TemplatesIdPatch200ResponseData`
        """
        model = ApiV1TemplatesIdPatch200ResponseData()
        if include_optional:
            return ApiV1TemplatesIdPatch200ResponseData(
                id = '',
                name = '',
                description = '',
                category = ''
    ...
    def testApiV1TemplatesIdPatch200ResponseData(self):
        """Test ApiV1TemplatesIdPatch200ResponseData"""
