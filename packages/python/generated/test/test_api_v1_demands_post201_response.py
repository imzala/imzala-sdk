...
class TestApiV1DemandsPost201Response(unittest.TestCase):
    """ApiV1DemandsPost201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsPost201Response:
        """Test ApiV1DemandsPost201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsPost201Response`
        """
        model = ApiV1DemandsPost201Response()
        if include_optional:
            return ApiV1DemandsPost201Response(
                success = True,
                data = imzala_client.models.created_demand.CreatedDemand(
                    id = '', 
                    title = '', 
                    status = 'PENDING', 
                    template_id = '', 
                    signing_urls = [
                        imzala_client.models.created_demand_signing_urls_inner.CreatedDemand_signing_urls_inner(
                            party_id = '', 
                            first_name = '', 
                            last_name = '', 
                            email = '', 
                    ...
                    variables_applied = ["address","iban","kira_bedeli"], 
                    variables_applied_root = ["kira_bedeli"], 
                    variables_applied_by_party = {"<kiraya-veren-id>":["address","iban"],"<kiraci-id>":["address","iban"]}, 
                    variables_ignored = [], )
            )
        else:
            return ApiV1DemandsPost201Response(
    ...
    def testApiV1DemandsPost201Response(self):
        """Test ApiV1DemandsPost201Response"""
