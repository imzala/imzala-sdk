...
class TestPartyMappingInput(unittest.TestCase):
    """PartyMappingInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartyMappingInput:
        """Test PartyMappingInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartyMappingInput`
        """
        model = PartyMappingInput()
        if include_optional:
            return PartyMappingInput(
                template_party_id = '',
                first_name = '',
                last_name = '',
                email = '',
    ...
    def testPartyMappingInput(self):
        """Test PartyMappingInput"""
