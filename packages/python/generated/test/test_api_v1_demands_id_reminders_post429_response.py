...
class TestApiV1DemandsIdRemindersPost429Response(unittest.TestCase):
    """ApiV1DemandsIdRemindersPost429Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DemandsIdRemindersPost429Response:
        """Test ApiV1DemandsIdRemindersPost429Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DemandsIdRemindersPost429Response`
        """
        model = ApiV1DemandsIdRemindersPost429Response()
        if include_optional:
            return ApiV1DemandsIdRemindersPost429Response(
                success = False,
                error = imzala_client.models._api_v1_demands__id__reminders_post_429_response_error._api_v1_demands__id__reminders_post_429_response_error(
                    code = 'RATE_LIMITED', 
                    message = '', 
    ...
    def testApiV1DemandsIdRemindersPost429Response(self):
        """Test ApiV1DemandsIdRemindersPost429Response"""
