...
class TestApiV1TimestampsPost201Response(unittest.TestCase):
    """ApiV1TimestampsPost201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1TimestampsPost201Response:
        """Test ApiV1TimestampsPost201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1TimestampsPost201Response`
        """
        model = ApiV1TimestampsPost201Response()
        if include_optional:
            return ApiV1TimestampsPost201Response(
                success = True,
                data = imzala_client.models.timestamp_record.TimestampRecord(
                    id = '', 
                    timestamp_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    tsa_authority = 'TÜBİTAK KAMU SM', 
                    file_sha256 = 'a3f8b1c2d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1', 
                    verify_url = 'https://imzala.org/dogrula?seri=<id>', 
                    certificate_url = 'https://imzala.org/dogrula?seri=<id>', 
                    credits_used = 4, 
                    credits_remaining = 0, )
            )
        else:
    ...
    def testApiV1TimestampsPost201Response(self):
        """Test ApiV1TimestampsPost201Response"""
