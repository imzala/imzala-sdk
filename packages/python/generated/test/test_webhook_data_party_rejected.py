...
class TestWebhookDataPartyRejected(unittest.TestCase):
    """WebhookDataPartyRejected unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDataPartyRejected:
        """Test WebhookDataPartyRejected
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDataPartyRejected`
        """
        model = WebhookDataPartyRejected()
        if include_optional:
            return WebhookDataPartyRejected(
                demand_id = '',
                party = imzala_client.models.webhook_data_party_rejected_party.WebhookDataPartyRejected_party(
                    id = '', 
                    first_name = '', 
                    last_name = '', 
                    email = '', 
    ...
    def testWebhookDataPartyRejected(self):
        """Test WebhookDataPartyRejected"""
