...
class TestApiV1MeGet200Response(unittest.TestCase):
    """ApiV1MeGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1MeGet200Response:
        """Test ApiV1MeGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1MeGet200Response`
        """
        model = ApiV1MeGet200Response()
        if include_optional:
            return ApiV1MeGet200Response(
                success = True,
                data = imzala_client.models._api_v1_me_get_200_response_data._api_v1_me_get_200_response_data(
                    id = '', 
                    email = '', 
                    first_name = '', 
                    last_name = '', 
                    workspace = imzala_client.models._api_v1_me_get_200_response_data_workspace._api_v1_me_get_200_response_data_workspace(
                        type = 'personal', 
                        organization_id = '', ), 
                    credits = imzala_client.models._api_v1_me_get_200_response_data_credits._api_v1_me_get_200_response_data_credits(
                        remaining = 56, ), )
            )
        else:
            return ApiV1MeGet200Response(
    ...
    def testApiV1MeGet200Response(self):
        """Test ApiV1MeGet200Response"""
