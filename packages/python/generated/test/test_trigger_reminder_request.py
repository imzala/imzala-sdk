...
class TestTriggerReminderRequest(unittest.TestCase):
    """TriggerReminderRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggerReminderRequest:
        """Test TriggerReminderRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggerReminderRequest`
        """
        model = TriggerReminderRequest()
        if include_optional:
            return TriggerReminderRequest(
                channels = ["sms"],
                force = True
            )
        else:
    ...
    def testTriggerReminderRequest(self):
        """Test TriggerReminderRequest"""
