...
class TestCreatedDemandUpload(unittest.TestCase):
    """CreatedDemandUpload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatedDemandUpload:
        """Test CreatedDemandUpload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatedDemandUpload`
        """
        model = CreatedDemandUpload()
        if include_optional:
            return CreatedDemandUpload(
                id = '',
                title = '',
                status = 'PENDING',
                pages = [
    ...
    def testCreatedDemandUpload(self):
        """Test CreatedDemandUpload"""
