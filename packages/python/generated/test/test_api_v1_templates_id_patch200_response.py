...
class TestApiV1TemplatesIdPatch200Response(unittest.TestCase):
    """ApiV1TemplatesIdPatch200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1TemplatesIdPatch200Response:
        """Test ApiV1TemplatesIdPatch200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1TemplatesIdPatch200Response`
        """
        model = ApiV1TemplatesIdPatch200Response()
        if include_optional:
            return ApiV1TemplatesIdPatch200Response(
                success = True,
                data = imzala_client.models._api_v1_templates__id__patch_200_response_data._api_v1_templates__id__patch_200_response_data(
                    id = '', 
                    name = '', 
                    description = '', 
                    category = '', )
    ...
    def testApiV1TemplatesIdPatch200Response(self):
        """Test ApiV1TemplatesIdPatch200Response"""
