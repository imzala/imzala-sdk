...
class TestWebhookDataDemandExpiredPartiesInner(unittest.TestCase):
    """WebhookDataDemandExpiredPartiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookDataDemandExpiredPartiesInner:
        """Test WebhookDataDemandExpiredPartiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookDataDemandExpiredPartiesInner`
        """
        model = WebhookDataDemandExpiredPartiesInner()
        if include_optional:
            return WebhookDataDemandExpiredPartiesInner(
                id = '',
                name = '',
                email = '',
                signed = True
    ...
    def testWebhookDataDemandExpiredPartiesInner(self):
        """Test WebhookDataDemandExpiredPartiesInner"""
