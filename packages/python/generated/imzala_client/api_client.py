...
from imzala_client.api_response import ApiResponse, T as ApiResponseT
import imzala_client.models
from imzala_client import rest
from imzala_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(imzala_client.models, klass)
