...
class TemplateUsageExampleRequest(BaseModel):
    """
    TemplateUsageExampleRequest
    """ # noqa: E501
    curl: Optional[StrictStr] = Field(default=None, description="curl komutu, slug'lar dolu")
    var_json: Optional[Dict[str, Any]] = Field(default=None, description="JSON payload, multi-party-aware (party_mapping[].variables + root variables)", alias="json")
    __properties: ClassVar[List[str]] = ["curl", "json"]
