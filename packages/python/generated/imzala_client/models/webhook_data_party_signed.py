...
class WebhookDataPartySigned(BaseModel):
    """
    WebhookDataPartySigned
    """ # noqa: E501
    demand_id: UUID
    party_id: UUID
    backfill: Optional[StrictBool] = Field(default=None, description="Replay bayrağı", alias="_backfill")
    __properties: ClassVar[List[str]] = ["demand_id", "party_id", "_backfill"]
