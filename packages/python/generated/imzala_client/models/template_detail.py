...
class TemplateDetail(BaseModel):
    ...
    parties: Optional[List[TemplatePartySummary]] = None
    pages_count: Optional[StrictInt] = None
    variables: Optional[List[TemplateVariable]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "category", "usage_count", "parties", "pages_count", "variables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parties": [TemplatePartySummary.from_dict(_item) for _item in obj["parties"]] if obj.get("parties") is not None else None,
