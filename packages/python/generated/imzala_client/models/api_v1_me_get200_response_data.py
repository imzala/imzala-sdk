...
class ApiV1MeGet200ResponseData(BaseModel):
    """
    ...
    workspace: Optional[ApiV1MeGet200ResponseDataWorkspace] = None
    credits: Optional[ApiV1MeGet200ResponseDataCredits] = None
    __properties: ClassVar[List[str]] = ["id", "email", "first_name", "last_name", "workspace", "credits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workspace": ApiV1MeGet200ResponseDataWorkspace.from_dict(obj["workspace"]) if obj.get("workspace") is not None else None,
            "credits": ApiV1MeGet200ResponseDataCredits.from_dict(obj["credits"]) if obj.get("credits") is not None else None
        })
        return _obj
