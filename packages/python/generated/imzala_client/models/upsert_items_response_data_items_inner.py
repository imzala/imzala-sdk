...
class UpsertItemsResponseDataItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "page_id", "party_id", "item_type", "position_x", "position_y", "width", "height", "is_required", "slug", "label", "config"]
