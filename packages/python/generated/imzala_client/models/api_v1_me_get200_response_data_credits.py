...
class ApiV1MeGet200ResponseDataCredits(BaseModel):
    """
    ApiV1MeGet200ResponseDataCredits
    """ # noqa: E501
    remaining: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["remaining"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1MeGet200ResponseDataCredits from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1MeGet200ResponseDataCredits from a dict"""
        if obj is None:
            return None
