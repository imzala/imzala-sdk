...
class TemplateUsageVariablesInner(BaseModel):
    """
    ...
    default_source: Optional[StrictStr] = None
    auto_filled: Optional[StrictBool] = None
    template_party_id: Optional[StrictStr] = None
    note: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["slug", "label", "item_type", "is_required", "default_source", "auto_filled", "template_party_id", "note"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auto_filled": obj.get("auto_filled"),
