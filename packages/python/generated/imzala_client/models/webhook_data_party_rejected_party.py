...
class WebhookDataPartyRejectedParty(BaseModel):
    """
    ...
    rejection_reason: Optional[StrictStr] = Field(default=None, description="Tarafın belirttiği sebep (opsiyonel, modal textarea)")
    __properties: ClassVar[List[str]] = ["id", "first_name", "last_name", "email", "rejection_reason"]
