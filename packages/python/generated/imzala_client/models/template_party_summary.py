...
class TemplatePartySummary(BaseModel):
    """
    TemplatePartySummary
    """ # noqa: E501
    id: Optional[UUID] = None
    order: Optional[StrictInt] = None
    label: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Musteri"]})
    is_required: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "order", "label", "is_required"]
