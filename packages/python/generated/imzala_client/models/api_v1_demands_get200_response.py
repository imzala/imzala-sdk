...
class ApiV1DemandsGet200Response(BaseModel):
    """
    ApiV1DemandsGet200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[ApiV1DemandsGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ApiV1DemandsGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
