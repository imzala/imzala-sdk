...
class TemplateSummary(BaseModel):
    ...
    parties: Optional[List[TemplateSummaryPartiesInner]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "category", "usage_count", "parties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parties": [TemplateSummaryPartiesInner.from_dict(_item) for _item in obj["parties"]] if obj.get("parties") is not None else None
        })
        return _obj
