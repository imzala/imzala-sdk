...
class ApiV1DemandsGet200ResponseDataDemandsInner(BaseModel):
    """
    ...
    parties_total: Optional[StrictInt] = None
    parties_signed: Optional[StrictInt] = None
    pdf_url: Optional[StrictStr] = Field(default=None, description="COMPLETED ise imzalı PDF public URL'i")
    __properties: ClassVar[List[str]] = ["id", "title", "status", "created_at", "completed_at", "parties_total", "parties_signed", "pdf_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parties_total": obj.get("parties_total"),
            "parties_signed": obj.get("parties_signed"),
