...
class ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData(BaseModel):
    """
    ApiV1DemandsIdPartiesPartyIdResendPost200ResponseData
    """ # noqa: E501
    sent: Optional[List[StrictStr]] = Field(default=None, description="Gönderilen kanallar (sms/email/whatsapp)")
