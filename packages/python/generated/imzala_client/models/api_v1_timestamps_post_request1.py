...
class ApiV1TimestampsPostRequest1(BaseModel):
    """
    ApiV1TimestampsPostRequest1
    """ # noqa: E501
    file_base64: StrictStr = Field(description="Standart Base64 kodlanmış dosya içeriği (RFC 4648 §4 — A-Za-z0-9+/ alfabesi, '=' padding). data URL öneki (`data:...;base64,`) ve URL-safe alfabe (`-_`) kabul edilmez. ")
    file_name: StrictStr = Field(description="Orijinal dosya adı (uzantısıyla, ör. \"belge.pdf\")")
    description: Optional[StrictStr] = Field(default=None, description="Kayıt açıklaması (opsiyonel, max 500 karakter)")
    owner_first_name: Optional[StrictStr] = Field(default=None, description="Dosya sahibinin adı (opsiyonel, kullanıcı beyanı)")
    owner_last_name: Optional[StrictStr] = Field(default=None, description="Dosya sahibinin soyadı (opsiyonel, kullanıcı beyanı)")
    __properties: ClassVar[List[str]] = ["file_base64", "file_name", "description", "owner_first_name", "owner_last_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "owner_first_name": obj.get("owner_first_name"),
            "owner_last_name": obj.get("owner_last_name")
        })
        return _obj
