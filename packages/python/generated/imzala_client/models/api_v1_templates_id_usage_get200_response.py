...
class ApiV1TemplatesIdUsageGet200Response(BaseModel):
    """
    ApiV1TemplatesIdUsageGet200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[TemplateUsage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": TemplateUsage.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
