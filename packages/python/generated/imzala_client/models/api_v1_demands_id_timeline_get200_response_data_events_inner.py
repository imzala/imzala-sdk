...
class ApiV1DemandsIdTimelineGet200ResponseDataEventsInner(BaseModel):
    """
    ApiV1DemandsIdTimelineGet200ResponseDataEventsInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    event_type: Optional[StrictStr] = None
    actor_label: Optional[StrictStr] = None
    ip_masked: Optional[StrictStr] = None
    device_label: Optional[StrictStr] = None
    comment_text: Optional[StrictStr] = None
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "event_type", "actor_label", "ip_masked", "device_label", "comment_text", "created_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if actor_label (nullable) is None
        # and model_fields_set contains the field
        if self.actor_label is None and "actor_label" in self.model_fields_set:
            _dict['actor_label'] = None

        # set to None if ip_masked (nullable) is None
        # and model_fields_set contains the field
        if self.ip_masked is None and "ip_masked" in self.model_fields_set:
            _dict['ip_masked'] = None

        # set to None if device_label (nullable) is None
        # and model_fields_set contains the field
        if self.device_label is None and "device_label" in self.model_fields_set:
            _dict['device_label'] = None

        # set to None if comment_text (nullable) is None
        # and model_fields_set contains the field
        if self.comment_text is None and "comment_text" in self.model_fields_set:
            _dict['comment_text'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actor_label": obj.get("actor_label"),
            "ip_masked": obj.get("ip_masked"),
