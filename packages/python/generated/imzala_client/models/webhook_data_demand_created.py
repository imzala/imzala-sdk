...
class WebhookDataDemandCreated(BaseModel):
    """
    WebhookDataDemandCreated
    """ # noqa: E501
    demand_id: UUID
    title: StrictStr
    backfill: Optional[StrictBool] = Field(default=None, description="Geçmiş event'i replay etmek için bayrak. Receiver yan etkileri (e-posta gönderme, ödeme tetikleme vs.) atlamalı. ", alias="_backfill")
    __properties: ClassVar[List[str]] = ["demand_id", "title", "_backfill"]
