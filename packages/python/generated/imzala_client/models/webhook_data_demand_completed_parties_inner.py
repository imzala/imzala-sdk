...
class WebhookDataDemandCompletedPartiesInner(BaseModel):
    """
    WebhookDataDemandCompletedPartiesInner
    """ # noqa: E501
    id: Optional[UUID] = None
    name: Optional[StrictStr] = Field(default=None, description="first_name + last_name")
    email: Optional[StrictStr] = None
    signed_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "name", "email", "signed_at"]
