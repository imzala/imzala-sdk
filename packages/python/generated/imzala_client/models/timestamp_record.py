...
class TimestampRecord(BaseModel):
    ...
    timestamp_time: Optional[datetime] = Field(default=None, description="TÜBİTAK KAMU SM'nin onayladığı damga zamanı (UTC)")
    tsa_authority: Optional[StrictStr] = Field(default=None, description="Zaman damgası sağlayıcısı", json_schema_extra={"examples": ["TÜBİTAK KAMU SM"]})
    file_sha256: Optional[StrictStr] = Field(default=None, description="Damgalanan dosyanın SHA-256 hash değeri (hex, 64 karakter)", json_schema_extra={"examples": ["a3f8b1c2d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1"]})
    verify_url: Optional[StrictStr] = Field(default=None, description="Damgayı doğrulamak için URL", json_schema_extra={"examples": ["https://imzala.org/dogrula?seri=<id>"]})
    certificate_url: Optional[StrictStr] = Field(default=None, description="Damga sertifikası URL'i", json_schema_extra={"examples": ["https://imzala.org/dogrula?seri=<id>"]})
    credits_used: Optional[StrictInt] = Field(default=None, description="Bu damga için harcanan kredi miktarı", json_schema_extra={"examples": [4]})
    credits_remaining: Optional[StrictInt] = Field(default=None, description="İşlem sonrası kalan kredi bakiyesi", json_schema_extra={"examples": [0]})
    __properties: ClassVar[List[str]] = ["id", "timestamp_time", "tsa_authority", "file_sha256", "verify_url", "certificate_url", "credits_used", "credits_remaining"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tsa_authority": obj.get("tsa_authority"),
