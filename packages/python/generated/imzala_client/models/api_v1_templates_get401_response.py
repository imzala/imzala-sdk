...
class ApiV1TemplatesGet401Response(BaseModel):
    """
    ApiV1TemplatesGet401Response
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, json_schema_extra={"examples": [False]})
    error: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Unauthorized"]})
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Invalid or missing X-API-Key header"]})
