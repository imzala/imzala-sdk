...
class ApiV1DemandsIdEmbedSessionPost200Response(BaseModel):
    """
    ApiV1DemandsIdEmbedSessionPost200Response
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, json_schema_extra={"examples": [True]})
    data: Optional[ApiV1DemandsIdEmbedSessionPost200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ApiV1DemandsIdEmbedSessionPost200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
