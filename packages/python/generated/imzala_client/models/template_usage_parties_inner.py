...
class TemplateUsagePartiesInner(BaseModel):
    """
    TemplateUsagePartiesInner
    """ # noqa: E501
    template_party_id: Optional[UUID] = None
    order: Optional[StrictInt] = None
    label: Optional[StrictStr] = None
    is_required: Optional[StrictBool] = None
    supported_fields: Optional[List[TemplateUsagePartiesInnerSupportedFieldsInner]] = None
    __properties: ClassVar[List[str]] = ["template_party_id", "order", "label", "is_required", "supported_fields"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in supported_fields (list)
        _items = []
        if self.supported_fields:
            for _item_supported_fields in self.supported_fields:
                if _item_supported_fields:
                    _items.append(_item_supported_fields.to_dict())
            _dict['supported_fields'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supported_fields": [TemplateUsagePartiesInnerSupportedFieldsInner.from_dict(_item) for _item in obj["supported_fields"]] if obj.get("supported_fields") is not None else None
        })
        return _obj
