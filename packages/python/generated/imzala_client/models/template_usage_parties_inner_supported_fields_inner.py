...
class TemplateUsagePartiesInnerSupportedFieldsInner(BaseModel):
    """
    ...
    required_if: Optional[StrictStr] = None
    default: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["key", "type", "required", "required_if", "default"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TemplateUsagePartiesInnerSupportedFieldsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TemplateUsagePartiesInnerSupportedFieldsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "required_if": obj.get("required_if"),
