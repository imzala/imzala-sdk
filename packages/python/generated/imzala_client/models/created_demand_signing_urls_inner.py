...
class CreatedDemandSigningUrlsInner(BaseModel):
    """
    ...
    signing_url: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["https://e.imzala.org/imza/<party_id>"]})
    __properties: ClassVar[List[str]] = ["party_id", "first_name", "last_name", "email", "phone", "signing_url"]
