...
class TemplateUsage(BaseModel):
    ...
    TemplateUsage
    """ # noqa: E501
    template: Optional[ApiV1TemplatesIdPatch200ResponseData] = None
    endpoint: Optional[TemplateUsageEndpoint] = None
    required_headers: Optional[Dict[str, StrictStr]] = Field(default=None, json_schema_extra={"examples": [{"X-API-Key": "<sizin API anahtariniz>", "X-Workspace-Id": "ed422ff9-...", "Content-Type": "application/json"}]})
    parties: Optional[List[TemplateUsagePartiesInner]] = None
    variables: Optional[List[TemplateUsageVariablesInner]] = None
    example_request: Optional[TemplateUsageExampleRequest] = None
    __properties: ClassVar[List[str]] = ["template", "endpoint", "required_headers", "parties", "variables", "example_request"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.example_request:
            _dict['example_request'] = self.example_request.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "template": ApiV1TemplatesIdPatch200ResponseData.from_dict(obj["template"]) if obj.get("template") is not None else None,
            "endpoint": TemplateUsageEndpoint.from_dict(obj["endpoint"]) if obj.get("endpoint") is not None else None,
            "required_headers": obj.get("required_headers"),
            "parties": [TemplateUsagePartiesInner.from_dict(_item) for _item in obj["parties"]] if obj.get("parties") is not None else None,
            "variables": [TemplateUsageVariablesInner.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None,
            "example_request": TemplateUsageExampleRequest.from_dict(obj["example_request"]) if obj.get("example_request") is not None else None
        })
        return _obj
