...
class ApiV1DemandsIdEmbedSessionPost200ResponseData(BaseModel):
    """
    ApiV1DemandsIdEmbedSessionPost200ResponseData
    """ # noqa: E501
    embed_token: Optional[StrictStr] = Field(default=None, description="Tek kullanımlık, kısa ömürlü gömülü imza token'ı", json_schema_extra={"examples": ["emb_a1b2c3d4e5f6..."]})
    expires_at: Optional[datetime] = Field(default=None, description="Token geçerlilik bitiş zamanı (ISO 8601 UTC)", json_schema_extra={"examples": ["2026-06-30T15:30:00Z"]})
    embed_url: Optional[StrictStr] = Field(default=None, description="`<iframe src=\"\">` alanına yerleştirilecek tam URL. `https://e.imzala.org/embed/sign?token=<embed_token>` formatında. ", json_schema_extra={"examples": ["https://e.imzala.org/embed/sign?token=emb_a1b2c3d4e5f6..."]})
    __properties: ClassVar[List[str]] = ["embed_token", "expires_at", "embed_url"]
