...
class WebhookDataDemandExpired(BaseModel):
    """
    ...
    parties: List[WebhookDataDemandExpiredPartiesInner]
    __properties: ClassVar[List[str]] = ["demand_id", "title", "expiry_date", "parties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parties": [WebhookDataDemandExpiredPartiesInner.from_dict(_item) for _item in obj["parties"]] if obj.get("parties") is not None else None
        })
        return _obj
