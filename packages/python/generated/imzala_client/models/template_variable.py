...
class TemplateVariable(BaseModel):
    ...
    def item_type_validate_enum(cls, value):
        ...
        if value not in set(['dynamic_text', 'cells', 'date', 'dropdown', 'text']):
            raise ValueError("must be one of enum values ('dynamic_text', 'cells', 'date', 'dropdown', 'text')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if default_source (nullable) is None
        # and model_fields_set contains the field
        if self.default_source is None and "default_source" in self.model_fields_set:
            _dict['default_source'] = None

        # set to None if template_party_id (nullable) is None
        # and model_fields_set contains the field
        if self.template_party_id is None and "template_party_id" in self.model_fields_set:
            _dict['template_party_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "template_party_id": obj.get("template_party_id")
        })
        return _obj
