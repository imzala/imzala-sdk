...
class WebhookDataDemandExpiredPartiesInner(BaseModel):
    """
    ...
    signed: Optional[StrictBool] = Field(default=None, description="Süre dolduğunda imzalamış mıydı?")
    __properties: ClassVar[List[str]] = ["id", "name", "email", "signed"]
