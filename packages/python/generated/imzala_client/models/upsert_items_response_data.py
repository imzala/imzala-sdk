...
class UpsertItemsResponseData(BaseModel):
    """
    UpsertItemsResponseData
    """ # noqa: E501
    items: Optional[List[UpsertItemsResponseDataItemsInner]] = None
    items_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["items", "items_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [UpsertItemsResponseDataItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
