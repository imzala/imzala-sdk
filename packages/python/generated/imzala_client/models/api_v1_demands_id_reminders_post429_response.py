...
class ApiV1DemandsIdRemindersPost429Response(BaseModel):
    """
    ApiV1DemandsIdRemindersPost429Response
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, json_schema_extra={"examples": [False]})
    error: Optional[ApiV1DemandsIdRemindersPost429ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": ApiV1DemandsIdRemindersPost429ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
