...
class WebhookDataPartyRejected(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["demand_id", "party", "rejected_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "party": WebhookDataPartyRejectedParty.from_dict(obj["party"]) if obj.get("party") is not None else None,
