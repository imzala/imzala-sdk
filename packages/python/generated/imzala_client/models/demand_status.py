...
class DemandStatus(BaseModel):
    ...
    parties: Optional[List[DemandStatusPartiesInner]] = None
    result_url: Optional[StrictStr] = None
    pdf_url: Optional[StrictStr] = Field(default=None, description="Sadece status=COMPLETED iken dolu")
    __properties: ClassVar[List[str]] = ["id", "title", "status", "created_at", "completed_at", "parties", "result_url", "pdf_url"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['DRAFT', 'PENDING', 'COMPLETED', 'EXPIRED', 'CANCELLED']):
            raise ValueError("must be one of enum values ('DRAFT', 'PENDING', 'COMPLETED', 'EXPIRED', 'CANCELLED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parties": [DemandStatusPartiesInner.from_dict(_item) for _item in obj["parties"]] if obj.get("parties") is not None else None,
