...
class CreatedDemandUpload(BaseModel):
    """
    CreatedDemandUpload
    """ # noqa: E501
    ...
    pages: Optional[List[DemandPage]] = Field(default=None, description="Oluşturulan sözleşmedeki her sayfanın `id` ve `order` bilgisi. `POST /api/v1/demands/{id}/items` endpoint'ine alan yerleştirmek için `page_id` parametresi olarak kullanın. ")
    signing_urls: Optional[List[CreatedDemandSigningUrlsInner]] = None
    result_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "title", "status", "pages", "signing_urls", "result_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pages": [DemandPage.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
