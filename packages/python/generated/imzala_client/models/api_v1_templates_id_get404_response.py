...
class ApiV1TemplatesIdGet404Response(BaseModel):
    """
    ApiV1TemplatesIdGet404Response
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, json_schema_extra={"examples": [False]})
    error: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Şablon bulunamadı"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1TemplatesIdGet404Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1TemplatesIdGet404Response from a dict"""
        if obj is None:
            return None
