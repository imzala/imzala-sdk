...
class ApiV1DemandsGet200ResponseData(BaseModel):
    """
    ApiV1DemandsGet200ResponseData
    """ # noqa: E501
    demands: Optional[List[ApiV1DemandsGet200ResponseDataDemandsInner]] = None
    total: Optional[StrictInt] = None
    page: Optional[StrictInt] = None
    limit: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["demands", "total", "page", "limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "demands": [ApiV1DemandsGet200ResponseDataDemandsInner.from_dict(_item) for _item in obj["demands"]] if obj.get("demands") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
            "limit": obj.get("limit")
        })
