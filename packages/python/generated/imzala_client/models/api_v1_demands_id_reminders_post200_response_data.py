...
class ApiV1DemandsIdRemindersPost200ResponseData(BaseModel):
    """
    ApiV1DemandsIdRemindersPost200ResponseData
    """ # noqa: E501
    demand_id: Optional[UUID] = None
    dispatched: Optional[List[ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner]] = None
    skipped: Optional[List[ApiV1DemandsIdRemindersPost200ResponseDataSkippedInner]] = Field(default=None, description="Hatırlatma gönderilmeyen partilerin nedenleriyle birlikte (telefon/email yok, opt-out vs.)")
    last_reminder_sent_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["demand_id", "dispatched", "skipped", "last_reminder_sent_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in dispatched (list)
        _items = []
        if self.dispatched:
            for _item_dispatched in self.dispatched:
                if _item_dispatched:
                    _items.append(_item_dispatched.to_dict())
            _dict['dispatched'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "demand_id": obj.get("demand_id"),
            "dispatched": [ApiV1DemandsIdRemindersPost200ResponseDataDispatchedInner.from_dict(_item) for _item in obj["dispatched"]] if obj.get("dispatched") is not None else None,
            "skipped": [ApiV1DemandsIdRemindersPost200ResponseDataSkippedInner.from_dict(_item) for _item in obj["skipped"]] if obj.get("skipped") is not None else None,
            "last_reminder_sent_at": obj.get("last_reminder_sent_at")
        })
        return _obj
