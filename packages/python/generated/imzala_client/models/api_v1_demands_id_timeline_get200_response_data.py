...
class ApiV1DemandsIdTimelineGet200ResponseData(BaseModel):
    """
    ApiV1DemandsIdTimelineGet200ResponseData
    """ # noqa: E501
    events: Optional[List[ApiV1DemandsIdTimelineGet200ResponseDataEventsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [ApiV1DemandsIdTimelineGet200ResponseDataEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
