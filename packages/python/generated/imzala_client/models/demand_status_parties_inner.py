...
class DemandStatusPartiesInner(BaseModel):
    """
    DemandStatusPartiesInner
    """ # noqa: E501
    party_id: Optional[UUID] = None
    name: Optional[StrictStr] = Field(default=None, description="Kısaltılmış görünen ad (Ahmet Y.) — KVKK maskeleme")
    email_masked: Optional[StrictStr] = Field(default=None, description="Maskeli e-posta (ah***@x.com)")
    signed: Optional[StrictBool] = None
    signed_at: Optional[datetime] = None
    rejected: Optional[StrictBool] = None
    rejected_at: Optional[datetime] = None
    signing_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["party_id", "name", "email_masked", "signed", "signed_at", "rejected", "rejected_at", "signing_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "email_masked": obj.get("email_masked"),
