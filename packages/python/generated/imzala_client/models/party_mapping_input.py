...
class PartyMappingInput(BaseModel):
    """
    PartyMappingInput
    """ # noqa: E501
    template_party_id: UUID = Field(description="GET /api/v1/templates/{id} cevabındaki parties[].id")
    first_name: StrictStr
    last_name: StrictStr
    email: Optional[StrictStr] = Field(default=None, description="email VEYA phone'dan en az biri zorunlu")
    phone: Optional[StrictStr] = Field(default=None, description="E.164 format (örn. \"+905551234567\")")
    government_id: Optional[StrictStr] = Field(default=None, description="TC kimlik no (11 hane)")
    birth_date: Optional[date] = Field(default=None, description="ISO 8601 (örn. \"1990-05-15\")")
    send_sms: Optional[StrictBool] = True
    send_email: Optional[StrictBool] = True
    variables: Optional[Dict[str, Optional[PartyMappingInputVariablesValue]]] = Field(default=None, description="Bu PARTİYE AİT dynamic field'lara gönderilen değerler. Slug bazında eşleşir. Item'ın template_party_id'si bu partiyle aynı olmalı; değilse değişken atlanır ve variables_ignored'a düşürülür. ")
    __properties: ClassVar[List[str]] = ["template_party_id", "first_name", "last_name", "email", "phone", "government_id", "birth_date", "send_sms", "send_email", "variables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "phone": obj.get("phone"),
            "government_id": obj.get("government_id"),
            "birth_date": obj.get("birth_date"),
            "send_sms": obj.get("send_sms") if obj.get("send_sms") is not None else True,
