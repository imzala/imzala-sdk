...
class ApiError(BaseModel):
    ...
    error: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["INSUFFICIENT_CREDITS"]})
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Yeterli krediniz yok"]})
