...
class ApiV1DemandsUploadPost201Response(BaseModel):
    """
    ApiV1DemandsUploadPost201Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[CreatedDemandUpload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CreatedDemandUpload.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
