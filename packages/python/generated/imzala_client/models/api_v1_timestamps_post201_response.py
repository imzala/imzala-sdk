...
class ApiV1TimestampsPost201Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": TimestampRecord.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
