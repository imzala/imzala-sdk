...
class TemplatesApi:
    ...
    def api_v1_templates_get(
        ...
        _param = self._api_v1_templates_get_serialize(
            page=page,
            limit=limit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiV1TemplatesGet200Response",
    ...
    def api_v1_templates_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiV1TemplatesGet200Response]:
        """Şablon listesi
    ...
    @validate_call
    def api_v1_templates_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        limit: Optional[StrictInt] = None,
        _request_timeout: Union[
    ...
    def _api_v1_templates_get_serialize(
        self,
        page,
        limit,
        _request_auth,
    ...
    def api_v1_templates_id_get(
        ...
        _param = self._api_v1_templates_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiV1TemplatesIdGet200Response",
    ...
    @validate_call
    def api_v1_templates_id_get_with_http_info(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiV1TemplatesIdGet200Response]:
        """Şablon detay
    ...
    @validate_call
    def api_v1_templates_id_get_without_preload_content(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_templates_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/templates/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api_v1_templates_id_usage_get(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
        ...
        _param = self._api_v1_templates_id_usage_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiV1TemplatesIdUsageGet200Response",
            '404': "ApiV1TemplatesIdGet404Response",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def api_v1_templates_id_usage_get_with_http_info(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiV1TemplatesIdUsageGet200Response]:
        """Şablon kullanım kılavuzu (curl + JSON örnek)
    ...
    @validate_call
    def api_v1_templates_id_usage_get_without_preload_content(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_templates_id_usage_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/templates/{id}/usage',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
