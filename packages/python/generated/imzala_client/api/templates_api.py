...
class TemplatesApi:
    ...
    @validate_call
    def api_v1_templates_id_delete(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
        ...
        _param = self._api_v1_templates_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v1_templates_id_delete_with_http_info(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v1_templates_id_delete_without_preload_content(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_templates_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def api_v1_templates_id_patch(
        self,
        id: UUID,
        api_v1_templates_id_patch_request: ApiV1TemplatesIdPatchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: (required)
        :type id: UUID
        :param api_v1_templates_id_patch_request: (required)
        :type api_v1_templates_id_patch_request: ApiV1TemplatesIdPatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._api_v1_templates_id_patch_serialize(
            id=id,
            api_v1_templates_id_patch_request=api_v1_templates_id_patch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiV1TemplatesIdPatch200Response",
    ...
    @validate_call
    def api_v1_templates_id_patch_with_http_info(
        self,
        id: UUID,
        api_v1_templates_id_patch_request: ApiV1TemplatesIdPatchRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiV1TemplatesIdPatch200Response]:
        """Şablon metadata güncelle
    ...
    @validate_call
    def api_v1_templates_id_patch_without_preload_content(
        self,
        id: UUID,
        api_v1_templates_id_patch_request: ApiV1TemplatesIdPatchRequest,
        _request_timeout: Union[
    ...
    def _api_v1_templates_id_patch_serialize(
        self,
        id,
        api_v1_templates_id_patch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if api_v1_templates_id_patch_request is not None:
            _body_params = api_v1_templates_id_patch_request
