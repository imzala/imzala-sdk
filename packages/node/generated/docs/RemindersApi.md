...
|------------- | ------------- | -------------|
|[**apiV1DemandsIdRemindersPost**](#apiv1demandsidreminderspost) | **POST** /api/v1/demands/{id}/reminders | Anlık hatırlatma tetikle (imzalanmamış taraflara)|

# **apiV1DemandsIdRemindersPost**
> ApiV1DemandsIdRemindersPost200Response apiV1DemandsIdRemindersPost()
...
const apiInstance = new RemindersApi(configuration);

let id: string; //Sözleşme (demand) ID (default to undefined)
let triggerReminderRequest: TriggerReminderRequest; // (optional)

const { status, data } = await apiInstance.apiV1DemandsIdRemindersPost(
    id,
    triggerReminderRequest
);
```
...
|------------- | ------------- | ------------- | -------------|
| **triggerReminderRequest** | **TriggerReminderRequest**|  | |
