...
class TemplatesApi
{
    ...
    /**
     * Operation apiV1TemplatesIdDelete
     *
     * Şablon sil
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1TemplatesIdDelete'] to see the possible values for this operation
     *
     * @throws \Imzala\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Imzala\Client\Model\ApiV1TemplatesIdDelete200Response|\Imzala\Client\Model\ApiV1TemplatesIdGet404Response
     */
    public function apiV1TemplatesIdDelete($id, string $contentType = self::contentTypes['apiV1TemplatesIdDelete'][0])
    {
        list($response) = $this->apiV1TemplatesIdDeleteWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation apiV1TemplatesIdDeleteWithHttpInfo
     *
     * Şablon sil
     *
     ...
     */
    public function apiV1TemplatesIdDeleteWithHttpInfo($id, string $contentType = self::contentTypes['apiV1TemplatesIdDelete'][0])
    {
        $request = $this->apiV1TemplatesIdDeleteRequest($id, $contentType);
    ...
    /**
     * Operation apiV1TemplatesIdDeleteAsync
     *
     * Şablon sil
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1TemplatesIdDeleteAsync($id, string $contentType = self::contentTypes['apiV1TemplatesIdDelete'][0])
    {
        return $this->apiV1TemplatesIdDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV1TemplatesIdDeleteAsyncWithHttpInfo
     *
     * Şablon sil
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1TemplatesIdDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['apiV1TemplatesIdDelete'][0])
    {
    ...
    /**
     * Create request for operation 'apiV1TemplatesIdDelete'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1TemplatesIdDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiV1TemplatesIdDeleteRequest($id, string $contentType = self::contentTypes['apiV1TemplatesIdDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiV1TemplatesIdDelete'
            );
        }
    ...
    /**
     * Operation apiV1TemplatesIdPatch
     *
     * Şablon metadata güncelle
     *
     * @param  string $id id (required)
     * @param  \Imzala\Client\Model\ApiV1TemplatesIdPatchRequest $api_v1_templates_id_patch_request api_v1_templates_id_patch_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1TemplatesIdPatch'] to see the possible values for this operation
     *
     * @throws \Imzala\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Imzala\Client\Model\ApiV1TemplatesIdPatch200Response|\Imzala\Client\Model\ApiV1TemplatesIdGet404Response|\Imzala\Client\Model\ApiV1TemplatesIdGet404Response
     */
    public function apiV1TemplatesIdPatch($id, $api_v1_templates_id_patch_request, string $contentType = self::contentTypes['apiV1TemplatesIdPatch'][0])
    {
        list($response) = $this->apiV1TemplatesIdPatchWithHttpInfo($id, $api_v1_templates_id_patch_request, $contentType);
        return $response;
    }

    /**
     * Operation apiV1TemplatesIdPatchWithHttpInfo
     *
     * Şablon metadata güncelle
     *
     * @param  string $id (required)
     * @param  \Imzala\Client\Model\ApiV1TemplatesIdPatchRequest $api_v1_templates_id_patch_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1TemplatesIdPatch'] to see the possible values for this operation
     *
     * @throws \Imzala\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Imzala\Client\Model\ApiV1TemplatesIdPatch200Response|\Imzala\Client\Model\ApiV1TemplatesIdGet404Response|\Imzala\Client\Model\ApiV1TemplatesIdGet404Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV1TemplatesIdPatchWithHttpInfo($id, $api_v1_templates_id_patch_request, string $contentType = self::contentTypes['apiV1TemplatesIdPatch'][0])
    {
        $request = $this->apiV1TemplatesIdPatchRequest($id, $api_v1_templates_id_patch_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Imzala\Client\Model\ApiV1TemplatesIdPatch200Response',
                        $request,
                        $response,
                    );
                case 400:
    ...
    /**
     * Operation apiV1TemplatesIdPatchAsync
     *
     * Şablon metadata güncelle
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1TemplatesIdPatchAsync($id, $api_v1_templates_id_patch_request, string $contentType = self::contentTypes['apiV1TemplatesIdPatch'][0])
    {
        return $this->apiV1TemplatesIdPatchAsyncWithHttpInfo($id, $api_v1_templates_id_patch_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV1TemplatesIdPatchAsyncWithHttpInfo
     *
     * Şablon metadata güncelle
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1TemplatesIdPatchAsyncWithHttpInfo($id, $api_v1_templates_id_patch_request, string $contentType = self::contentTypes['apiV1TemplatesIdPatch'][0])
    {
        $returnType = '\Imzala\Client\Model\ApiV1TemplatesIdPatch200Response';
        $request = $this->apiV1TemplatesIdPatchRequest($id, $api_v1_templates_id_patch_request, $contentType);
    ...
    /**
     * Create request for operation 'apiV1TemplatesIdPatch'
     *
     * @param  string $id (required)
     * @param  \Imzala\Client\Model\ApiV1TemplatesIdPatchRequest $api_v1_templates_id_patch_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiV1TemplatesIdPatch'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiV1TemplatesIdPatchRequest($id, $api_v1_templates_id_patch_request, string $contentType = self::contentTypes['apiV1TemplatesIdPatch'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiV1TemplatesIdPatch'
            );
        }

        // verify the required parameter 'api_v1_templates_id_patch_request' is set
        if ($api_v1_templates_id_patch_request === null || (is_array($api_v1_templates_id_patch_request) && count($api_v1_templates_id_patch_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $api_v1_templates_id_patch_request when calling apiV1TemplatesIdPatch'
            );
        }
        ...
        // for model (json/xml)
        if (isset($api_v1_templates_id_patch_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($api_v1_templates_id_patch_request));
            } else {
                $httpBody = $api_v1_templates_id_patch_request;
            }
