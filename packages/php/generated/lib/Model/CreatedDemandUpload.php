...
/**
 * CreatedDemandUpload Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatedDemandUpload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreatedDemandUpload';
    ...
    protected static $openAPITypes = [
        ...
        'title' => 'string',
        'status' => 'string',
        'pages' => '\Imzala\Client\Model\DemandPage[]',
     ...
     * Gets pages
     *
     * @return \Imzala\Client\Model\DemandPage[]|null
     */
     ...
     * Sets pages
     *
     * @param \Imzala\Client\Model\DemandPage[]|null $pages Oluşturulan sözleşmedeki her sayfanın `id` ve `order` bilgisi. `POST /api/v1/demands/{id}/items` endpoint'ine alan yerleştirmek için `page_id` parametresi olarak kullanın.
     *
     * @return self
     */
