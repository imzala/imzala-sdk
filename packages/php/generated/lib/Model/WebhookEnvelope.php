...
/**
 * WebhookEnvelope Class Doc Comment
 *
 * @category Class
 * @description Tüm webhook payload&#39;larının ortak zarfı. &#x60;data&#x60; alanı olay tipine göre değişir; her olay için ayrı veri şeması yukarıda dokümante.
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WebhookEnvelope implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WebhookEnvelope';
    ...
    public const TYPE_DEMAND_CREATED = 'demand.created';
    public const TYPE_DEMAND_COMPLETED = 'demand.completed';
    public const TYPE_DEMAND_EXPIRED = 'demand.expired';
    public const TYPE_PARTY_SIGNED = 'party.signed';
    public const TYPE_PARTY_VIEWED = 'party.viewed';
    public const TYPE_PARTY_REJECTED = 'party.rejected';
    ...
    {
        return [
            self::TYPE_DEMAND_CREATED,
            self::TYPE_DEMAND_COMPLETED,
            self::TYPE_DEMAND_EXPIRED,
            self::TYPE_PARTY_SIGNED,
            self::TYPE_PARTY_VIEWED,
            self::TYPE_PARTY_REJECTED,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^evt_[0-9a-f]{32}$/", $this->container['id'])) {
            $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /^evt_[0-9a-f]{32}$/.";
        }
     ...
     * Sets id
     *
     * @param string $id Olay benzersiz id'si. Receiver tarafında idempotency için kullanın (DB'de unique key).
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((!preg_match("/^evt_[0-9a-f]{32}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling WebhookEnvelope., must conform to the pattern /^evt_[0-9a-f]{32}$/.");
        }
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Olay zamanı (ISO 8601 UTC).
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param object $data Olay tipine özel veri (aşağıdaki şemalar)
     *
     * @return self
     */
