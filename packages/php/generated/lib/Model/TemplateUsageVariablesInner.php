...
/**
 * TemplateUsageVariablesInner Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class TemplateUsageVariablesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TemplateUsage_variables_inner';
    ...
    protected static $setters = [
        ...
        'default_source' => 'setDefaultSource',
        'auto_filled' => 'setAutoFilled',
        'template_party_id' => 'setTemplatePartyId',
        'note' => 'setNote'
    ];
    ...
    protected static $getters = [
        ...
        'auto_filled' => 'getAutoFilled',
        'template_party_id' => 'getTemplatePartyId',
        'note' => 'getNote'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('default_source', $data ?? [], null);
        $this->setIfExists('auto_filled', $data ?? [], null);
        $this->setIfExists('template_party_id', $data ?? [], null);
    ...
    {
        return $this->container['default_source'];
    }

    /**
     * Sets default_source
     *
     * @param string|null $default_source default_source
     *
     * @return self
     */
    public function setDefaultSource($default_source)
    {
        if (is_null($default_source)) {
            array_push($this->openAPINullablesSetToNull, 'default_source');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('default_source', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['default_source'] = $default_source;
     ...
     * @return bool|null
     */
    public function getAutoFilled()
    {
        return $this->container['auto_filled'];
    }

    /**
     * Sets auto_filled
     *
     * @param bool|null $auto_filled auto_filled
     *
     * @return self
     */
    public function setAutoFilled($auto_filled)
    {
        if (is_null($auto_filled)) {
            throw new \InvalidArgumentException('non-nullable auto_filled cannot be null');
        }
        $this->container['auto_filled'] = $auto_filled;

        return $this;
    }

    /**
     * Gets template_party_id
     *
     * @return string|null
     */
    public function getTemplatePartyId()
    {
        return $this->container['template_party_id'];
    }

    /**
     * Sets template_party_id
     *
     * @param string|null $template_party_id template_party_id
     *
     * @return self
     */
    public function setTemplatePartyId($template_party_id)
    {
        if (is_null($template_party_id)) {
            array_push($this->openAPINullablesSetToNull, 'template_party_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('template_party_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['template_party_id'] = $template_party_id;
