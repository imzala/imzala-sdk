...
/**
 * UpsertItemsRequest Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpsertItemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpsertItemsRequest';
    ...
    protected static $openAPITypes = [
        'items' => '\Imzala\Client\Model\PageItem[]',
        'page_ids' => 'int[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('page_ids', $data ?? [], null);
    }
     ...
     * Gets items
     *
     * @return \Imzala\Client\Model\PageItem[]
     */
     ...
     * Sets items
     *
     * @param \Imzala\Client\Model\PageItem[] $items items
     *
     * @return self
     */
     ...
     * Sets page_ids
     *
     * @param int[]|null $page_ids **Opsiyonel.** Verilirse sadece bu sayfaların item'ları replace edilir; diğer sayfalardaki item'lar korunur. Body'deki `items[].page_id` değerleri bu listede olmalıdır. Omitted ise tüm sayfaların item'ları replace edilir.
     *
     * @return self
     */
    ...
    {
        if (is_null($page_ids)) {
            throw new \InvalidArgumentException('non-nullable page_ids cannot be null');
        }
