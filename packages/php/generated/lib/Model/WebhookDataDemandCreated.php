...
/**
 * WebhookDataDemandCreated Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookDataDemandCreated implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WebhookDataDemandCreated';
     ...
     * Sets _backfill
     *
     * @param bool|null $_backfill Geçmiş event'i replay etmek için bayrak. Receiver yan etkileri (e-posta gönderme, ödeme tetikleme vs.) atlamalı.
     *
     * @return self
     */
