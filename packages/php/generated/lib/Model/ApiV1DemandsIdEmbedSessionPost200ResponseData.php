...
/**
 * ApiV1DemandsIdEmbedSessionPost200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DemandsIdEmbedSessionPost200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_demands__id__embed_session_post_200_response_data';
    ...
    {
        $this->setIfExists('embed_token', $data ?? [], null);
     ...
     * Sets embed_token
     *
     * @param string|null $embed_token Tek kullanımlık, kısa ömürlü gömülü imza token'ı
     *
     * @return self
     */
    public function setEmbedToken($embed_token)
    {
        if (is_null($embed_token)) {
            throw new \InvalidArgumentException('non-nullable embed_token cannot be null');
        }
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at Token geçerlilik bitiş zamanı (ISO 8601 UTC)
     *
     * @return self
     */
     ...
     * Sets embed_url
     *
     * @param string|null $embed_url `<iframe src=\"\">` alanına yerleştirilecek tam URL. `https://e.imzala.org/embed/sign?token=<embed_token>` formatında.
     *
     * @return self
     */
