...
class TemplateVariable implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $template_party_id Bu field'in sahibi olan template parti id'si. NULL ise root scope (party_mapping dışında) — kök variables'a göndermeniz gerekir. Doluysa party_mapping[i].variables'ta i bu id ile eşleşen partinin altına göndermeniz gerekir.
     *
     * @return self
     */
