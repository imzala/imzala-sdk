...
/**
 * DemandStatusPartiesInner Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class DemandStatusPartiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DemandStatus_parties_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('email_masked', $data ?? [], null);
     ...
     * Sets name
     *
     * @param string|null $name Kısaltılmış görünen ad (Ahmet Y.) — KVKK maskeleme
     *
     * @return self
     */
    ...
    {
        return $this->container['email_masked'];
    }

    /**
     * Sets email_masked
     *
     * @param string|null $email_masked Maskeli e-posta (ah***@x.com)
     *
     * @return self
     */
    public function setEmailMasked($email_masked)
    {
        if (is_null($email_masked)) {
            throw new \InvalidArgumentException('non-nullable email_masked cannot be null');
        }
        $this->container['email_masked'] = $email_masked;
     ...
     * Sets signed_at
     *
     * @param \DateTime|null $signed_at signed_at
     *
     * @return self
     */
     ...
     * Sets rejected
     *
     * @param bool|null $rejected rejected
     *
     * @return self
     */
    ...
    public function setRejectedAt($rejected_at)
    {
        if (is_null($rejected_at)) {
            array_push($this->openAPINullablesSetToNull, 'rejected_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rejected_at', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setSigningUrl($signing_url)
    {
        if (is_null($signing_url)) {
            throw new \InvalidArgumentException('non-nullable signing_url cannot be null');
        }
