 ...
 */
class DemandPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DemandPage';
     ...
     * Sets order
     *
     * @param int $order 1-based sayfa sırası
     *
     * @return self
     */
