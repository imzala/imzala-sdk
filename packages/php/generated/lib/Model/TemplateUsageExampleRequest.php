...
/**
 * TemplateUsageExampleRequest Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class TemplateUsageExampleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TemplateUsage_example_request';
    ...
    {
        $this->setIfExists('curl', $data ?? [], null);
    ...
    {
        return $this->container['curl'];
    }

    /**
     * Sets curl
     *
     * @param string|null $curl curl komutu, slug'lar dolu
     *
     * @return self
     */
    ...
    {
        if (is_null($curl)) {
            throw new \InvalidArgumentException('non-nullable curl cannot be null');
        }
        $this->container['curl'] = $curl;
     ...
     * Sets json
     *
     * @param object|null $json JSON payload, multi-party-aware (party_mapping[].variables + root variables)
     *
     * @return self
     */
