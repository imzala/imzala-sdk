...
/**
 * ApiV1DemandsIdRemindersPost429ResponseError Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DemandsIdRemindersPost429ResponseError implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_demands__id__reminders_post_429_response_error';
     ...
     *
     * @param int|null $retry_after_seconds Sadece RATE_LIMITED'de
     *
     * @return self
     */
