...
/**
 * PartyMappingInput Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class PartyMappingInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PartyMappingInput';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('send_sms', $data ?? [], true);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['template_party_id'] === null) {
            $invalidProperties[] = "'template_party_id' can't be null";
        }
     ...
     *
     * @param string $template_party_id GET /api/v1/templates/{id} cevabındaki parties[].id
     *
     * @return self
     */
    public function setTemplatePartyId($template_party_id)
    {
        if (is_null($template_party_id)) {
            throw new \InvalidArgumentException('non-nullable template_party_id cannot be null');
        }
     ...
     * Sets email
     *
     * @param string|null $email email VEYA phone'dan en az biri zorunlu
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone E.164 format (örn. \"+905551234567\")
     *
     * @return self
     */
     ...
     * Sets government_id
     *
     * @param string|null $government_id TC kimlik no (11 hane)
     *
     * @return self
     */
     ...
     * Sets birth_date
     *
     * @param \DateTime|null $birth_date ISO 8601 (örn. \"1990-05-15\")
     *
     * @return self
     */
     ...
     * Sets send_sms
     *
     * @param bool|null $send_sms send_sms
     *
     * @return self
     */
     ...
     * Sets variables
     *
     * @param array<string,\Imzala\Client\Model\PartyMappingInputVariablesValue>|null $variables Bu PARTİYE AİT dynamic field'lara gönderilen değerler. Slug bazında eşleşir. Item'ın template_party_id'si bu partiyle aynı olmalı; değilse değişken atlanır ve variables_ignored'a düşürülür.
     *
     * @return self
     */
