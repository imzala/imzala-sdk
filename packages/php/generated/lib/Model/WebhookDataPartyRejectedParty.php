...
/**
 * WebhookDataPartyRejectedParty Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookDataPartyRejectedParty implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WebhookDataPartyRejected_party';
     ...
     *
     * @param string|null $rejection_reason Tarafın belirttiği sebep (opsiyonel, modal textarea)
     *
     * @return self
     */
