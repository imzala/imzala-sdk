...
/**
 * TriggerReminderRequest Class Doc Comment
 *
 * @category Class
 * @description Anlık hatırlatma tetikleme isteği gövdesi (tüm alanlar opsiyonel).
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TriggerReminderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TriggerReminderRequest';
     ...
     * Sets channels
     *
     * @param string[]|null $channels Bu çağrıda kullanılacak kanal(lar). Yollanmazsa default `[\"sms\",\"email\"]` ile her iki kanalda da gönderilir (parti `send_sms`/`send_email` toggle'ı + iletişim alanı + demand global toggle uygunluğuna göre).
     *
     * @return self
     */
     ...
     * Sets force
     *
     * @param bool|null $force `true` ise 5 dk anti-spam penceresini override eder (son hatırlatma 5 dk içinde gönderilmiş olsa bile gönderir). Production akışlarında yanlışlıkla spam atmamak için sadece kasıtlı admin operasyonlarında kullanın.
     *
     * @return self
     */
