...
/**
 * WebhookDataDemandCompleted Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookDataDemandCompleted implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WebhookDataDemandCompleted';
    ...
    protected static $openAPITypes = [
        ...
        'parties' => '\Imzala\Client\Model\WebhookDataDemandCompletedPartiesInner[]',
        '_backfill' => 'bool'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_backfill', $data ?? [], null);
    }
     ...
     * Gets parties
     *
     * @return \Imzala\Client\Model\WebhookDataDemandCompletedPartiesInner[]
     */
     ...
     * Sets parties
     *
     * @param \Imzala\Client\Model\WebhookDataDemandCompletedPartiesInner[] $parties parties
     *
     * @return self
     */
    ...
    {
        return $this->container['_backfill'];
    }

    /**
     * Sets _backfill
     *
     * @param bool|null $_backfill Replay bayrağı (yan etkileri atla)
     *
     * @return self
     */
    public function setBackfill($_backfill)
    {
        if (is_null($_backfill)) {
            throw new \InvalidArgumentException('non-nullable _backfill cannot be null');
        }
        $this->container['_backfill'] = $_backfill;
