...
/**
 * WebhookDataDemandExpiredPartiesInner Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookDataDemandExpiredPartiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WebhookDataDemandExpired_parties_inner';
     ...
     * Sets signed
     *
     * @param bool|null $signed Süre dolduğunda imzalamış mıydı?
     *
     * @return self
     */
