...
/**
 * ApiV1DemandsIdTimelineGet200ResponseDataEventsInner Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DemandsIdTimelineGet200ResponseDataEventsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_demands__id__timeline_get_200_response_data_events_inner';
    ...
    protected static $setters = [
        ...
        'actor_label' => 'setActorLabel',
        'ip_masked' => 'setIpMasked',
    ...
    protected static $getters = [
        ...
        'actor_label' => 'getActorLabel',
        'ip_masked' => 'getIpMasked',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('actor_label', $data ?? [], null);
        $this->setIfExists('ip_masked', $data ?? [], null);
    ...
    {
        return $this->container['actor_label'];
    }

    /**
     * Sets actor_label
     *
     * @param string|null $actor_label actor_label
     *
     * @return self
     */
    public function setActorLabel($actor_label)
    {
        if (is_null($actor_label)) {
            array_push($this->openAPINullablesSetToNull, 'actor_label');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('actor_label', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['actor_label'] = $actor_label;
     ...
     * @return string|null
     */
    public function getIpMasked()
    {
        return $this->container['ip_masked'];
    }

    /**
     * Sets ip_masked
     *
     * @param string|null $ip_masked ip_masked
     *
     * @return self
     */
    public function setIpMasked($ip_masked)
    {
        if (is_null($ip_masked)) {
            array_push($this->openAPINullablesSetToNull, 'ip_masked');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ip_masked', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ip_masked'] = $ip_masked;
     ...
     * Sets device_label
     *
     * @param string|null $device_label device_label
     *
     * @return self
     */
    ...
    public function setCommentText($comment_text)
    {
        if (is_null($comment_text)) {
            array_push($this->openAPINullablesSetToNull, 'comment_text');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('comment_text', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
