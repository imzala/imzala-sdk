...
/**
 * ApiV1DemandsIdEmbedSessionPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DemandsIdEmbedSessionPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_demands__id__embed_session_post_request';
     ...
     * Sets party_id
     *
     * @param string $party_id Token üretilecek tarafın ID'si. `POST /api/v1/demands` veya `GET /api/v1/demands/{id}` cevabındaki `signing_urls[].party_id` alanından alınır.
     *
     * @return self
     */
