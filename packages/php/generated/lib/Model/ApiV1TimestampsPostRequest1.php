...
/**
 * ApiV1TimestampsPostRequest1 Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1TimestampsPostRequest1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_timestamps_post_request_1';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('owner_first_name', $data ?? [], null);
        $this->setIfExists('owner_last_name', $data ?? [], null);
    }
     ...
     * Sets file_base64
     *
     * @param string $file_base64 Standart Base64 kodlanmış dosya içeriği (RFC 4648 §4 — A-Za-z0-9+/ alfabesi, '=' padding). data URL öneki (`data:...;base64,`) ve URL-safe alfabe (`-_`) kabul edilmez.
     *
     * @return self
     */
     ...
     * Sets file_name
     *
     * @param string $file_name Orijinal dosya adı (uzantısıyla, ör. \"belge.pdf\")
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Kayıt açıklaması (opsiyonel, max 500 karakter)
     *
     * @return self
     */
     ...
     *
     * @param string|null $owner_first_name Dosya sahibinin adı (opsiyonel, kullanıcı beyanı)
     *
     * @return self
     */
    public function setOwnerFirstName($owner_first_name)
    {
        if (is_null($owner_first_name)) {
            throw new \InvalidArgumentException('non-nullable owner_first_name cannot be null');
        }
     ...
     *
     * @param string|null $owner_last_name Dosya sahibinin soyadı (opsiyonel, kullanıcı beyanı)
     *
     * @return self
     */
    public function setOwnerLastName($owner_last_name)
    {
        if (is_null($owner_last_name)) {
            throw new \InvalidArgumentException('non-nullable owner_last_name cannot be null');
        }
