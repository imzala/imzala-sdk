...
/**
 * TimestampRecord Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class TimestampRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TimestampRecord';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('timestamp_time', $data ?? [], null);
        $this->setIfExists('tsa_authority', $data ?? [], null);
     ...
     * Sets timestamp_time
     *
     * @param \DateTime|null $timestamp_time TÜBİTAK KAMU SM'nin onayladığı damga zamanı (UTC)
     *
     * @return self
     */
    public function setTimestampTime($timestamp_time)
    {
        if (is_null($timestamp_time)) {
            throw new \InvalidArgumentException('non-nullable timestamp_time cannot be null');
        }
     ...
     * @return string|null
     */
    public function getTsaAuthority()
    {
        return $this->container['tsa_authority'];
    }

    /**
     * Sets tsa_authority
     *
     * @param string|null $tsa_authority Zaman damgası sağlayıcısı
     *
     * @return self
     */
    public function setTsaAuthority($tsa_authority)
    {
        if (is_null($tsa_authority)) {
            throw new \InvalidArgumentException('non-nullable tsa_authority cannot be null');
        }
        $this->container['tsa_authority'] = $tsa_authority;
     ...
     * Sets file_sha256
     *
     * @param string|null $file_sha256 Damgalanan dosyanın SHA-256 hash değeri (hex, 64 karakter)
     *
     * @return self
     */
     ...
     * Sets verify_url
     *
     * @param string|null $verify_url Damgayı doğrulamak için URL
     *
     * @return self
     */
     ...
     *
     * @param string|null $certificate_url Damga sertifikası URL'i
     *
     * @return self
     */
     ...
     * Sets credits_used
     *
     * @param int|null $credits_used Bu damga için harcanan kredi miktarı
     *
     * @return self
     */
     ...
     *
     * @param int|null $credits_remaining İşlem sonrası kalan kredi bakiyesi
     *
     * @return self
     */
