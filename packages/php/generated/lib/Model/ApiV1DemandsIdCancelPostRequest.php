...
/**
 * ApiV1DemandsIdCancelPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DemandsIdCancelPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_demands__id__cancel_post_request';
     ...
     * Sets reason
     *
     * @param string|null $reason İptal nedeni (opsiyonel)
     *
     * @return self
     */
