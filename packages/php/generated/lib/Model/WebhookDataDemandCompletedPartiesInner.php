...
/**
 * WebhookDataDemandCompletedPartiesInner Class Doc Comment
 *
 * @category Class
 * @package  Imzala\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhookDataDemandCompletedPartiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WebhookDataDemandCompleted_parties_inner';
     ...
     * Sets name
     *
     * @param string|null $name first_name + last_name
     *
     * @return self
     */
