...
**template_party_id** | **string** | Bu field&#39;in sahibi olan template parti id&#39;si. NULL ise root scope (party_mapping dışında) — kök variables&#39;a göndermeniz gerekir. Doluysa party_mapping[i].variables&#39;ta i bu id ile eşleşen partinin altına göndermeniz gerekir. | [optional]
